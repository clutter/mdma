...
class Rails::Application < ::Rails::Engine
  ...
  # source://sprockets-rails/3.2.1/lib/sprockets/railtie.rb#34
  def asset_precompiled?(logical_path); end

  # Returns the value of attribute assets.
  #
  # source://sprockets-rails/3.2.1/lib/sprockets/railtie.rb#27
  def assets; end
  ...
  # source://sprockets-rails/3.2.1/lib/sprockets/railtie.rb#30
  def assets_manifest; end

  # source://sprockets-rails/3.2.1/lib/sprockets/railtie.rb#30
  def assets_manifest=(_arg0); end

  # source://railties//lib/rails/engine.rb#507
  ...
  # source://sprockets-rails/3.2.1/lib/sprockets/railtie.rb#48
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  ...
  # source://railties//lib/rails/application/configuration.rb#292
  def annotations; end
  ...
  # source://railties//lib/rails/application/configuration.rb#169
  ...
  # source://railties//lib/rails/application/configuration.rb#304
  ...
  # source://railties//lib/rails/application/configuration.rb#252
  def colorize_logging; end

  # source://railties//lib/rails/application/configuration.rb#256
  ...
  # source://railties//lib/rails/application/configuration.rb#296
  ...
  #
  # source://railties//lib/rails/application/configuration.rb#220
  def database_configuration; end

  # source://railties//lib/rails/application/configuration.rb#176
  ...
  #
  # source://railties//lib/rails/application/configuration.rb#180
  def debug_exception_response_format=(_arg0); end

  # source://railties//lib/rails/application/configuration.rb#316
  ...
  # source://railties//lib/rails/application/configuration.rb#161
  ...
  #
  # source://railties//lib/rails/application/configuration.rb#205
  def load_database_yaml; end

  # source://railties//lib/rails/application/configuration.rb#74
  ...
  # source://railties//lib/rails/application/configuration.rb#182
  def paths; end
...
class Rails::Application::DefaultMiddlewareStack
  ...
  # source://railties//lib/rails/application/default_middleware_stack.rb#83
  def load_rack_cache; end

  # source://railties//lib/rails/application/default_middleware_stack.rb#105
...
class Rails::Application::RoutesReloader
  ...
  # source://railties//lib/rails/application/routes_reloader.rb#44
  def finalize!; end

  # source://railties//lib/rails/application/routes_reloader.rb#40
  def load_paths; end

  # source://railties//lib/rails/application/routes_reloader.rb#48
  def revert; end
...
class Rails::ApplicationController < ::ActionController::Base
  ...
  # source://railties//lib/rails/application_controller.rb#26
  def disable_content_security_policy_nonce!; end

  # @return [Boolean]
  #
  # source://railties//lib/rails/application_controller.rb#22
  def local_request?; end

  # source://railties//lib/rails/application_controller.rb#16
...
# source://railties//lib/rails/configuration.rb#85
class Rails::Configuration::Generators
  # @return [Generators] a new instance of Generators
  #
  # source://railties//lib/rails/configuration.rb#89
  def initialize; end

  # Returns the value of attribute aliases.
  #
  # source://railties//lib/rails/configuration.rb#86
  def aliases; end
  ...
  # source://railties//lib/rails/configuration.rb#99
...
class Rails::Configuration::MiddlewareStackProxy
  ...
  # source://railties//lib/rails/configuration.rb#77
  def +(other); end

  # source://railties//lib/rails/configuration.rb#61
  def delete(*args, &block); end

  # source://railties//lib/rails/configuration.rb#43
  def insert(*args, &block); end

  # source://railties//lib/rails/configuration.rb#49
  ...
  # source://railties//lib/rails/configuration.rb#53
  def swap(*args, &block); end

  # source://railties//lib/rails/configuration.rb#65
  def unshift(*args, &block); end

  # source://railties//lib/rails/configuration.rb#57
...
class Rails::Engine < ::Rails::Railtie
  ...
  #
  # source://railties//lib/rails/engine.rb#524
  def call(env); end
  ...
  #
  # source://railties//lib/rails/engine.rb#519
  def endpoint; end
  ...
  #
  # source://railties//lib/rails/engine.rb#536
  def routes(&block); end

  # @return [Boolean]
  #
  # source://railties//lib/rails/engine.rb#652
  def routes?; end
  ...
  # @return [Boolean]
  #
  # source://railties//lib/rails/engine.rb#683
...
class Rails::InfoController < ::Rails::ApplicationController
  ...
  # source://railties//lib/rails/info_controller.rb#37
  def match_route; end
...
# source://railties//lib/rails/paths.rb#110
class Rails::Paths::Path
  include ::Enumerable

  # @return [Path] a new instance of Path
  #
  # source://railties//lib/rails/paths.rb#115
  def initialize(root, current, paths, options = T.unsafe(nil)); end

  # source://railties//lib/rails/paths.rb#167
  def <<(path); end

  # source://railties//lib/rails/paths.rb#128
  def absolute_current; end

  # source://railties//lib/rails/paths.rb#149
  def autoload!; end
  ...
  # source://railties//lib/rails/paths.rb#172
  def concat(paths); end

  # source://railties//lib/rails/paths.rb#163
  def each(&block); end
  ...
  #
  # source://railties//lib/rails/paths.rb#208
  def existent; end

  # source://railties//lib/rails/paths.rb#219
  def existent_directories; end

  # Expands all paths against the root and return all unique values.
  #
  # source://railties//lib/rails/paths.rb#189
  def expanded; end

  # source://railties//lib/rails/paths.rb#184
  def extensions; end

  # source://railties//lib/rails/paths.rb#139
  def first; end

  # Returns the value of attribute glob.
  #
  # source://railties//lib/rails/paths.rb#113
  def glob; end
  ...
  # source://railties//lib/rails/paths.rb#227
...
class Rails::Paths::Root
  ...
  # source://railties//lib/rails/paths.rb#102
...
class Rails::Rack::Logger < ::ActiveSupport::LogSubscriber
  ...
  # source://railties//lib/rails/rack/logger.rb#34
  def call_app(request, env); end

  # source://railties//lib/rails/rack/logger.rb#57
  def compute_tags(request); end

  # source://railties//lib/rails/rack/logger.rb#70
  ...
  #
  # source://railties//lib/rails/rack/logger.rb#49
...
class Rails::Railtie
  ...
  #
  # source://railties//lib/rails/railtie.rb#209
  def initialize; end
  ...
  # source://railties//lib/rails/railtie.rb#207
  def railtie_name(*args, &block); end

  # source://railties//lib/rails/railtie.rb#226
...
# source://railties//lib/rails/test_unit/runner.rb#81
...
class Rails::TestUnit::Filter
  ...
  #
  # source://railties//lib/rails/test_unit/runner.rb#118
