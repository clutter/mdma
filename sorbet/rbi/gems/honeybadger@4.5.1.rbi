...
module Honeybadger
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/singleton.rb#68
  def install_at_exit_callback; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/singleton.rb#60
  ...
  # @see Agent#notify
  #
  # source://honeybadger//lib/honeybadger/singleton.rb#53
  def notify(exception_or_opts, opts = T.unsafe(nil)); end

  # @deprecated
  # @raise [NoMethodError]
  #
  # source://honeybadger//lib/honeybadger/singleton.rb#79
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/singleton.rb#94
...
class Honeybadger::Agent
  ...
  # @return self
  #
  # source://honeybadger//lib/honeybadger/agent.rb#273
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#247
  def breadcrumbs; end
  ...
  #   otherwise.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#179
  def check_in(id); end

  # Clear all transaction scoped data.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#229
  def clear!; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#331
  def config; end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#223
  ...
  #   data is flushed).
  #
  # source://honeybadger//lib/honeybadger/agent.rb#314
  def flush; end
  ...
  # @return [Hash, nil]
  #
  # source://honeybadger//lib/honeybadger/agent.rb#241
  def get_context; end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#116
  def notify(exception_or_opts, opts = T.unsafe(nil)); end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#325
  def stop(force = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#394
  def with_rack_env(rack_env, &block); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#402
  def worker; end
  ...
  # source://honeybadger//lib/honeybadger/agent.rb#429
  def push(object); end

  # source://honeybadger//lib/honeybadger/agent.rb#434
  def send_now(object); end

  # @raise [ArgumentError]
  #
  # source://honeybadger//lib/honeybadger/agent.rb#416
  def validate_notify_opts!(opts); end

  # source://honeybadger//lib/honeybadger/agent.rb#443
...
class Honeybadger::Backend::Base
  ...
  #
  # source://honeybadger//lib/honeybadger/backend/base.rb#104
  def config; end
end
...
# source://honeybadger//lib/honeybadger/config/defaults.rb#309
Honeybadger::Config::DEFAULTS = T.let(T.unsafe(nil), Hash)

# source://honeybadger//lib/honeybadger/config/defaults.rb#29
Honeybadger::Config::DEFAULT_PATHS = T.let(T.unsafe(nil), Array)

# source://honeybadger//lib/honeybadger/config/defaults.rb#27
...
# source://honeybadger//lib/honeybadger/config/defaults.rb#31
...
module Honeybadger::Config::Yaml
  class << self
    # source://honeybadger//lib/honeybadger/config/yaml.rb#57
...
# source://honeybadger//lib/honeybadger/notice.rb#45
class Honeybadger::Notice
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#171
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#131
  def api_key; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#216
  def as_json(*args); end

  # The backtrace from the given exception or hash.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#87
  def backtrace; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#137
  def breadcrumbs; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#77
  def cause; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#84
  def causes; end

  # CGI variables such as HTTP_METHOD.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#108
  def cgi_data; end
  ...
  # The context Hash.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#105
  def context; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#99
  def error_class; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#102
  def error_message; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#74
  def exception; end

  # Custom fingerprint for error, used to group similar errors together.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#90
  def fingerprint; end
  ...
  # Returns nothing.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#263
  def halt!; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#269
  def halted?; end

  # The unique ID of this notice which can be used to reference the error in
  # Honeybadger.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#71
  def id; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#256
  def ignore?; end

  # Local variables are extracted from first frame of backtrace.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#128
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#111
  def parameters; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#122
  def session; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#134
  def source; end

  # Tags which will be applied to error.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#93
  def tags; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#250
  def to_json(*a); end

  # The URL at which the error occurred (if any).
  #
  # source://honeybadger//lib/honeybadger/notice.rb#125
  def url; end
  ...
  # Returns the value of attribute config.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#275
  def config; end

  # source://honeybadger//lib/honeybadger/notice.rb#340
  def construct_backtrace_filters(opts); end

  # source://honeybadger//lib/honeybadger/notice.rb#385
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#353
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#496
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#370
  def exception_context(exception); end

  # source://honeybadger//lib/honeybadger/notice.rb#393
  def fingerprint_from_opts(opts); end

  # source://honeybadger//lib/honeybadger/notice.rb#404
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#311
  ...
  # source://honeybadger//lib/honeybadger/notice.rb#539
  def params_filters; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#471
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#529
  ...
  # source://honeybadger//lib/honeybadger/notice.rb#543
  def rails_params_filters; end

  # source://honeybadger//lib/honeybadger/notice.rb#346
  ...
  # source://honeybadger//lib/honeybadger/notice.rb#421
  def s(data); end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#462
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#512
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#486
...
# @api private
#
# source://honeybadger//lib/honeybadger/notice.rb#59
class Honeybadger::Notice::Cause
  # @api private
  # @return [Cause] a new instance of Cause
  #
  # source://honeybadger//lib/honeybadger/notice.rb#62
...
# @api private
#
# source://honeybadger//lib/honeybadger/notice.rb#141
...
# @api private
#
# source://honeybadger//lib/honeybadger/notice.rb#52
...
class Honeybadger::Plugin
  ...
  class << self
    ...
    #   execution { }
    #   end
    # @param name [String] The optional name of the plugin. Should use
...
class Honeybadger::Util::Revision
  class << self
    ...
    # @api private
    #
    # source://honeybadger//lib/honeybadger/util/revision.rb#21
    def from_capistrano(root); end

    # @api private
    #
    # source://honeybadger//lib/honeybadger/util/revision.rb#27
    def from_git; end
    ...
    # @api private
    #
    # source://honeybadger//lib/honeybadger/util/revision.rb#17
    def from_heroku; end
  end
end
