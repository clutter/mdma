...
module Concurrent
  ...
  #
  # source://concurrent-ruby//lib/concurrent/tvar.rb#150
  ...
  # @raise [ArgumentError]
  #
  # source://concurrent-ruby//lib/concurrent/tvar.rb#93
  def atomically; end

  # @raise [ArgumentError]
  #
  # source://concurrent-ruby//lib/concurrent/dataflow.rb#56
  ...
  #
  # source://concurrent-ruby//lib/concurrent/dataflow.rb#34
  def dataflow(*inputs, &block); end

  # source://concurrent-ruby//lib/concurrent/dataflow.rb#44
  def dataflow!(*inputs, &block); end

  # source://concurrent-ruby//lib/concurrent/dataflow.rb#39
  def dataflow_with(executor, *inputs, &block); end

  # source://concurrent-ruby//lib/concurrent/dataflow.rb#49
  def dataflow_with!(executor, *inputs, &block); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/tvar.rb#155
  ...
  #   starting point
  #
  # source://concurrent-ruby//lib/concurrent/utility/monotonic_time.rb#53
  ...
  class << self
    ...
    #
    # source://concurrent-ruby//lib/concurrent/configuration.rb#19
    def create_simple_logger(level = T.unsafe(nil), output = T.unsafe(nil)); end

    # @deprecated
    # @return [Logger] Logger with provided level and output.
    #
    # source://concurrent-ruby//lib/concurrent/configuration.rb#51
    ...
    # @see AtExit
    #
    # source://concurrent-ruby//lib/concurrent/configuration.rb#129
    ...
    # @return [Executor]
    #
    # source://concurrent-ruby//lib/concurrent/configuration.rb#164
    ...
    #
    # source://concurrent-ruby//lib/concurrent/configuration.rb#136
    def global_fast_executor; end

    # source://concurrent-ruby//lib/concurrent/configuration.rb#147
    ...
    # @return [ThreadPoolExecutor] the thread pool
    #
    # source://concurrent-ruby//lib/concurrent/configuration.rb#143
    def global_io_executor; end

    # source://concurrent-ruby//lib/concurrent/configuration.rb#91
    def global_logger; end

    # source://concurrent-ruby//lib/concurrent/configuration.rb#95
    ...
    #
    # source://concurrent-ruby//lib/concurrent/configuration.rb#154
    ...
    # source://concurrent-ruby//lib/concurrent/configuration.rb#168
    def new_fast_executor(opts = T.unsafe(nil)); end

    # source://concurrent-ruby//lib/concurrent/configuration.rb#178
    def new_io_executor(opts = T.unsafe(nil)); end

    # source://concurrent-ruby//lib/concurrent/utility/processor_counter.rb#155
    def physical_processor_count; end

    # source://concurrent-ruby//lib/concurrent/utility/processor_counter.rb#151
    def processor_count; end

    # source://concurrent-ruby//lib/concurrent/utility/processor_counter.rb#149
    def processor_counter; end

    # Use logger created by #create_simple_logger to log concurrent-ruby messages.
    #
    # source://concurrent-ruby//lib/concurrent/configuration.rb#45
    ...
    # @deprecated
    #
    # source://concurrent-ruby//lib/concurrent/configuration.rb#78
    def use_stdlib_logger(level = T.unsafe(nil), output = T.unsafe(nil)); end
  end
end

# source://concurrent-ruby//lib/concurrent/exchanger.rb#38
class Concurrent::AbstractExchanger < ::Concurrent::Synchronization::Object
  ...
  #
  # source://concurrent-ruby//lib/concurrent/exchanger.rb#44
  def initialize; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/exchanger.rb#69
  ...
  #
  # source://concurrent-ruby//lib/concurrent/exchanger.rb#80
  def exchange!(value, timeout = T.unsafe(nil)); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/exchanger.rb#109
  ...
  #
  # source://concurrent-ruby//lib/concurrent/exchanger.rb#122
  def do_exchange(value, timeout); end
end

# source://concurrent-ruby//lib/concurrent/exchanger.rb#41
Concurrent::AbstractExchanger::CANCEL = T.let(T.unsafe(nil), Object)

# source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#10
class Concurrent::AbstractExecutorService < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#20
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#61
  ...
  # @return [Boolean] `true` when auto-termination is enabled else `false`.
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#56
  def auto_terminate?; end

  # @return [Symbol] The fallback policy in effect. Either `:abort`, `:discard`, or `:caller_runs`.
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#17
  ...
  # @raise [NotImplementedError]
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#31
  def kill; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#41
  def running?; end
  ...
  # @raise [NotImplementedError]
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#26
  def shutdown; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#51
  def shutdown?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#46
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#36
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#73
  def handle_fallback(*args); end

  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#116
  def ns_auto_terminate=(value); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#112
  def ns_auto_terminate?; end

  # @raise [NotImplementedError]
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#92
  def ns_execute(*args, &task); end

  # Callback method called when the executor has been killed.
  # The default behavior is to do nothing.
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#108
  def ns_kill_execution; end

  # Callback method called when an orderly shutdown has completed.
  # The default behavior is to signal all waiting threads.
  #
  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#100
  def ns_shutdown_execution; end

  # source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#129
  def terminate_at_exit; end
end

# The set of possible fallback policies that may be set at thread pool creation.
#
# source://concurrent-ruby//lib/concurrent/executor/abstract_executor_service.rb#14
...
#
# source://concurrent-ruby//lib/concurrent/atomic/abstract_thread_local_var.rb#8
class Concurrent::AbstractThreadLocalVar
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/abstract_thread_local_var.rb#11
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/abstract_thread_local_var.rb#38
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/abstract_thread_local_var.rb#28
  def value; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/abstract_thread_local_var.rb#33
  def value=(value); end
  ...
  # @raise [NotImplementedError]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/abstract_thread_local_var.rb#53
  def allocate_storage; end

  # source://concurrent-ruby//lib/concurrent/atomic/abstract_thread_local_var.rb#58
  def default; end
end
...
#
# source://concurrent-ruby//lib/concurrent/agent.rb#144
class Concurrent::Agent < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#219
  ...
  # @see #send_off
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#330
  def <<(action); end
  ...
  # @return [Boolean] self
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#349
  def await; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#362
  ...
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#376
  def await_for!(timeout); end
  ...
  # @return [Object] the current value
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#228
  def deref; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#239
  def error; end

  # The error mode this Agent is operating in. See {#initialize} for details.
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#183
  def error_mode; end
  ...
  # @see #restart
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#401
  def failed?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#293
  ...
  # @return [Boolean] true
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#423
  ...
  # @yieldreturn [Object] the new value of the Agent
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#277
  ...
  # @yieldreturn [Object] the new value of the Agent
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#286
  def send!(*args, &action); end
  ...
  # @yieldreturn [Object] the new value of the Agent
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#301
  def send_off!(*args, &action); end
  ...
  # @yieldreturn [Object] the new value of the Agent
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#310
  ...
  # @yieldreturn [Object] the new value of the Agent
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#318
  def send_via!(executor, *args, &action); end
  ...
  # @return [Boolean] true if all actions complete before timeout else false
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#392
  ...
  # @raise [ArgumentError]
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#509
  def enqueue_action_job(action, args, executor); end

  # source://concurrent-ruby//lib/concurrent/agent.rb#515
  def enqueue_await_job(latch); end

  # source://concurrent-ruby//lib/concurrent/agent.rb#542
  def execute_next_job; end

  # source://concurrent-ruby//lib/concurrent/agent.rb#575
  def handle_error(error); end

  # source://concurrent-ruby//lib/concurrent/agent.rb#528
  def ns_enqueue_job(job, index = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/agent.rb#583
  def ns_find_last_job_for_thread; end

  # source://concurrent-ruby//lib/concurrent/agent.rb#489
  def ns_initialize(initial, opts); end

  # source://concurrent-ruby//lib/concurrent/agent.rb#538
  def ns_post_next_job; end

  # source://concurrent-ruby//lib/concurrent/agent.rb#569
  ...
  class << self
    ...
    # @return [Boolean] true
    #
    # source://concurrent-ruby//lib/concurrent/agent.rb#448
    ...
    # @return [Boolean] true if all actions complete before timeout else false
    #
    # source://concurrent-ruby//lib/concurrent/agent.rb#462
    ...
    # @return [Boolean] true if all actions complete before timeout
    #
    # source://concurrent-ruby//lib/concurrent/agent.rb#481
    def await_for!(timeout, *agents); end
  end
end

# source://concurrent-ruby//lib/concurrent/agent.rb#153
Concurrent::Agent::AWAIT_ACTION = T.let(T.unsafe(nil), Proc)

# source://concurrent-ruby//lib/concurrent/agent.rb#150
Concurrent::Agent::AWAIT_FLAG = T.let(T.unsafe(nil), Object)

# source://concurrent-ruby//lib/concurrent/agent.rb#156
Concurrent::Agent::DEFAULT_ERROR_HANDLER = T.let(T.unsafe(nil), Proc)

# source://concurrent-ruby//lib/concurrent/agent.rb#159
Concurrent::Agent::DEFAULT_VALIDATOR = T.let(T.unsafe(nil), Proc)

# source://concurrent-ruby//lib/concurrent/agent.rb#147
...
#
# source://concurrent-ruby//lib/concurrent/agent.rb#166
class Concurrent::Agent::Error < ::StandardError
  # @return [Error] a new instance of Error
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#167
  def initialize(message = T.unsafe(nil)); end
end

# source://concurrent-ruby//lib/concurrent/agent.rb#162
...
# fails validation.
#
# source://concurrent-ruby//lib/concurrent/agent.rb#175
class Concurrent::Agent::ValidationError < ::Concurrent::Agent::Error
  # @return [ValidationError] a new instance of ValidationError
  #
  # source://concurrent-ruby//lib/concurrent/agent.rb#176
  def initialize(message = T.unsafe(nil)); end
end
...
#
# source://concurrent-ruby//lib/concurrent/array.rb#63
class Concurrent::Array < ::Array; end

# source://concurrent-ruby//lib/concurrent/array.rb#22
...
#
# source://concurrent-ruby//lib/concurrent/async.rb#237
module Concurrent::Async
  ...
  #
  # source://concurrent-ruby//lib/concurrent/async.rb#422
  def async; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/async.rb#440
  def await; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/async.rb#451
  def init_synchronization; end

  class << self
    # @private
    #
    # source://concurrent-ruby//lib/concurrent/async.rb#282
    ...
    #
    # source://concurrent-ruby//lib/concurrent/async.rb#270
...
#
# source://concurrent-ruby//lib/concurrent/async.rb#301
class Concurrent::Async::AsyncDelegator < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/async.rb#307
  ...
  #
  # source://concurrent-ruby//lib/concurrent/async.rb#323
  ...
  #
  # source://concurrent-ruby//lib/concurrent/async.rb#347
  def perform; end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/async.rb#339
  def respond_to_missing?(method, include_private = T.unsafe(nil)); end
end

# Delegates synchronous, thread-safe method calls to the wrapped object.
#
# source://concurrent-ruby//lib/concurrent/async.rb#370
class Concurrent::Async::AwaitDelegator
  ...
  #
  # source://concurrent-ruby//lib/concurrent/async.rb#375
  def initialize(delegate); end
  ...
  # @return [IVar] the result of the method call
  #
  # source://concurrent-ruby//lib/concurrent/async.rb#388
  def method_missing(method, *args, &block); end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/async.rb#397
  def respond_to_missing?(method, include_private = T.unsafe(nil)); end
end

# source://concurrent-ruby//lib/concurrent/async.rb#289
module Concurrent::Async::ClassMethods
  # source://concurrent-ruby//lib/concurrent/async.rb#290
  def new(*args, &block); end
end

# @see AtExitImplementation
#
# source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#96
Concurrent::AtExit = T.let(T.unsafe(nil), Concurrent::AtExitImplementation)
...
#
# source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#10
class Concurrent::AtExitImplementation < ::Concurrent::Synchronization::LockableObject
  include ::Logger::Severity

  # @return [AtExitImplementation] a new instance of AtExitImplementation
  #
  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#13
  def initialize(*args); end

  # Add a handler to be run at `Kernel#at_exit`
  #
  # @param handler_id [Object] optionally provide an id, if already present, handler is replaced
  # @return id of the handler
  # @yield the handler
  #
  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#22
  def add(handler_id = T.unsafe(nil), &handler); end

  # Delete a handler by handler_id
  #
  # @return [true, false]
  #
  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#30
  def delete(handler_id); end

  # Configure if it runs during `Kernel#at_exit`
  #
  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#62
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#57
  def enabled?; end
  ...
  # @return [true, false]
  #
  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#36
  def handler?(handler_id); end

  # @return copy of the handlers
  #
  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#41
  def handlers; end

  # install `Kernel#at_exit` callback to execute added handlers
  #
  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#46
  def install; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#68
  def run; end

  private

  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#82
  def ns_initialize(enabled = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/utility/at_exit.rb#87
  def runner; end
end
...
# @see http://clojure.org/state Values and Change - Clojure's approach to Identity and State
#
# source://concurrent-ruby//lib/concurrent/atom.rb#95
class Concurrent::Atom < ::Concurrent::Synchronization::Object
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atom.rb#121
  def initialize(value, opts = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#169
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atom.rb#181
  def compare_and_set(old_value, new_value); end

  # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#125
  def deref; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atom.rb#198
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atom.rb#157
  def swap(*args); end
  ...
  # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#133
  def swap_value(value); end

  # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#141
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atom.rb#216
  ...
  class << self
    # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#58
    def new(*args, &block); end
  end
end
...
#
# source://concurrent-ruby//lib/concurrent/atomic/atomic_boolean.rb#119
class Concurrent::AtomicBoolean < ::Concurrent::MutexAtomicBoolean
  # @return [String] Short string representation.
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_boolean.rb#120
  def inspect; end
...
# source://concurrent-ruby//lib/concurrent/atomic/atomic_boolean.rb#81
Concurrent::AtomicBooleanImplementation = Concurrent::MutexAtomicBoolean

# Define update methods that use direct paths
#
# source://concurrent-ruby//lib/concurrent/atomic/atomic_reference.rb#19
module Concurrent::AtomicDirectUpdate
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_reference.rb#48
  def try_update; end
  ...
  # @yieldparam old_value [Object] the starting value of the atomic reference
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_reference.rb#72
  def try_update!; end
  ...
  # @yieldparam old_value [Object] the starting value of the atomic reference
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_reference.rb#31
  def update; end
end
...
#
# source://concurrent-ruby//lib/concurrent/atomic/atomic_fixnum.rb#136
class Concurrent::AtomicFixnum < ::Concurrent::MutexAtomicFixnum
  # @return [String] Short string representation.
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_fixnum.rb#137
  def inspect; end
...
# source://concurrent-ruby//lib/concurrent/atomic/atomic_fixnum.rb#98
...
#
# source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#7
class Concurrent::AtomicMarkableReference < ::Concurrent::Synchronization::Object
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#12
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#30
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#61
  def get; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#75
  def mark; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#88
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#149
  def try_update; end
  ...
  # @yieldparam old_mark [Boolean] the starting state of marked
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#125
  def try_update!; end
  ...
  # @yieldparam old_mark [Boolean] the starting state of marked
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#102
  def update; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#68
  def value; end
  ...
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_markable_reference.rb#160
...
#
# source://concurrent-ruby//lib/concurrent/atomic_reference/numeric_cas_wrapper.rb#7
module Concurrent::AtomicNumericCompareAndSetWrapper
  # source://concurrent-ruby//lib/concurrent/atomic_reference/numeric_cas_wrapper.rb#10
  def compare_and_set(old_value, new_value); end
end
...
#
# source://concurrent-ruby//lib/concurrent/atomic/atomic_reference.rb#195
class Concurrent::AtomicReference < ::Concurrent::MutexAtomicReference
  # @return [String] Short string representation.
  #
  # source://concurrent-ruby//lib/concurrent/atomic/atomic_reference.rb#198
  def inspect; end
...
# source://concurrent-ruby//lib/concurrent/atomic/atomic_reference.rb#148
...
#
# source://concurrent-ruby//lib/concurrent/executor/cached_thread_pool.rb#27
class Concurrent::CachedThreadPool < ::Concurrent::ThreadPoolExecutor
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/cached_thread_pool.rb#39
  ...
  # @see http://docs.oracle.com/javase/8/docs/api/java/util/concurrent/Executors.html#newCachedThreadPool--
  #
  # source://concurrent-ruby//lib/concurrent/executor/cached_thread_pool.rb#51
  def ns_initialize(opts); end
end

# Raised when an asynchronous operation is cancelled before execution.
#
# source://concurrent-ruby//lib/concurrent/errors.rb#9
...
# @api private
#
# source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#12
class Concurrent::Collection::CopyOnNotifyObserverSet < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#14
  def initialize; end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#20
  def add_observer(observer = T.unsafe(nil), func = T.unsafe(nil), &block); end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#55
  def count_observers; end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#39
  def delete_observer(observer); end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#47
  ...
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#72
  ...
  # @return [CopyOnWriteObserverSet] self
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#62
  ...
  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#80
  ...
  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#86
  def duplicate_and_clear_observers; end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#94
  def duplicate_observers; end

  # @api private
  # @raise [ArgumentError]
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_notify_observer_set.rb#98
...
# @api private
#
# source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#11
class Concurrent::Collection::CopyOnWriteObserverSet < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#13
  def initialize; end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#19
  def add_observer(observer = T.unsafe(nil), func = T.unsafe(nil), &block); end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#56
  def count_observers; end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#40
  def delete_observer(observer); end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#50
  def delete_observers; end
  ...
  # @return [CopyOnWriteObserverSet] self
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#72
  def notify_and_delete_observers(*args, &block); end
  ...
  # @return [CopyOnWriteObserverSet] self
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#63
  def notify_observers(*args, &block); end
  ...
  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#80
  def ns_initialize; end
  ...
  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#102
  def clear_observers_and_return_old; end

  # @api private
  # @raise [ArgumentError]
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#86
  def notify_to(observers, *args); end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#94
  def observers; end

  # @api private
  #
  # source://concurrent-ruby//lib/concurrent/collection/copy_on_write_observer_set.rb#98
...
#
# source://concurrent-ruby//lib/concurrent/collection/non_concurrent_priority_queue.rb#50
class Concurrent::Collection::NonConcurrentPriorityQueue < ::Concurrent::Collection::RubyNonConcurrentPriorityQueue
  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#78
  def <<(item); end

  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#65
  def deq; end

  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#78
  def enq(item); end

  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#48
  def has_priority?(item); end

  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#65
  def shift; end

  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#54
  def size; end
end

# source://concurrent-ruby//lib/concurrent/collection/non_concurrent_priority_queue.rb#10
Concurrent::Collection::NonConcurrentPriorityQueueImplementation = Concurrent::Collection::RubyNonConcurrentPriorityQueue

# source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#8
class Concurrent::Collection::RubyNonConcurrentPriorityQueue
  # @return [RubyNonConcurrentPriorityQueue] a new instance of RubyNonConcurrentPriorityQueue
  #
  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#11
  def initialize(opts = T.unsafe(nil)); end
  ...
  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#18
  def clear; end

  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#25
  def delete(item); end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#43
  def empty?; end
  ...
  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#60
  def peek; end
  ...
  #   else false
  #
  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#119
  def ordered?(x, y); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#128
  def sink(k); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#103
  def swap(x, y); end
  ...
  # @param k [Integer] the index at which to start the percolation
  #
  # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#142
  def swim(k); end

  class << self
    # @!macro priority_queue_method_from_list
    #
    # source://concurrent-ruby//lib/concurrent/collection/ruby_non_concurrent_priority_queue.rb#89
    def from_list(list, opts = T.unsafe(nil)); end
  end
end

# source://concurrent-ruby//lib/concurrent/concern/dereferenceable.rb#2
...
#
# source://concurrent-ruby//lib/concurrent/concern/dereferenceable.rb#11
module Concurrent::Concern::Dereferenceable
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/dereferenceable.rb#21
  def deref; end
  ...
  # source://concurrent-ruby//lib/concurrent/concern/dereferenceable.rb#63
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/dereferenceable.rb#54
  ...
  # @param opts [Hash] the options defining dereference behavior.
  #
  # source://concurrent-ruby//lib/concurrent/concern/dereferenceable.rb#48
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/dereferenceable.rb#31
  def value=(value); end
end

# Include where logging is needed
#
# source://concurrent-ruby//lib/concurrent/concern/logging.rb#9
module Concurrent::Concern::Logging
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/logging.rb#17
  def log(level, progname, message = T.unsafe(nil), &block); end
end

# source://concurrent-ruby//lib/concurrent/concern/obligation.rb#10
module Concurrent::Concern::Obligation
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#49
  def complete?; end
  ...
  #   raise rejected_ivar
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#126
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#20
  def fulfilled?; end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#56
  def incomplete?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#86
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#35
  def pending?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#119
  def reason; end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#28
  def rejected?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#110
  def state; end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#42
  def unscheduled?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#65
  ...
  # @return [Object] see Dereferenceable#deref
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#98
  def value!(timeout = T.unsafe(nil)); end
  ...
  # @return [Obligation] self
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#74
  def wait(timeout = T.unsafe(nil)); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#174
  def compare_and_set_state(next_state, *expected_current); end

  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#145
  def event; end

  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#134
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#190
  def if_state(*expected_states); end

  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#139
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#210
  def ns_check_state?(expected); end

  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#215
  def ns_set_state(value); end

  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#150
  def set_state(success, value, reason); end

  # source://concurrent-ruby//lib/concurrent/concern/obligation.rb#161
  def state=(value); end
end
...
# or an AtomicFixum)
#
# source://concurrent-ruby//lib/concurrent/concern/observable.rb#50
module Concurrent::Concern::Observable
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/observable.rb#61
  def add_observer(observer = T.unsafe(nil), func = T.unsafe(nil), &block); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/observable.rb#101
  def count_observers; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/observable.rb#82
  def delete_observer(observer); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/observable.rb#91
  def delete_observers; end
  ...
  # @return [Observable] self
  #
  # source://concurrent-ruby//lib/concurrent/concern/observable.rb#70
  ...
  #
  # source://concurrent-ruby//lib/concurrent/concern/observable.rb#107
  def observers; end
...
# source://concurrent-ruby//lib/concurrent/atomic/atomic_reference.rb#143
class Concurrent::ConcurrentUpdateError < ::ThreadError; end

# frozen pre-allocated backtrace to speed ConcurrentUpdateError
#
# source://concurrent-ruby//lib/concurrent/atomic/atomic_reference.rb#144
Concurrent::ConcurrentUpdateError::CONC_UP_ERR_BACKTRACE = T.let(T.unsafe(nil), Array)

# Raised when errors occur during configuration.
#
# source://concurrent-ruby//lib/concurrent/errors.rb#6
...
#
# source://concurrent-ruby//lib/concurrent/atomic/count_down_latch.rb#98
class Concurrent::CountDownLatch < ::Concurrent::MutexCountDownLatch; end

# source://concurrent-ruby//lib/concurrent/atomic/count_down_latch.rb#56
...
#
# source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#27
class Concurrent::CyclicBarrier < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#40
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#105
  def broken?; end

  # @return [Fixnum] the number of threads currently waiting on the barrier
  #
  # source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#54
  def number_waiting; end

  # @return [Fixnum] the number of threads needed to pass the barrier
  #
  # source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#49
  def parties; end
  ...
  # @return [nil]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#95
  def reset; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#66
  def wait(timeout = T.unsafe(nil)); end

  protected

  # source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#111
  def ns_generation_done(generation, status, continue = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#122
  def ns_initialize(parties, &block); end

  # source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#117
  def ns_next_generation; end
end

# source://concurrent-ruby//lib/concurrent/atomic/cyclic_barrier.rb#30
...
#
# source://concurrent-ruby//lib/concurrent/delay.rb#44
class Concurrent::Delay < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/delay.rb#62
  ...
  # @yield the delayed operation to perform
  #
  # source://concurrent-ruby//lib/concurrent/delay.rb#146
  ...
  # @return [Object] the current value of the object
  #
  # source://concurrent-ruby//lib/concurrent/delay.rb#77
  def value(timeout = T.unsafe(nil)); end
  ...
  # @return [Object] the current value of the object
  #
  # source://concurrent-ruby//lib/concurrent/delay.rb#113
  def value!(timeout = T.unsafe(nil)); end
  ...
  # @return [Object] self
  #
  # source://concurrent-ruby//lib/concurrent/delay.rb#132
  def wait(timeout = T.unsafe(nil)); end

  protected

  # source://concurrent-ruby//lib/concurrent/delay.rb#160
  def ns_initialize(opts, &block); end

  private

  # source://concurrent-ruby//lib/concurrent/delay.rb#173
  def execute_task_once; end
end

# source://concurrent-ruby//lib/concurrent/dataflow.rb#7
class Concurrent::DependencyCounter
  # @return [DependencyCounter] a new instance of DependencyCounter
  #
  # source://concurrent-ruby//lib/concurrent/dataflow.rb#9
  def initialize(count, &block); end

  # source://concurrent-ruby//lib/concurrent/dataflow.rb#14
  def update(time, value, reason); end
end

# source://concurrent-ruby//lib/concurrent/errors.rb#3
...
#
# source://concurrent-ruby//lib/concurrent/atomic/event.rb#36
class Concurrent::Event < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/event.rb#40
  def initialize; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/event.rb#68
  def reset; end
  ...
  # @return [Boolean] should always return `true`
  #
  # source://concurrent-ruby//lib/concurrent/atomic/event.rb#56
  def set; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/event.rb#48
  def set?; end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/event.rb#60
  def try?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/event.rb#83
  def wait(timeout = T.unsafe(nil)); end

  protected

  # source://concurrent-ruby//lib/concurrent/atomic/event.rb#104
  def ns_initialize; end

  # source://concurrent-ruby//lib/concurrent/atomic/event.rb#96
  def ns_set; end
end
...
#
# source://concurrent-ruby//lib/concurrent/exchanger.rb#335
class Concurrent::Exchanger < ::Concurrent::RubyExchanger; end

# source://concurrent-ruby//lib/concurrent/exchanger.rb#326
Concurrent::ExchangerImplementation = Concurrent::RubyExchanger

# source://concurrent-ruby//lib/concurrent/executor/executor_service.rb#157
module Concurrent::ExecutorService
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/executor_service.rb#166
  def <<(task); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/executor_service.rb#174
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/executor_service.rb#161
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/executor_service.rb#181
  def serialized?; end
end
...
#
# source://concurrent-ruby//lib/concurrent/executor/fixed_thread_pool.rb#183
class Concurrent::FixedThreadPool < ::Concurrent::ThreadPoolExecutor
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/fixed_thread_pool.rb#197
...
#
# source://concurrent-ruby//lib/concurrent/future.rb#21
class Concurrent::Future < ::Concurrent::IVar
  ...
  #
  # source://concurrent-ruby//lib/concurrent/future.rb#33
  def initialize(opts = T.unsafe(nil), &block); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/future.rb#99
  def cancel; end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/future.rb#111
  def cancelled?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/future.rb#53
  def execute; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/future.rb#82
  ...
  #   else false
  #
  # source://concurrent-ruby//lib/concurrent/future.rb#121
  def wait_or_cancel(timeout); end

  protected

  # source://concurrent-ruby//lib/concurrent/future.rb#133
  ...
  class << self
    ...
    # @yield the asynchronous operation to perform
    #
    # source://concurrent-ruby//lib/concurrent/future.rb#77
    def execute(opts = T.unsafe(nil), &block); end
  end
end

# source://concurrent-ruby//lib/concurrent/configuration.rb#100
Concurrent::GLOBAL_FAST_EXECUTOR = T.let(T.unsafe(nil), Concurrent::Delay)

# source://concurrent-ruby//lib/concurrent/configuration.rb#112
Concurrent::GLOBAL_IMMEDIATE_EXECUTOR = T.let(T.unsafe(nil), Concurrent::ImmediateExecutor)

# source://concurrent-ruby//lib/concurrent/configuration.rb#104
Concurrent::GLOBAL_IO_EXECUTOR = T.let(T.unsafe(nil), Concurrent::Delay)

# source://concurrent-ruby//lib/concurrent/configuration.rb#88
Concurrent::GLOBAL_LOGGER = T.let(T.unsafe(nil), Concurrent::AtomicReference)

# Clock that cannot be set and represents monotonic time since
# some unspecified starting point.
#
# source://concurrent-ruby//lib/concurrent/utility/monotonic_time.rb#42
Concurrent::GLOBAL_MONOTONIC_CLOCK = T.let(T.unsafe(nil), T.untyped)

# source://concurrent-ruby//lib/concurrent/configuration.rb#108
...
#
# source://concurrent-ruby//lib/concurrent/hash.rb#56
class Concurrent::Hash < ::Hash; end

# source://concurrent-ruby//lib/concurrent/hash.rb#16
...
#
# source://concurrent-ruby//lib/concurrent/ivar.rb#47
class Concurrent::IVar < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/ivar.rb#61
  ...
  # @raise [ArgumentError]
  #
  # source://concurrent-ruby//lib/concurrent/ivar.rb#80
  def add_observer(observer = T.unsafe(nil), func = T.unsafe(nil), &block); end
  ...
  # @return [IVar] self
  #
  # source://concurrent-ruby//lib/concurrent/ivar.rb#134
  ...
  # @yield A block operation to use for setting the value
  #
  # source://concurrent-ruby//lib/concurrent/ivar.rb#112
  ...
  # @yield A block operation to use for setting the value
  #
  # source://concurrent-ruby//lib/concurrent/ivar.rb#144
  def try_set(value = T.unsafe(nil), &block); end

  protected

  # source://concurrent-ruby//lib/concurrent/ivar.rb#201
  def check_for_block_or_value!(block_given, value); end

  # source://concurrent-ruby//lib/concurrent/ivar.rb#176
  def complete(success, value, reason); end

  # source://concurrent-ruby//lib/concurrent/ivar.rb#183
  def complete_without_notification(success, value, reason); end

  # source://concurrent-ruby//lib/concurrent/ivar.rb#189
  def notify_observers(value, reason); end

  # @raise [MultipleAssignmentError]
  #
  # source://concurrent-ruby//lib/concurrent/ivar.rb#194
  def ns_complete_without_notification(success, value, reason); end

  # source://concurrent-ruby//lib/concurrent/ivar.rb#154
  def ns_initialize(value, opts); end

  # source://concurrent-ruby//lib/concurrent/ivar.rb#167
...
#
# source://concurrent-ruby//lib/concurrent/errors.rb#20
...
#
# source://concurrent-ruby//lib/concurrent/executor/immediate_executor.rb#17
class Concurrent::ImmediateExecutor < ::Concurrent::AbstractExecutorService
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/immediate_executor.rb#21
  def initialize; end

  # source://concurrent-ruby//lib/concurrent/executor/immediate_executor.rb#34
  def <<(task); end

  # source://concurrent-ruby//lib/concurrent/executor/immediate_executor.rb#55
  def kill; end

  # @raise [ArgumentError]
  #
  # source://concurrent-ruby//lib/concurrent/executor/immediate_executor.rb#26
  def post(*args, &task); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/executor/immediate_executor.rb#40
  def running?; end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/executor/immediate_executor.rb#50
  def shutdown?; end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/executor/immediate_executor.rb#45
  def shuttingdown?; end

  # source://concurrent-ruby//lib/concurrent/executor/immediate_executor.rb#62
  def wait_for_termination(timeout = T.unsafe(nil)); end
end

# Raised when an attempt is made to violate an immutability guarantee.
#
# source://concurrent-ruby//lib/concurrent/errors.rb#16
...
#
# source://concurrent-ruby//lib/concurrent/immutable_struct.rb#9
module Concurrent::ImmutableStruct
  include ::Concurrent::Synchronization::AbstractStruct

  # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#51
  def ==(other); end

  # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#46
  def [](member); end

  # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#56
  def each(&block); end

  # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#62
  def each_pair(&block); end

  # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#29
  def inspect; end

  # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#36
  def merge(other, &block); end

  # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#68
  def select(&block); end

  # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#17
  def to_a; end

  # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#41
  def to_h; end
  ...
  # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#24
  def values_at(*indexes); end

  class << self
    # @private
    #
    # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#12
    def included(base); end

    # source://concurrent-ruby//lib/concurrent/immutable_struct.rb#74
    def new(*args, &block); end
  end
end

# source://concurrent-ruby//lib/concurrent/immutable_struct.rb#84
...
# @note Intended for use primarily in testing and debugging.
#
# source://concurrent-ruby//lib/concurrent/executor/indirect_immediate_executor.rb#20
class Concurrent::IndirectImmediateExecutor < ::Concurrent::ImmediateExecutor
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/indirect_immediate_executor.rb#21
  def initialize; end
  ...
  # @yield the asynchronous task to perform
  #
  # source://concurrent-ruby//lib/concurrent/executor/indirect_immediate_executor.rb#27
  def post(*args, &task); end
end
...
#
# source://concurrent-ruby//lib/concurrent/errors.rb#24
class Concurrent::InitializationError < ::Concurrent::Error; end

# Raised when a lifecycle method (such as `stop`) is called in an improper
# sequence or when the object is in an inappropriate state.
#
# source://concurrent-ruby//lib/concurrent/errors.rb#13
class Concurrent::LifecycleError < ::Concurrent::Error; end

# source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#4
class Concurrent::LockFreeStack < ::Concurrent::Synchronization::Object
  ...
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#49
  ...
  # @return [true, false]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#116
  def clear; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#140
  def clear_each(&block); end

  # @param head [Node]
  # @return [true, false]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#126
  def clear_if(head); end

  # @param head [Node]
  # @return [true, false]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#97
  def compare_and_clear(head); end

  # @param head [Node]
  # @return [true, false]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#83
  ...
  # @return [true, false]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#63
  def compare_and_push(head, value); end

  # @param head [Node]
  # @return [self]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#105
  def each(head = T.unsafe(nil)); end

  # @param head [Node]
  # @return [true, false]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#56
  def empty?(head = T.unsafe(nil)); end

  # @return [String] Short string representation.
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#152
  def inspect; end

  # @return [Node]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#77
  def peek; end

  # @return [Object]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#88
  def pop; end

  # @param value [Object]
  # @return [self]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#69
  def push(value); end
  ...
  # @return [true, false]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#133
  ...
  class << self
    ...
    # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#39
    def of1(value); end

    # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#44
...
#
# source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#30
Concurrent::LockFreeStack::EMPTY = T.let(T.unsafe(nil), Concurrent::LockFreeStack::Node)

# source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#8
class Concurrent::LockFreeStack::Node
  # @return [Node] a new instance of Node
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#21
  def initialize(value, next_node); end

  # @return [Node]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#12
  def next_node; end

  # @return [Object]
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#15
  def value; end

  # allow to nil-ify to free GC when the entry is no longer relevant, not synchronised
  #
  # source://concurrent-ruby//lib/concurrent/collection/lock_free_stack.rb#19
  def value=(_arg0); end
...
#    (PoPL), 1996.
#
# source://concurrent-ruby//lib/concurrent/mvar.rb#38
class Concurrent::MVar < ::Concurrent::Synchronization::Object
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#54
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#86
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#195
  def empty?; end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#200
  def full?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#123
  ...
  # @raise [ArgumentError]
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#179
  def modify!; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#66
  def take(timeout = T.unsafe(nil)); end

  # Non-blocking version of `put`, that returns whether or not it was successful.
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#156
  def try_put!(value); end

  # Non-blocking version of `take`, that returns `EMPTY` instead of blocking.
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#142
  def try_take!; end

  protected

  # source://concurrent-ruby//lib/concurrent/mvar.rb#206
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#212
  def unlocked_empty?; end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/mvar.rb#216
  def unlocked_full?; end

  # source://concurrent-ruby//lib/concurrent/mvar.rb#224
  def wait_for_empty(timeout); end

  # source://concurrent-ruby//lib/concurrent/mvar.rb#220
  def wait_for_full(timeout); end

  # source://concurrent-ruby//lib/concurrent/mvar.rb#228
...
# policy or strategy.
#
# source://concurrent-ruby//lib/concurrent/errors.rb#29
...
#
# source://concurrent-ruby//lib/concurrent/maybe.rb#104
class Concurrent::Maybe < ::Concurrent::Synchronization::Object
  ...
  #
  # source://concurrent-ruby//lib/concurrent/maybe.rb#224
  ...
  #
  # source://concurrent-ruby//lib/concurrent/maybe.rb#199
  def <=>(other); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/maybe.rb#176
  def fulfilled?; end

  # The value of a `Maybe` when `Just`. Will be `NONE` when `Nothing`.
  #
  # source://concurrent-ruby//lib/concurrent/maybe.rb#114
  def just; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/maybe.rb#117
  def nothing; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/maybe.rb#184
  def nothing?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/maybe.rb#210
  def or(other); end
  ...
  class << self
    ...
    #
    # source://concurrent-ruby//lib/concurrent/maybe.rb#137
    def from(*args); end
    ...
    # @return [Maybe] The newly created object.
    #
    # source://concurrent-ruby//lib/concurrent/maybe.rb#152
    def just(value); end
    ...
    # @return [Maybe] The newly created object.
    #
    # source://concurrent-ruby//lib/concurrent/maybe.rb#164
...
#
# source://concurrent-ruby//lib/concurrent/maybe.rb#111
...
#
# source://concurrent-ruby//lib/concurrent/errors.rb#33
class Concurrent::MultipleAssignmentError < ::Concurrent::Error
  ...
  #
  # source://concurrent-ruby//lib/concurrent/errors.rb#36
  def initialize(message = T.unsafe(nil), inspection_data = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/errors.rb#41
  def inspect; end

  # Returns the value of attribute inspection_data.
  #
  # source://concurrent-ruby//lib/concurrent/errors.rb#34
  def inspection_data; end
end

# Aggregates multiple exceptions.
#
# source://concurrent-ruby//lib/concurrent/errors.rb#58
class Concurrent::MultipleErrors < ::Concurrent::Error
  # @return [MultipleErrors] a new instance of MultipleErrors
  #
  # source://concurrent-ruby//lib/concurrent/errors.rb#61
  def initialize(errors, message = T.unsafe(nil)); end

  # Returns the value of attribute errors.
  #
  # source://concurrent-ruby//lib/concurrent/errors.rb#59
  def errors; end
end
...
# @see http://ruby-doc.org/core-2.2.0/Struct.html Ruby standard library `Struct`
#
# source://concurrent-ruby//lib/concurrent/mutable_struct.rb#10
module Concurrent::MutableStruct
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#128
  def ==(other); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#118
  def [](member); end
  ...
  # @return [Object] the value of the given struct member or the member at the given index.
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#185
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#139
  def each(&block); end
  ...
  # @yieldparam value [Object] each struct value (in order)
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#152
  def each_pair(&block); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#72
  def inspect; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#94
  def merge(other, &block); end
  ...
  # @yieldparam value [Object] each struct value (in order)
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#167
  def select(&block); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#51
  def to_a; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#103
  def to_h; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#63
  def values_at(*indexes); end
  ...
  class << self
    ...
    #
    # source://concurrent-ruby//lib/concurrent/mutable_struct.rb#200
    def new(*args, &block); end
  end
end

# source://concurrent-ruby//lib/concurrent/mutable_struct.rb#210
Concurrent::MutableStruct::FACTORY = T.let(T.unsafe(nil), T.untyped)

# source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_boolean.rb#8
class Concurrent::MutexAtomicBoolean < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_boolean.rb#11
  def initialize(initial = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_boolean.rb#32
  def false?; end

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_boolean.rb#42
  def make_false; end

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_boolean.rb#37
  def make_true; end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_boolean.rb#27
  def true?; end

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_boolean.rb#17
  def value; end

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_boolean.rb#22
  def value=(value); end

  protected

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_boolean.rb#49
  def ns_initialize(initial); end

  private

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_boolean.rb#56
...
# @see http://docs.oracle.com/javase/7/docs/api/java/util/concurrent/atomic/AtomicLong.html java.util.concurrent.atomic.AtomicLong
#
# source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_fixnum.rb#9
class Concurrent::MutexAtomicFixnum < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_fixnum.rb#12
  def initialize(initial = T.unsafe(nil)); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_fixnum.rb#42
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_fixnum.rb#35
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_fixnum.rb#28
  ...
  # @yieldparam old_value [Object] the starting value of the atomic reference
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_fixnum.rb#54
  def update; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_fixnum.rb#18
  def value; end
  ...
  # @return [Fixnum] the current value
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_fixnum.rb#23
  def value=(value); end

  protected

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_fixnum.rb#63
  def ns_initialize(initial); end

  private

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_atomic_fixnum.rb#70
  def ns_set(value); end
end

# source://concurrent-ruby//lib/concurrent/atomic_reference/mutex_atomic.rb#5
class Concurrent::MutexAtomicReference < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic_reference/mutex_atomic.rb#11
  def initialize(value = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/atomic_reference/mutex_atomic.rb#39
  def _compare_and_set(old_value, new_value); end

  # source://concurrent-ruby//lib/concurrent/atomic_reference/numeric_cas_wrapper.rb#10
  def compare_and_swap(old_value, new_value); end

  # source://concurrent-ruby//lib/concurrent/atomic_reference/mutex_atomic.rb#17
  def get; end

  # source://concurrent-ruby//lib/concurrent/atomic_reference/mutex_atomic.rb#29
  def get_and_set(new_value); end

  # source://concurrent-ruby//lib/concurrent/atomic_reference/mutex_atomic.rb#23
  ...
  # source://concurrent-ruby//lib/concurrent/atomic_reference/mutex_atomic.rb#52
...
# with its work. A `CountDownLatch` can be used only once. Its value cannot be reset.
#
# source://concurrent-ruby//lib/concurrent/atomic/mutex_count_down_latch.rb#9
class Concurrent::MutexCountDownLatch < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_count_down_latch.rb#12
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_count_down_latch.rb#34
  def count; end

  # Signal the latch to decrement the counter. Will signal all blocked threads when
  # the `count` reaches zero.
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_count_down_latch.rb#26
  def count_down; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_count_down_latch.rb#21
  def wait(timeout = T.unsafe(nil)); end

  protected

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_count_down_latch.rb#40
...
#
# source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#9
class Concurrent::MutexSemaphore < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#12
  ...
  # @return [nil]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#20
  ...
  # @return [Integer]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#31
  ...
  # @return [Integer]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#40
  ...
  # @return [nil]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#83
  ...
  # @return [nil]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#61
  ...
  #   acquired a permit
  #
  # source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#47
  def try_acquire(permits = T.unsafe(nil), timeout = T.unsafe(nil)); end

  protected

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#94
  def ns_initialize(count); end

  private

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#101
  def try_acquire_now(permits); end

  # source://concurrent-ruby//lib/concurrent/atomic/mutex_semaphore.rb#111
...
#
# source://concurrent-ruby//lib/concurrent/configuration.rb#85
Concurrent::NULL_LOGGER = T.let(T.unsafe(nil), Proc)

# source://concurrent-ruby//lib/concurrent/options.rb#6
module Concurrent::Options
  class << self
    # source://concurrent-ruby//lib/concurrent/options.rb#27
    def executor(executor_identifier); end
    ...
    #
    # source://concurrent-ruby//lib/concurrent/options.rb#19
...
#
# source://concurrent-ruby//lib/concurrent/promise.rb#190
class Concurrent::Promise < ::Concurrent::IVar
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promise.rb#210
  def initialize(opts = T.unsafe(nil), &block); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promise.rb#359
  def catch(&block); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promise.rb#246
  def execute; end
  ...
  # @return [IVar] self
  #
  # source://concurrent-ruby//lib/concurrent/promise.rb#277
  def fail(reason = T.unsafe(nil)); end
  ...
  # @return [Promise]
  #
  # source://concurrent-ruby//lib/concurrent/promise.rb#374
  ...
  # @yield The block to execute
  #
  # source://concurrent-ruby//lib/concurrent/promise.rb#348
  ...
  # @yield A block operation to use for setting the value
  #
  # source://concurrent-ruby//lib/concurrent/promise.rb#261
  def set(value = T.unsafe(nil), &block); end
  ...
  # @yield The block operation to be performed asynchronously.
  #
  # source://concurrent-ruby//lib/concurrent/promise.rb#313
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promise.rb#439
  def zip(*others); end

  protected

  # source://concurrent-ruby//lib/concurrent/promise.rb#550
  def complete(success, value, reason); end

  # source://concurrent-ruby//lib/concurrent/promise.rb#544
  def notify_child(child); end

  # source://concurrent-ruby//lib/concurrent/promise.rb#480
  def ns_initialize(value, opts); end

  # source://concurrent-ruby//lib/concurrent/promise.rb#532
  def on_fulfill(result); end

  # source://concurrent-ruby//lib/concurrent/promise.rb#538
  def on_reject(reason); end

  # source://concurrent-ruby//lib/concurrent/promise.rb#561
  def realize(task); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promise.rb#527
  def root?; end

  # source://concurrent-ruby//lib/concurrent/promise.rb#519
  def set_pending; end

  # source://concurrent-ruby//lib/concurrent/promise.rb#569
  def set_state!(success, value, reason); end

  # source://concurrent-ruby//lib/concurrent/promise.rb#575
  ...
  class << self
    ...
    #
    # source://concurrent-ruby//lib/concurrent/promise.rb#504
    ...
    # @return [Boolean]
    #
    # source://concurrent-ruby//lib/concurrent/promise.rb#463
    ...
    #   the promises given as arguments
    #
    # source://concurrent-ruby//lib/concurrent/promise.rb#474
    ...
    #
    # source://concurrent-ruby//lib/concurrent/promise.rb#295
    def execute(opts = T.unsafe(nil), &block); end
    ...
    #
    # source://concurrent-ruby//lib/concurrent/promise.rb#224
    ...
    # @return [Promise] the newly created `Promise`
    #
    # source://concurrent-ruby//lib/concurrent/promise.rb#237
    ...
    # @return [Promise<Array>]
    #
    # source://concurrent-ruby//lib/concurrent/promise.rb#408
    def zip(*promises); end
  end
end

# source://concurrent-ruby//lib/concurrent/promise.rb#11
class Concurrent::PromiseExecutionError < ::StandardError; end

# {include:file:docs-source/promises-main.md}
#
# source://concurrent-ruby//lib/concurrent/promises.rb#11
...
# @abstract
#
# source://concurrent-ruby//lib/concurrent/promises.rb#2036
...
#
# source://concurrent-ruby//lib/concurrent/promises.rb#511
class Concurrent::Promises::AbstractEventFuture < ::Concurrent::Synchronization::Object
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#520
  def initialize(promise, default_executor); end

  # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#169
  def __initialize_atomic_fields__; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#736
  def add_callback_clear_delayed_node(node); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#731
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#700
  def blocks; end

  # For inspection.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#708
  def callbacks; end
  ...
  # @see #chain_on
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#594
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#612
  ...
  # @return [self]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#627
  ...
  # @see similar
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#588
  def default_executor; end

  # @return [String] Short string representation.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#617
  def inspect; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#635
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#653
  def on_resolution!(*args, &callback); end
  ...
  # @yieldreturn is forgotten.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#671
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#547
  def pending?; end

  # For inspection.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#714
  def promise; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#686
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#553
  def resolved?; end
  ...
  # @return [Symbol]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#541
  def state; end
  ...
  # @return [self]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#560
  def touch; end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#720
  def touched?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#576
  def wait(timeout = T.unsafe(nil)); end

  # For inspection.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#726
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#681
  def with_default_executor(executor); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#741
  def with_hidden_resolvable; end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#748
  def add_callback(method, *args); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#801
  def async_callback_on_resolution(state, executor, args, callback); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#785
  def call_callback(method, state, args); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#789
  def call_callbacks(state); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#761
  def callback_clear_delayed_node(state, node); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#807
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#766
  def wait_until_resolved(timeout); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#797
...
# source://concurrent-ruby//lib/concurrent/promises.rb#1785
class Concurrent::Promises::AbstractFlatPromise < ::Concurrent::Promises::BlockedPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1787
  def initialize(delayed_because, blockers_count, event_or_future); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1797
  def touch; end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1817
  def add_delayed_of(future); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1809
  def on_resolvable(resolved_future, index); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1813
  def resolvable?(countdown, future, index); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1805
  def touched?; end
end
...
# @private
#
# source://concurrent-ruby//lib/concurrent/promises.rb#1538
class Concurrent::Promises::AbstractPromise < ::Concurrent::Synchronization::Object
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1542
  def initialize(future); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1553
  def default_executor; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1570
  def delayed_because; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1547
  def event; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1547
  def future; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1564
  def inspect; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1557
  def state; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1564
  def to_s; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1561
  def touch; end
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1581
  def evaluate_to(*args, block); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1576
...
# source://concurrent-ruby//lib/concurrent/promises.rb#2073
class Concurrent::Promises::AnyFulfilledFuturePromise < ::Concurrent::Promises::AnyResolvedFuturePromise
  private

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#2077
  def resolvable?(countdown, future, index); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#2039
class Concurrent::Promises::AnyResolvedEventPromise < ::Concurrent::Promises::AbstractAnyPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#2043
  def initialize(delayed, blockers_count, default_executor); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#2051
  def on_resolvable(resolved_future, index); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#2047
  def resolvable?(countdown, future, index); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#2056
class Concurrent::Promises::AnyResolvedFuturePromise < ::Concurrent::Promises::AbstractAnyPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#2060
  def initialize(delayed, blockers_count, default_executor); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#2068
  def on_resolvable(resolved_future, index); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#2064
  def resolvable?(countdown, future, index); end
end

# @abstract
#
# source://concurrent-ruby//lib/concurrent/promises.rb#1608
class Concurrent::Promises::BlockedPromise < ::Concurrent::Promises::InnerPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1650
  def initialize(delayed, blockers_count, future); end

  # for inspection only
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1672
  def blocked_by; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1663
  def delayed_because; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1656
  def on_blocker_resolution(future, index); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1667
  def touch; end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1680
  def clear_and_propagate_touch(stack_or_element = T.unsafe(nil)); end

  # @raise [NotImplementedError]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1699
  def on_resolvable(resolved_future, index); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1695
  def process_on_blocker_resolution(future, index); end

  # @return [true, false] if resolvable
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1691
  def resolvable?(countdown, future, index); end

  class << self
    # source://concurrent-ruby//lib/concurrent/promises.rb#1641
    def add_delayed(delayed1, delayed2); end

    # source://concurrent-ruby//lib/concurrent/promises.rb#1634
    def new_blocked_by(blockers, *args, &block); end

    # source://concurrent-ruby//lib/concurrent/promises.rb#1612
    def new_blocked_by1(blocker, *args, &block); end

    # source://concurrent-ruby//lib/concurrent/promises.rb#1619
...
# @abstract
#
# source://concurrent-ruby//lib/concurrent/promises.rb#1705
class Concurrent::Promises::BlockedTaskPromise < ::Concurrent::Promises::BlockedPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1706
  def initialize(delayed, blockers_count, default_executor, executor, args, &task); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1714
  def executor; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1755
class Concurrent::Promises::ChainPromise < ::Concurrent::Promises::BlockedTaskPromise
  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1758
  def on_resolvable(resolved_future, index); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#2084
class Concurrent::Promises::DelayPromise < ::Concurrent::Promises::InnerPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#2086
  def initialize(default_executor); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#2097
  def delayed_because; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#2093
  def touch; end
end
...
# cancellation.
#
# source://concurrent-ruby//lib/concurrent/promises.rb#815
class Concurrent::Promises::Event < ::Concurrent::Promises::AbstractEventFuture
  ...
  # @return [Future, Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#828
  def &(other); end
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#842
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#852
  def delay; end
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#864
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#882
  def to_event; end
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#874
  def to_future; end
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#888
  def with_default_executor(executor); end
  ...
  # source://concurrent-ruby//lib/concurrent/promises.rb#899
  def callback_on_resolution(state, args, callback); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#894
  def rejected_resolution(raise_on_reassign, state); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1961
class Concurrent::Promises::EventWrapperPromise < ::Concurrent::Promises::BlockedPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1962
  def initialize(delayed, blockers_count, default_executor); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1968
  def on_resolvable(resolved_future, index); end
end
...
# new.
#
# source://concurrent-ruby//lib/concurrent/promises.rb#44
module Concurrent::Promises::FactoryMethods
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#276
  ...
  # @see #any_event_on
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#317
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#327
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#298
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#311
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#292
  ...
  # @see #delay_on
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#188
  ...
  #   executor parameter or changed with {AbstractEventFuture#with_default_executor}.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#205
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#125
  ...
  # @see #future_on
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#92
  ...
  #   raised exception becomes {Future#reason} rejecting it.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#104
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#172
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#134
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#61
  ...
  # @return [ResolvableEvent]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#70
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#76
  ...
  # @return [ResolvableFuture]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#86
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#142
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#116
  ...
  # @see #schedule_on
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#212
  ...
  #   `Time` means to run on `intended_time`.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#231
  ...
  # @see #zip_futures_on
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#238
  ...
  # @see #zip_events_on
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#260
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#270
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#252
  def zip_futures_on(default_executor, *futures_and_or_events); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#48
module Concurrent::Promises::FactoryMethods::Configuration
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#52
  def default_executor; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1829
class Concurrent::Promises::FlatEventPromise < ::Concurrent::Promises::AbstractFlatPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1833
  def initialize(delayed, blockers_count, default_executor); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1837
  def process_on_blocker_resolution(future, index); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1862
class Concurrent::Promises::FlatFuturePromise < ::Concurrent::Promises::AbstractFlatPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1866
  def initialize(delayed, blockers_count, levels, default_executor); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1873
  def process_on_blocker_resolution(future, index); end
end
...
#
# source://concurrent-ruby//lib/concurrent/promises.rb#906
class Concurrent::Promises::Future < ::Concurrent::Promises::AbstractEventFuture
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1059
  def &(other); end
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1074
  def any(event_or_future); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1204
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1084
  def delay; end
  ...
  # @return [Exception]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1002
  def exception(*args); end
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1109
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1119
  def flat_event; end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#910
  def fulfilled?; end

  # @return [String] Short string representation.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1224
  def inspect; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1125
  ...
  # @yieldreturn is forgotten.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1136
  def on_fulfillment!(*args, &callback); end
  ...
  # @yieldreturn is forgotten.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1148
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1154
  ...
  # @yieldreturn is forgotten.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1165
  def on_rejection!(*args, &callback); end
  ...
  # @yieldreturn is forgotten.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1177
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#955
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#917
  def rejected?; end
  ...
  # @see #rescue_on
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1041
  ...
  #   raised exception becomes {Future#reason} rejecting it.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1053
  ...
  #   on timeout.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#970
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1199
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1091
  def schedule(intended_time); end
  ...
  # @see #then_on
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1023
  def then(*args, &task); end
  ...
  #   raised exception becomes {Future#reason} rejecting it.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1035
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1211
  def to_event; end
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1219
  def to_future; end
  ...
  #   nil on rejection.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#939
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#986
  def value!(timeout = T.unsafe(nil), timeout_value = T.unsafe(nil)); end
  ...
  #   and it was resolved, false implies it was not resolved within timeout.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#976
  def wait!(timeout = T.unsafe(nil)); end
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1100
  def with_default_executor(executor); end
  ...
  # source://concurrent-ruby//lib/concurrent/promises.rb#1261
  def async_callback_on_fulfillment(state, executor, args, callback); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1267
  def async_callback_on_rejection(state, executor, args, callback); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1273
  def callback_on_fulfillment(state, args, callback); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1277
  def callback_on_rejection(state, args, callback); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1281
  def callback_on_resolution(state, args, callback); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1240
  def rejected_resolution(raise_on_reassign, state); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1236
  def run_test(v); end

  # @raise [self]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1255
  def wait_until_resolved!(timeout = T.unsafe(nil)); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1973
class Concurrent::Promises::FutureWrapperPromise < ::Concurrent::Promises::BlockedPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1974
  def initialize(delayed, blockers_count, default_executor); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1980
  def on_resolvable(resolved_future, index); end
end

# will be immediately resolved
#
# source://concurrent-ruby//lib/concurrent/promises.rb#1772
class Concurrent::Promises::ImmediateEventPromise < ::Concurrent::Promises::InnerPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1773
  def initialize(default_executor); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1778
class Concurrent::Promises::ImmediateFuturePromise < ::Concurrent::Promises::InnerPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1779
  def initialize(default_executor, fulfilled, value, reason); end
end

# @abstract
#
# source://concurrent-ruby//lib/concurrent/promises.rb#1604
class Concurrent::Promises::InnerPromise < ::Concurrent::Promises::AbstractPromise; end

# source://concurrent-ruby//lib/concurrent/promises.rb#336
module Concurrent::Promises::InternalStates; end

# source://concurrent-ruby//lib/concurrent/promises.rb#395
class Concurrent::Promises::InternalStates::Fulfilled < ::Concurrent::Promises::InternalStates::ResolvedWithResult
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#397
  def initialize(value); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#405
  def apply(args, block); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#401
  def fulfilled?; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#413
  def reason; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#417
  def to_sym; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#409
  def value; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#423
class Concurrent::Promises::InternalStates::FulfilledArray < ::Concurrent::Promises::InternalStates::Fulfilled
  # source://concurrent-ruby//lib/concurrent/promises.rb#424
  def apply(args, block); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#486
Concurrent::Promises::InternalStates::PENDING = T.let(T.unsafe(nil), Concurrent::Promises::InternalStates::Pending)

# source://concurrent-ruby//lib/concurrent/promises.rb#457
class Concurrent::Promises::InternalStates::PartiallyRejected < ::Concurrent::Promises::InternalStates::ResolvedWithResult
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#458
  def initialize(value, reason); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#480
  def apply(args, block); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#464
  def fulfilled?; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#476
  def reason; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#468
  def to_sym; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#472
  def value; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#349
class Concurrent::Promises::InternalStates::Pending < ::Concurrent::Promises::InternalStates::State
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#350
  def resolved?; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#354
  def to_sym; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#488
Concurrent::Promises::InternalStates::RESERVED = T.let(T.unsafe(nil), Concurrent::Promises::InternalStates::Reserved)

# source://concurrent-ruby//lib/concurrent/promises.rb#490
Concurrent::Promises::InternalStates::RESOLVED = T.let(T.unsafe(nil), Concurrent::Promises::InternalStates::Fulfilled)

# source://concurrent-ruby//lib/concurrent/promises.rb#430
class Concurrent::Promises::InternalStates::Rejected < ::Concurrent::Promises::InternalStates::ResolvedWithResult
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#431
  def initialize(reason); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#451
  def apply(args, block); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#435
  def fulfilled?; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#443
  def reason; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#447
  def to_sym; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#439
  def value; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#360
class Concurrent::Promises::InternalStates::Reserved < ::Concurrent::Promises::InternalStates::Pending; end

# source://concurrent-ruby//lib/concurrent/promises.rb#364
class Concurrent::Promises::InternalStates::ResolvedWithResult < ::Concurrent::Promises::InternalStates::State
  # @raise [NotImplementedError]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#389
  def apply; end

  # @raise [NotImplementedError]
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#377
  def fulfilled?; end

  # @raise [NotImplementedError]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#385
  def reason; end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#365
  def resolved?; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#373
  def result; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#369
  def to_sym; end

  # @raise [NotImplementedError]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#381
  def value; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#338
class Concurrent::Promises::InternalStates::State
  # @raise [NotImplementedError]
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#339
  def resolved?; end

  # @raise [NotImplementedError]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#343
  def to_sym; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1737
class Concurrent::Promises::RescuePromise < ::Concurrent::Promises::BlockedTaskPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1740
  def initialize(delayed, blockers_count, default_executor, executor, args, &task); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1744
  def on_resolvable(resolved_future, index); end
end

# Marker module of Future, Event resolved manually.
#
# source://concurrent-ruby//lib/concurrent/promises.rb#1288
...
#
# source://concurrent-ruby//lib/concurrent/promises.rb#1293
class Concurrent::Promises::ResolvableEvent < ::Concurrent::Promises::Event
  ...
  #   is already resolved.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1313
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1331
  ...
  # @return [Event]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1320
  def with_hidden_resolvable; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1589
class Concurrent::Promises::ResolvableEventPromise < ::Concurrent::Promises::AbstractPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1590
  def initialize(default_executor); end
end

# A Future which can be resolved by user.
#
# source://concurrent-ruby//lib/concurrent/promises.rb#1343
class Concurrent::Promises::ResolvableFuture < ::Concurrent::Promises::Future
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1384
  def evaluate_to(*args, &block); end
  ...
  # @yieldreturn [Object] value
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1395
  def evaluate_to!(*args, &block); end
  ...
  #   is already resolved.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1364
  ...
  # @see Future#reason
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1492
  ...
  #   is already resolved.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1374
  ...
  #   is already resolved.
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1354
  ...
  # @see Future#result
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1513
  ...
  # @see Future#value
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1448
  ...
  # @see Future#value!
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1470
  def value!(timeout = T.unsafe(nil), timeout_value = T.unsafe(nil), resolve_on_timeout = T.unsafe(nil)); end
  ...
  # @see AbstractEventFuture#wait
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1410
  def wait(timeout = T.unsafe(nil), resolve_on_timeout = T.unsafe(nil)); end
  ...
  # @see Future#wait!
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1427
  def wait!(timeout = T.unsafe(nil), resolve_on_timeout = T.unsafe(nil)); end
  ...
  # @return [Future]
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1531
  def with_hidden_resolvable; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1595
class Concurrent::Promises::ResolvableFuturePromise < ::Concurrent::Promises::AbstractPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1596
  def initialize(default_executor); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1898
class Concurrent::Promises::RunFuturePromise < ::Concurrent::Promises::AbstractFlatPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1902
  def initialize(delayed, blockers_count, default_executor, run_test); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1907
  def process_on_blocker_resolution(future, index); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#2103
class Concurrent::Promises::ScheduledPromise < ::Concurrent::Promises::InnerPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#2114
  def initialize(default_executor, intended_time); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#2108
  def inspect; end

  # source://concurrent-ruby//lib/concurrent/promises.rb#2104
  def intended_time; end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1719
class Concurrent::Promises::ThenPromise < ::Concurrent::Promises::BlockedTaskPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1722
  def initialize(delayed, blockers_count, default_executor, executor, args, &task); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1726
  def on_resolvable(resolved_future, index); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1929
class Concurrent::Promises::ZipEventEventPromise < ::Concurrent::Promises::BlockedPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1930
  def initialize(delayed, blockers_count, default_executor); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1936
  def on_resolvable(resolved_future, index); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#2020
class Concurrent::Promises::ZipEventsPromise < ::Concurrent::Promises::BlockedPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#2024
  def initialize(delayed, blockers_count, default_executor); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#2030
  def on_resolvable(resolved_future, index); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1941
class Concurrent::Promises::ZipFutureEventPromise < ::Concurrent::Promises::BlockedPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1942
  def initialize(delayed, blockers_count, default_executor); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#1956
  def on_resolvable(resolved_future, index); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1949
  def process_on_blocker_resolution(future, index); end
end

# source://concurrent-ruby//lib/concurrent/promises.rb#1985
class Concurrent::Promises::ZipFuturesPromise < ::Concurrent::Promises::BlockedPromise
  ...
  #
  # source://concurrent-ruby//lib/concurrent/promises.rb#1989
  def initialize(delayed, blockers_count, default_executor); end

  private

  # source://concurrent-ruby//lib/concurrent/promises.rb#2002
  def on_resolvable(resolved_future, index); end

  # source://concurrent-ruby//lib/concurrent/promises.rb#1996
  def process_on_blocker_resolution(future, index); end
end
...
#
# source://concurrent-ruby//lib/concurrent/re_include.rb#34
module Concurrent::ReInclude
  # source://concurrent-ruby//lib/concurrent/re_include.rb#42
  def extended(base); end

  # source://concurrent-ruby//lib/concurrent/re_include.rb#48
  def include(*modules); end

  # source://concurrent-ruby//lib/concurrent/re_include.rb#36
  def included(base); end
end
...
#
# source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#30
class Concurrent::ReadWriteLock < ::Concurrent::Synchronization::Object
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#58
  def initialize; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#110
  ...
  # @return [Boolean] true if the lock is successfully acquired
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#159
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#213
  def has_waiters?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#139
  ...
  # @return [Boolean] true if the lock is successfully released
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#195
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#74
  ...
  # @yield the task to be performed within the lock.
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#93
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#206
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#245
  def max_readers?(c = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#250
  def max_writers?(c = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#220
  def running_readers(c = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#225
  def running_readers?(c = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#230
  def running_writer?(c = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#240
  def waiting_writer?(c = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#235
...
# source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#39
Concurrent::ReadWriteLock::MAX_READERS = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#42
Concurrent::ReadWriteLock::MAX_WRITERS = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#36
Concurrent::ReadWriteLock::RUNNING_WRITER = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/atomic/read_write_lock.rb#33
...
# @see http://docs.oracle.com/javase/7/docs/api/java/util/concurrent/locks/ReentrantReadWriteLock.html java.util.concurrent.ReentrantReadWriteLock
#
# source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#51
class Concurrent::ReentrantReadWriteLock < ::Concurrent::Synchronization::Object
  ...
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#107
  def initialize; end
  ...
  # @return [Boolean] true if the lock is successfully acquired
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#160
  def acquire_read_lock; end
  ...
  # @return [Boolean] true if the lock is successfully acquired
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#255
  def acquire_write_lock; end
  ...
  # @return [Boolean] true if the lock is successfully released
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#234
  def release_read_lock; end
  ...
  # @return [Boolean] true if the lock is successfully released
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#329
  def release_write_lock; end
  ...
  # @return [Boolean] true if the lock is successfully acquired
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#213
  ...
  # @return [Boolean] true if the lock is successfully acquired
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#310
  ...
  # @yield the task to be performed within the lock.
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#124
  def with_read_lock; end
  ...
  # @yield the task to be performed within the lock.
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#143
  def with_write_lock; end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#370
  def max_readers?(c = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#375
  def max_writers?(c = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#345
  def running_readers(c = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#350
  def running_readers?(c = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#355
  def running_writer?(c = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#365
  def waiting_or_running_writer?(c = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#360
  def waiting_writers(c = T.unsafe(nil)); end
...
# source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#92
Concurrent::ReentrantReadWriteLock::MAX_READERS = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#94
Concurrent::ReentrantReadWriteLock::MAX_WRITERS = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#82
Concurrent::ReentrantReadWriteLock::READER_BITS = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#100
Concurrent::ReentrantReadWriteLock::READ_LOCK_MASK = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#90
Concurrent::ReentrantReadWriteLock::RUNNING_WRITER = T.let(T.unsafe(nil), Integer)

# Used with @Counter:
#
# source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#88
Concurrent::ReentrantReadWriteLock::WAITING_WRITER = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#84
Concurrent::ReentrantReadWriteLock::WRITER_BITS = T.let(T.unsafe(nil), Integer)

# Used with @HeldCount:
#
# source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#98
Concurrent::ReentrantReadWriteLock::WRITE_LOCK_HELD = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/atomic/reentrant_read_write_lock.rb#102
Concurrent::ReentrantReadWriteLock::WRITE_LOCK_MASK = T.let(T.unsafe(nil), Integer)

# Raised by an `Executor` when it is unable to process a given task,
# possibly because of a reject policy or other internal error.
#
# source://concurrent-ruby//lib/concurrent/errors.rb#48
...
class Concurrent::RubyExchanger < ::Concurrent::AbstractExchanger
  ...
  # @return [Object, CANCEL] the value exchanged by the other thread; {CANCEL} on timeout
  #
  # source://concurrent-ruby//lib/concurrent/exchanger.rb#170
  def do_exchange(value, timeout); end
...
# source://concurrent-ruby//lib/concurrent/exchanger.rb#138
class Concurrent::RubyExchanger::Node < ::Concurrent::Synchronization::Object
  # @return [Node] a new instance of Node
  #
  # source://concurrent-ruby//lib/concurrent/exchanger.rb#142
  ...
  # source://concurrent-ruby//lib/concurrent/exchanger.rb#153
  def item; end

  # source://concurrent-ruby//lib/concurrent/exchanger.rb#149
  def latch; end
...
# source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#8
class Concurrent::RubyExecutorService < ::Concurrent::AbstractExecutorService
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#11
  def initialize(*args, &block); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#37
  def kill; end

  # @raise [ArgumentError]
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#17
  def post(*args, &task); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#27
  def shutdown; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#48
  def wait_for_termination(timeout = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#66
  def ns_running?; end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#74
  def ns_shutdown?; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#62
  def ns_shutdown_execution; end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#70
  def ns_shuttingdown?; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#54
  def stop_event; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_executor_service.rb#58
  def stopped_event; end
end

# source://concurrent-ruby//lib/concurrent/executor/ruby_single_thread_executor.rb#8
class Concurrent::RubySingleThreadExecutor < ::Concurrent::RubyThreadPoolExecutor
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_single_thread_executor.rb#11
  def initialize(opts = T.unsafe(nil)); end
end

# source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#8
class Concurrent::RubyThreadLocalVar < ::Concurrent::AbstractThreadLocalVar
  # source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#39
  def value; end

  # source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#55
  def value=(value); end

  protected

  # source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#72
  def allocate_storage; end

  private

  # source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#153
  def default_for(thread); end

  # source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#117
  def get_threadlocal_array(thread = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#121
  def set_threadlocal_array(array, thread = T.unsafe(nil)); end

  # This exists only for use in testing
  #
  # source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#138
  def value_for(thread); end

  class << self
    # source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#101
    def thread_finalizer(array); end

    # source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#84
    def threadlocal_finalizer(index); end
  end
end

# used as a hash set
#
# source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#34
Concurrent::RubyThreadLocalVar::ARRAYS = T.let(T.unsafe(nil), Hash)

# source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#32
Concurrent::RubyThreadLocalVar::FREE = T.let(T.unsafe(nil), Array)

# source://concurrent-ruby//lib/concurrent/atomic/ruby_thread_local_var.rb#33
Concurrent::RubyThreadLocalVar::LOCK = T.let(T.unsafe(nil), Thread::Mutex)

# source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#12
class Concurrent::RubyThreadPoolExecutor < ::Concurrent::RubyExecutorService
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#39
  def initialize(opts = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#59
  def can_overflow?; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#54
  def completed_task_count; end

  # Returns the value of attribute idletime.
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#33
  def idletime; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#44
  def largest_length; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#64
  def length; end

  # Returns the value of attribute max_length.
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#27
  def max_length; end

  # Returns the value of attribute max_queue.
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#36
  def max_queue; end

  # Returns the value of attribute min_length.
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#30
  def min_length; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#69
  def queue_length; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#90
  def ready_worker(worker); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#74
  def remaining_capacity; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#85
  def remove_busy_worker(worker); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#49
  def scheduled_task_count; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#100
  def worker_died(worker); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#95
  def worker_not_old_enough(worker); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#105
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#224
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#186
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#204
  def ns_enqueue(*args, &task); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#146
  def ns_execute(*args, &task); end

  # @raise [ArgumentError]
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#112
  def ns_initialize(opts); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#174
  def ns_kill_execution; end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#141
  def ns_limited_queue?; end

  # try oldest worker if it is idle for enough time, it's returned back at the start
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#270
  def ns_prune_pool; end

  # handle ready worker, giving it new job or assigning back to @ready
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#235
  def ns_ready_worker(worker, success = T.unsafe(nil)); end

  # removes a worker which is not in not tracked in @ready
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#261
  def ns_remove_busy_worker(worker); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#279
  def ns_reset_if_forked; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#159
  def ns_shutdown_execution; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#214
  def ns_worker_died(worker); end

  # returns back worker to @ready which was not idle for enough time
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#252
  def ns_worker_not_old_enough(worker); end
end

# source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#15
Concurrent::RubyThreadPoolExecutor::DEFAULT_MAX_POOL_SIZE = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#21
Concurrent::RubyThreadPoolExecutor::DEFAULT_MAX_QUEUE_SIZE = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#18
Concurrent::RubyThreadPoolExecutor::DEFAULT_MIN_POOL_SIZE = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#24
Concurrent::RubyThreadPoolExecutor::DEFAULT_THREAD_IDLETIMEOUT = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#292
class Concurrent::RubyThreadPoolExecutor::Worker
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#295
  def initialize(pool); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#302
  def <<(message); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#310
  def kill; end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#306
  def stop; end

  private

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#316
  def create_worker(queue, pool, idletime); end

  # source://concurrent-ruby//lib/concurrent/executor/ruby_thread_pool_executor.rb#347
...
#
# source://concurrent-ruby//lib/concurrent/executor/safe_task_executor.rb#9
class Concurrent::SafeTaskExecutor < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/safe_task_executor.rb#11
  def initialize(task, opts = T.unsafe(nil)); end

  # @return [Array]
  #
  # source://concurrent-ruby//lib/concurrent/executor/safe_task_executor.rb#18
...
#
# source://concurrent-ruby//lib/concurrent/scheduled_task.rb#145
class Concurrent::ScheduledTask < ::Concurrent::IVar
  ...
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#165
  def initialize(delay, opts = T.unsafe(nil), &task); end

  # Comparator which orders by schedule time.
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#200
  def <=>(other); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#222
  def cancel; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#207
  def cancelled?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#260
  def execute; end

  # The executor on which to execute the task.
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#150
  def executor; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#186
  def initial_delay; end

  # Execute the task.
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#284
  ...
  # @return [Boolean] true if the task is in the given state else false
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#214
  def processing?; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#249
  ...
  # @return [Boolean] true if successfully rescheduled else false
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#237
  def reset; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#193
  ...
  # @return [Boolean] true if successfully rescheduled else false
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#313
  ...
  # @return [Boolean] true if successfully rescheduled else false
  #
  # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#299
  ...
  class << self
    ...
    #
    # source://concurrent-ruby//lib/concurrent/scheduled_task.rb#277
...
#
# source://concurrent-ruby//lib/concurrent/atomic/semaphore.rb#143
class Concurrent::Semaphore < ::Concurrent::MutexSemaphore; end

# source://concurrent-ruby//lib/concurrent/atomic/semaphore.rb#93
...
#   foo.serialized?                       #=> true
#
# source://concurrent-ruby//lib/concurrent/executor/serial_executor_service.rb#24
module Concurrent::SerialExecutorService
  ...
  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/executor/serial_executor_service.rb#30
  def serialized?; end
end

# Ensures passed jobs in a serialized order never running at the same time.
#
# source://concurrent-ruby//lib/concurrent/executor/serialized_execution.rb#8
class Concurrent::SerializedExecution < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/serialized_execution.rb#11
  def initialize; end
  ...
  # @yield the asynchronous task to perform
  #
  # source://concurrent-ruby//lib/concurrent/executor/serialized_execution.rb#34
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/serialized_execution.rb#44
  def posts(posts); end

  private

  # source://concurrent-ruby//lib/concurrent/executor/serialized_execution.rb#75
  def call_job(job); end

  # source://concurrent-ruby//lib/concurrent/executor/serialized_execution.rb#70
  def ns_initialize; end

  # ensures next job is executed if any is stashed
  #
  # source://concurrent-ruby//lib/concurrent/executor/serialized_execution.rb#95
  def work(job); end
end

# source://concurrent-ruby//lib/concurrent/executor/serialized_execution.rb#16
class Concurrent::SerializedExecution::Job < ::Struct
  ...
  # source://concurrent-ruby//lib/concurrent/executor/serialized_execution.rb#17
  def call; end
...
#
# source://concurrent-ruby//lib/concurrent/executor/serialized_execution_delegator.rb#12
class Concurrent::SerializedExecutionDelegator < ::SimpleDelegator
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/serialized_execution_delegator.rb#15
  ...
  # @yield the asynchronous task to perform
  #
  # source://concurrent-ruby//lib/concurrent/executor/serialized_execution_delegator.rb#22
  def post(*args, &task); end
end
...
#
# source://concurrent-ruby//lib/concurrent/set.rb#63
class Concurrent::Set < ::Set; end

# source://concurrent-ruby//lib/concurrent/set.rb#24
...
#
# source://concurrent-ruby//lib/concurrent/settable_struct.rb#14
module Concurrent::SettableStruct
  include ::Concurrent::Synchronization::AbstractStruct

  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#50
  def ==(other); end

  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#45
  def [](member); end

  # @raise [Concurrent::ImmutabilityError] if the given member has already been set
  #
  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#75
  def []=(member, value); end

  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#55
  def each(&block); end

  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#61
  def each_pair(&block); end

  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#29
  def inspect; end

  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#35
  def merge(other, &block); end

  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#67
  def select(&block); end

  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#18
  def to_a; end

  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#40
  def to_h; end
  ...
  # source://concurrent-ruby//lib/concurrent/settable_struct.rb#24
  def values_at(*indexes); end

  class << self
    # source://concurrent-ruby//lib/concurrent/settable_struct.rb#95
    def new(*args, &block); end
  end
end

# source://concurrent-ruby//lib/concurrent/settable_struct.rb#105
...
# @note Intended for use primarily in testing and debugging.
#
# source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#18
class Concurrent::SimpleExecutorService < ::Concurrent::RubyExecutorService
  ...
  # @return [self] returns itself
  #
  # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#53
  def <<(task); end
  ...
  # not running.
  #
  # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#81
  def kill; end
  ...
  # @yield the asynchronous task to perform
  #
  # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#37
  def post(*args, &task); end
  ...
  # @return [Boolean] `true` when running, `false` when shutting down or shutdown
  #
  # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#59
  def running?; end
  ...
  # thread pool is not running.
  #
  # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#74
  def shutdown; end
  ...
  # @return [Boolean] `true` when shutdown, `false` when shutting down or running
  #
  # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#69
  def shutdown?; end
  ...
  # @return [Boolean] `true` when not running and not shutdown, else `false`
  #
  # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#64
  def shuttingdown?; end
  ...
  # @return [Boolean] `true` if shutdown complete or false on `timeout`
  #
  # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#88
  def wait_for_termination(timeout = T.unsafe(nil)); end

  private

  # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#94
  def ns_initialize; end
  ...
  class << self
    ...
    # @return [self] returns itself
    #
    # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#31
    def <<(task); end
    ...
    # @yield the asynchronous task to perform
    #
    # source://concurrent-ruby//lib/concurrent/executor/simple_executor_service.rb#21
    def post(*args); end
  end
end
...
#
# source://concurrent-ruby//lib/concurrent/executor/single_thread_executor.rb#36
class Concurrent::SingleThreadExecutor < ::Concurrent::RubySingleThreadExecutor; end

# source://concurrent-ruby//lib/concurrent/executor/single_thread_executor.rb#9
...
# source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#6
module Concurrent::Synchronization::AbstractStruct
  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#9
  ...
  #
  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#19
  def length; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#29
  def members; end
  ...
  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#82
  def ns_each; end

  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#89
  def ns_each_pair; end

  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#75
  def ns_equality(other); end

  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#59
  def ns_get(member); end

  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#105
  def ns_inspect; end

  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#114
  def ns_merge(other, &block); end

  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#98
  def ns_select; end

  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#52
  def ns_to_h; end

  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#38
  def ns_values; end

  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#45
  def ns_values_at(indexes); end

  # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#119
  def pr_underscore(clazz); end

  class << self
    # source://concurrent-ruby//lib/concurrent/synchronization/abstract_struct.rb#130
...
#
# source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#6
class Concurrent::Synchronization::Condition < ::Concurrent::Synchronization::LockableObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#16
  def initialize(lock); end

  # source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#45
  def broadcast; end

  # source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#49
  def ns_broadcast; end

  # source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#41
  def ns_signal; end

  # source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#25
  def ns_wait(timeout = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#33
  def ns_wait_until(timeout = T.unsafe(nil), &condition); end

  # source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#37
  def signal; end

  # source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#21
  def wait(timeout = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#29
...
# TODO (pitr-ch 04-Dec-2016): should be in edge
#
# source://concurrent-ruby//lib/concurrent/synchronization/lock.rb#7
class Concurrent::Synchronization::Lock < ::Concurrent::Synchronization::LockableObject
  # source://concurrent-ruby//lib/concurrent/synchronization/lock.rb#29
  def broadcast; end

  # source://concurrent-ruby//lib/concurrent/synchronization/lock.rb#23
  def signal; end

  # source://concurrent-ruby//lib/concurrent/synchronization/lock.rb#11
  def wait(timeout = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/synchronization/lock.rb#17
  def wait_until(timeout = T.unsafe(nil), &condition); end
end
...
class Concurrent::Synchronization::LockableObject < ::Concurrent::Synchronization::MutexLockableObject
  # source://concurrent-ruby//lib/concurrent/synchronization/condition.rb#55
...
module Concurrent::Synchronization::MriAttrVolatile
  ...
  # source://concurrent-ruby//lib/concurrent/synchronization/mri_object.rb#28
  def full_memory_barrier; end

  class << self
    # @private
    #
    # source://concurrent-ruby//lib/concurrent/synchronization/mri_object.rb#6
    def included(base); end
  end
end
...
module Concurrent::Synchronization::MriAttrVolatile::ClassMethods
  # source://concurrent-ruby//lib/concurrent/synchronization/mri_object.rb#11
  def attr_volatile(*names); end
end

# source://concurrent-ruby//lib/concurrent/synchronization/mri_object.rb#36
class Concurrent::Synchronization::MriObject < ::Concurrent::Synchronization::AbstractObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/synchronization/mri_object.rb#39
  def initialize; end
end
...
class Concurrent::Synchronization::Object < ::Concurrent::Synchronization::MriObject
  ...
  # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#178
  def __initialize_atomic_fields__; end

  class << self
    # @return [true, false] is the attribute with name atomic?
    #
    # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#157
    ...
    #
    # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#151
    ...
    #
    # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#116
    ...
    # @return [true]
    #
    # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#77
    ...
    # @return [true]
    #
    # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#53
    def safe_initialization!; end

    # @return [true, false] if this class is safely initialized.
    #
    # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#68
    def safe_initialization?; end

    private

    # source://concurrent-ruby//lib/concurrent/synchronization/object.rb#163
...
module Concurrent::Synchronization::RbxAttrVolatile
  ...
  # source://concurrent-ruby//lib/concurrent/synchronization/rbx_object.rb#32
  def full_memory_barrier; end

  class << self
    # @private
    #
    # source://concurrent-ruby//lib/concurrent/synchronization/rbx_object.rb#6
    def included(base); end
  end
end

# source://concurrent-ruby//lib/concurrent/synchronization/rbx_object.rb#10
module Concurrent::Synchronization::RbxAttrVolatile::ClassMethods
  # source://concurrent-ruby//lib/concurrent/synchronization/rbx_object.rb#12
  def attr_volatile(*names); end
end
...
# source://concurrent-ruby//lib/concurrent/synchronization/rbx_object.rb#41
class Concurrent::Synchronization::RbxObject < ::Concurrent::Synchronization::AbstractObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/synchronization/rbx_object.rb#44
  def initialize; end
end
...
module Concurrent::Synchronization::TruffleRubyAttrVolatile
  ...
  # source://concurrent-ruby//lib/concurrent/synchronization/truffleruby_object.rb#32
  def full_memory_barrier; end

  class << self
    # @private
    #
    # source://concurrent-ruby//lib/concurrent/synchronization/truffleruby_object.rb#6
    def included(base); end
  end
end
...
module Concurrent::Synchronization::TruffleRubyAttrVolatile::ClassMethods
  # source://concurrent-ruby//lib/concurrent/synchronization/truffleruby_object.rb#11
  def attr_volatile(*names); end
end

# source://concurrent-ruby//lib/concurrent/synchronization/truffleruby_object.rb#39
class Concurrent::Synchronization::TruffleRubyObject < ::Concurrent::Synchronization::AbstractObject
  ...
  #
  # source://concurrent-ruby//lib/concurrent/synchronization/truffleruby_object.rb#42
  def initialize; end
end
...
# source://concurrent-ruby//lib/concurrent/thread_safe/synchronized_delegator.rb#23
class Concurrent::SynchronizedDelegator < ::SimpleDelegator
  # source://concurrent-ruby//lib/concurrent/thread_safe/synchronized_delegator.rb#33
  def initialize(obj); end

  # source://concurrent-ruby//lib/concurrent/thread_safe/synchronized_delegator.rb#38
  def method_missing(method, *args, &block); end

  # source://concurrent-ruby//lib/concurrent/thread_safe/synchronized_delegator.rb#24
  def setup; end

  # source://concurrent-ruby//lib/concurrent/thread_safe/synchronized_delegator.rb#29
  def teardown; end
end
...
#
# source://concurrent-ruby//lib/concurrent/tvar.rb#12
class Concurrent::TVar < ::Concurrent::Synchronization::Object
  # Create a new `TVar` with an initial value.
  #
  # @return [TVar] a new instance of TVar
  #
  # source://concurrent-ruby//lib/concurrent/tvar.rb#16
  def initialize(value); end

  # source://concurrent-ruby//lib/concurrent/tvar.rb#52
  def unsafe_increment_version; end

  # source://concurrent-ruby//lib/concurrent/tvar.rb#57
  def unsafe_lock; end

  # source://concurrent-ruby//lib/concurrent/tvar.rb#37
  def unsafe_value; end

  # source://concurrent-ruby//lib/concurrent/tvar.rb#42
  def unsafe_value=(value); end

  # source://concurrent-ruby//lib/concurrent/tvar.rb#47
  def unsafe_version; end

  # Get the value of a `TVar`.
  #
  # source://concurrent-ruby//lib/concurrent/tvar.rb#23
  def value; end

  # Set the value of a `TVar`.
  #
  # source://concurrent-ruby//lib/concurrent/tvar.rb#30
  def value=(value); end
...
# @see https://docs.oracle.com/javase/7/docs/api/java/lang/ThreadLocal.html Java ThreadLocal
#
# source://concurrent-ruby//lib/concurrent/atomic/thread_local_var.rb#102
class Concurrent::ThreadLocalVar < ::Concurrent::RubyThreadLocalVar; end

# source://concurrent-ruby//lib/concurrent/atomic/thread_local_var.rb#60
...
#
# source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#19
class Concurrent::TimerSet < ::Concurrent::RubyExecutorService
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#30
  def initialize(opts = T.unsafe(nil)); end
  ...
  # not running.
  #
  # source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#62
  def kill; end
  ...
  # @yield the task to be performed.
  #
  # source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#48
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#74
  def ns_initialize(opts); end

  # source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#95
  def ns_post_task(task); end

  # source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#130
  def ns_reset_if_forked; end

  # `ExecutorService` callback called during shutdown.
  #
  # source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#123
  def ns_shutdown_execution; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#90
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#144
  ...
  #
  # source://concurrent-ruby//lib/concurrent/executor/timer_set.rb#116
...
#
# source://concurrent-ruby//lib/concurrent/timer_task.rb#156
class Concurrent::TimerTask < ::Concurrent::RubyExecutorService
  ...
  #   `TimerTask`.
  #
  # source://concurrent-ruby//lib/concurrent/timer_task.rb#190
  ...
  #
  # source://concurrent-ruby//lib/concurrent/timer_task.rb#216
  def execute; end

  # @return [Fixnum] Number of seconds after the task completes before the
  #   task is performed again.
  #
  # source://concurrent-ruby//lib/concurrent/timer_task.rb#240
  def execution_interval; end

  # @return [Fixnum] Number of seconds after the task completes before the
  #   task is performed again.
  #
  # source://concurrent-ruby//lib/concurrent/timer_task.rb#247
  ...
  # @return [Boolean] `true` when running, `false` when shutting down or shutdown
  #
  # source://concurrent-ruby//lib/concurrent/timer_task.rb#199
  def running?; end

  # @return [Fixnum] Number of seconds the task can run before it is
  #   considered to have failed.
  #
  # source://concurrent-ruby//lib/concurrent/timer_task.rb#258
  def timeout_interval; end

  # @return [Fixnum] Number of seconds the task can run before it is
  #   considered to have failed.
  #
  # source://concurrent-ruby//lib/concurrent/timer_task.rb#265
  def timeout_interval=(value); end

  private

  # source://concurrent-ruby//lib/concurrent/timer_task.rb#309
  def execute_task(completion); end

  # source://concurrent-ruby//lib/concurrent/timer_task.rb#277
  def ns_initialize(opts, &task); end

  # source://concurrent-ruby//lib/concurrent/timer_task.rb#297
  def ns_kill_execution; end

  # source://concurrent-ruby//lib/concurrent/timer_task.rb#291
  def ns_shutdown_execution; end

  # source://concurrent-ruby//lib/concurrent/timer_task.rb#303
  def schedule_next_task(interval = T.unsafe(nil)); end

  # source://concurrent-ruby//lib/concurrent/timer_task.rb#325
  ...
  class << self
    ...
    #   `TimerTask`.
    #
    # source://concurrent-ruby//lib/concurrent/timer_task.rb#233
...
#
# source://concurrent-ruby//lib/concurrent/timer_task.rb#161
Concurrent::TimerTask::EXECUTION_INTERVAL = T.let(T.unsafe(nil), Integer)

# Default `:timeout_interval` in seconds.
#
# source://concurrent-ruby//lib/concurrent/timer_task.rb#164
Concurrent::TimerTask::TIMEOUT_INTERVAL = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/tvar.rb#163
class Concurrent::Transaction
  # @return [Transaction] a new instance of Transaction
  #
  # source://concurrent-ruby//lib/concurrent/tvar.rb#172
  def initialize; end

  # source://concurrent-ruby//lib/concurrent/tvar.rb#213
  def abort; end

  # source://concurrent-ruby//lib/concurrent/tvar.rb#217
  def commit; end

  # source://concurrent-ruby//lib/concurrent/tvar.rb#177
  def read(tvar); end

  # source://concurrent-ruby//lib/concurrent/tvar.rb#242
  def unlock; end

  # @return [Boolean]
  #
  # source://concurrent-ruby//lib/concurrent/tvar.rb#230
  def valid?; end

  # source://concurrent-ruby//lib/concurrent/tvar.rb#188
  def write(tvar, value); end

  class << self
    # source://concurrent-ruby//lib/concurrent/tvar.rb#248
    def current; end

    # source://concurrent-ruby//lib/concurrent/tvar.rb#252
    def current=(transaction); end
  end
end

# source://concurrent-ruby//lib/concurrent/tvar.rb#165
Concurrent::Transaction::ABORTED = T.let(T.unsafe(nil), Object)

# source://concurrent-ruby//lib/concurrent/tvar.rb#169
class Concurrent::Transaction::AbortError < ::StandardError; end

# source://concurrent-ruby//lib/concurrent/tvar.rb#170
class Concurrent::Transaction::LeaveError < ::StandardError; end

# source://concurrent-ruby//lib/concurrent/tvar.rb#167
...
#
# source://concurrent-ruby//lib/concurrent/tuple.rb#20
class Concurrent::Tuple
  ...
  #
  # source://concurrent-ruby//lib/concurrent/tuple.rb#33
  ...
  #
  # source://concurrent-ruby//lib/concurrent/tuple.rb#73
  ...
  #
  # source://concurrent-ruby//lib/concurrent/tuple.rb#82
  def each; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/tuple.rb#47
  def get(i); end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/tuple.rb#59
  def set(i, value); end

  # The (fixed) size of the tuple.
  #
  # source://concurrent-ruby//lib/concurrent/tuple.rb#24
  def size; end
...
# source://concurrent-ruby//lib/concurrent/tuple.rb#27
...
# @private
#
# source://concurrent-ruby//lib/concurrent/utility/native_integer.rb#4
module Concurrent::Utility::NativeInteger
  extend ::Concurrent::Utility::NativeInteger

  # source://concurrent-ruby//lib/concurrent/utility/native_integer.rb#23
  def ensure_integer(value); end

  # source://concurrent-ruby//lib/concurrent/utility/native_integer.rb#30
  def ensure_integer_and_bounds(value); end

  # source://concurrent-ruby//lib/concurrent/utility/native_integer.rb#16
  def ensure_lower_bound(value); end

  # source://concurrent-ruby//lib/concurrent/utility/native_integer.rb#36
  def ensure_positive(value); end

  # source://concurrent-ruby//lib/concurrent/utility/native_integer.rb#43
  def ensure_positive_and_no_zero(value); end

  # source://concurrent-ruby//lib/concurrent/utility/native_integer.rb#9
  def ensure_upper_bound(value); end
end

# source://concurrent-ruby//lib/concurrent/utility/native_integer.rb#7
Concurrent::Utility::NativeInteger::MAX_VALUE = T.let(T.unsafe(nil), Integer)

# http://stackoverflow.com/questions/535721/ruby-max-integer
#
# source://concurrent-ruby//lib/concurrent/utility/native_integer.rb#6
Concurrent::Utility::NativeInteger::MIN_VALUE = T.let(T.unsafe(nil), Integer)

# source://concurrent-ruby//lib/concurrent/utility/processor_counter.rb#8
class Concurrent::Utility::ProcessorCounter
  # @return [ProcessorCounter] a new instance of ProcessorCounter
  #
  # source://concurrent-ruby//lib/concurrent/utility/processor_counter.rb#9
  def initialize; end
  ...
  #
  # source://concurrent-ruby//lib/concurrent/utility/processor_counter.rb#70
  def physical_processor_count; end
  ...
  # @see http://msdn.microsoft.com/en-us/library/aa394373(v=vs.85).aspx
  #
  # source://concurrent-ruby//lib/concurrent/utility/processor_counter.rb#49
  def processor_count; end

  private

  # source://concurrent-ruby//lib/concurrent/utility/processor_counter.rb#115
  def compute_physical_processor_count; end

  # source://concurrent-ruby//lib/concurrent/utility/processor_counter.rb#76
  def compute_processor_count; end
end

# source://concurrent-ruby//lib/concurrent/version.rb#2
