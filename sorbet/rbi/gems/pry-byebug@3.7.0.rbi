...
module Byebug
  ...
  # source://byebug/11.0.1/lib/byebug/core.rb#31
  def displays; end

  # source://byebug/11.0.1/lib/byebug/core.rb#31
  def displays=(_arg0); end

  # source://byebug/11.0.1/lib/byebug/core.rb#25
  def init_file; end

  # source://byebug/11.0.1/lib/byebug/core.rb#25
  def init_file=(_arg0); end

  # source://byebug/11.0.1/lib/byebug/core.rb#41
  def mode; end

  # source://byebug/11.0.1/lib/byebug/core.rb#41
  def mode=(_arg0); end

  # source://byebug/11.0.1/lib/byebug/core.rb#52
  ...
  # source://byebug/11.0.1/lib/byebug/core.rb#102
  def rc_dirs; end

  # source://byebug/11.0.1/lib/byebug/core.rb#91
  ...
  class << self
    # source://byebug/11.0.1/lib/byebug/remote.rb#25
    def actual_control_port; end

    # source://byebug/11.0.1/lib/byebug/remote.rb#20
    def actual_port; end

    def add_catchpoint(_arg0); end

    # source://byebug/11.0.1/lib/byebug/attacher.rb#10
    def attach; end
    ...
    # source://byebug/11.0.1/lib/byebug/core.rb#76
    def handle_post_mortem; end

    # source://byebug/11.0.1/lib/byebug/remote.rb#32
    def interrupt; end

    # source://byebug/11.0.1/lib/byebug/core.rb#61
    def load_settings; end

    def lock; end

    # source://byebug/11.0.1/lib/byebug/remote.rb#59
    ...
    # source://byebug/11.0.1/lib/byebug/attacher.rb#21
    def spawn(host = T.unsafe(nil), port = T.unsafe(nil)); end

    def start; end

    # source://byebug/11.0.1/lib/byebug/remote.rb#55
    def start_client(host = T.unsafe(nil), port = T.unsafe(nil)); end

    # source://byebug/11.0.1/lib/byebug/remote.rb#48
    def start_control(host = T.unsafe(nil), port = T.unsafe(nil)); end

    # source://byebug/11.0.1/lib/byebug/remote.rb#39
    ...
    # source://byebug/11.0.1/lib/byebug/remote.rb#17
    ...
    # source://byebug/11.0.1/lib/byebug/remote.rb#66
    def client; end

    # source://byebug/11.0.1/lib/byebug/remote.rb#76
    def control; end

    # source://byebug/11.0.1/lib/byebug/remote.rb#70
    def server; end
  end
end
...
# source://byebug/11.0.1/lib/byebug/remote.rb#13
...
module Pry::Byebug::Breakpoints
  ...
  #
  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#101
  def delete_all; end

  # Disables a breakpoint with the given ID.
  #
  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#116
  def disable(id); end

  # Disables all breakpoints.
  #
  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#123
  def disable_all; end

  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#137
  def each(&block); end

  # Enables a disabled breakpoint with the given ID.
  #
  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#109
  def enable(id); end

  # @raise [ArgumentError]
  #
  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#145
  def find_by_id(id); end

  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#141
  def last; end

  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#133
  def size; end

  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#129
  def to_a; end

  private

  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#154
  def change_status(id, enabled = T.unsafe(nil)); end

  # source://pry-byebug//lib/pry/byebug/breakpoints.rb#160
...
#
# source://pry-byebug//lib/pry-byebug/base.rb#6
module PryByebug
  # Reference to currently running pry-remote server. Used by the processor.
  #
  # source://pry-byebug//lib/pry-byebug/base.rb#8
...
#
# source://pry-byebug//lib/pry-byebug/commands/breakpoint.rb#11
class PryByebug::BreakCommand < ::Pry::ClassCommand
  include ::PryByebug::Helpers::Breakpoints
  include ::PryByebug::Helpers::Multiline

  # source://pry-byebug//lib/pry-byebug/commands/breakpoint.rb#48
  def options(opt); end

  # source://pry-byebug//lib/pry-byebug/commands/breakpoint.rb#60
  def process; end

  private

  # source://pry-byebug//lib/pry-byebug/commands/breakpoint.rb#109
  def add_breakpoint(place, condition); end

  # source://pry-byebug//lib/pry-byebug/commands/breakpoint.rb#91
  def new_breakpoint; end

  # source://pry-byebug//lib/pry-byebug/commands/breakpoint.rb#100
  def option_to_method(option); end

  # source://pry-byebug//lib/pry-byebug/commands/breakpoint.rb#104
  def print_all; end

  # source://pry-byebug//lib/pry-byebug/commands/breakpoint.rb#86
  def process_condition; end

  # source://pry-byebug//lib/pry-byebug/commands/breakpoint.rb#76
  ...
  # source://pry-byebug//lib/pry-byebug/commands/breakpoint.rb#82
  def process_show; end
end

# Continue program execution until the next breakpoint
#
# source://pry-byebug//lib/pry-byebug/commands/continue.rb#10
class PryByebug::ContinueCommand < ::Pry::ClassCommand
  include ::PryByebug::Helpers::Navigation
  include ::PryByebug::Helpers::Breakpoints

  # source://pry-byebug//lib/pry-byebug/commands/continue.rb#29
  def process; end
end
...
#
# source://pry-byebug//lib/pry-byebug/commands/exit_all.rb#7
class PryByebug::ExitAllCommand < ::Pry::Command::ExitAll
  # source://pry-byebug//lib/pry-byebug/commands/exit_all.rb#8
  def process; end
end
...
# source://pry-byebug//lib/pry-byebug/helpers/navigation.rb#4
...
module PryByebug::Helpers::Breakpoints
  ...
  #
  # source://pry-byebug//lib/pry-byebug/helpers/breakpoints.rb#29
  ...
  # location.
  #
  # source://pry-byebug//lib/pry-byebug/helpers/breakpoints.rb#22
  def current_file; end

  # Max width of breakpoints id column
  #
  # source://pry-byebug//lib/pry-byebug/helpers/breakpoints.rb#85
  def max_width; end

  # Prints a header for the breakpoint list.
  #
  # source://pry-byebug//lib/pry-byebug/helpers/breakpoints.rb#71
  ...
  #
  # source://pry-byebug//lib/pry-byebug/helpers/breakpoints.rb#38
  def print_full_breakpoint(breakpoint); end

  # Print out concise information about a breakpoint.
  #
  # source://pry-byebug//lib/pry-byebug/helpers/breakpoints.rb#60
