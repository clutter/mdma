...
module ActiveJob::Arguments
  ...
  # source://activejob//lib/active_job/arguments.rb#170
  def convert_to_global_id_hash(argument); end

  # @return [Boolean]
  #
  # source://activejob//lib/active_job/arguments.rb#120
  def custom_serialized?(hash); end

  # source://activejob//lib/active_job/arguments.rb#91
  def deserialize_argument(argument); end

  # source://activejob//lib/active_job/arguments.rb#116
  ...
  # source://activejob//lib/active_job/arguments.rb#69
  def serialize_argument(argument); end

  # source://activejob//lib/active_job/arguments.rb#124
  ...
  # @return [Boolean]
  #
  # source://activejob//lib/active_job/arguments.rb#112
  def serialized_global_id?(hash); end

  # source://activejob//lib/active_job/arguments.rb#157
...
#
# source://activejob//lib/active_job/base.rb#61
...
#
# source://activejob//lib/active_job/callbacks.rb#20
module ActiveJob::Callbacks
  ...
  class << self
    # source://activesupport/6.0.0/lib/active_support/core_ext/class/attribute.rb#110
    def __callbacks; end
...
#
# source://activejob//lib/active_job/callbacks.rb#39
module ActiveJob::Callbacks::ClassMethods
  ...
  #   end
  #
  # source://activejob//lib/active_job/callbacks.rb#132
  ...
  #   end
  #
  # source://activejob//lib/active_job/callbacks.rb#74
  ...
  #   end
  #
  # source://activejob//lib/active_job/callbacks.rb#153
  ...
  #   end
  #
  # source://activejob//lib/active_job/callbacks.rb#94
  ...
  #   end
  #
  # source://activejob//lib/active_job/callbacks.rb#113
  ...
  #   end
  #
  # source://activejob//lib/active_job/callbacks.rb#55
...
module ActiveJob::Core
  ...
  #    end
  #
  # source://activejob//lib/active_job/core.rb#134
  ...
  # queuing adapter.
  #
  # source://activejob//lib/active_job/core.rb#92
  def serialize; end
  ...
  # @return [Boolean]
  #
  # source://activejob//lib/active_job/core.rb#171
  def arguments_serialized?; end

  # source://activejob//lib/active_job/core.rb#167
  def deserialize_arguments(serialized_args); end

  # source://activejob//lib/active_job/core.rb#156
  def deserialize_arguments_if_needed; end

  # source://activejob//lib/active_job/core.rb#163
...
module ActiveJob::Enqueuing::ClassMethods
  ...
  # source://activejob//lib/active_job/enqueuing.rb#26
...
module ActiveJob::Exceptions
  ...
  #  end
  #
  # source://activejob//lib/active_job/exceptions.rb#117
  ...
  # source://activejob//lib/active_job/exceptions.rb#148
  def executions_for(exceptions); end

  # source://activejob//lib/active_job/exceptions.rb#142
  def instrument(name, error: T.unsafe(nil), wait: T.unsafe(nil), &block); end
end

# source://activejob//lib/active_job/exceptions.rb#10
module ActiveJob::Exceptions::ClassMethods
  ...
  #  end
  #
  # source://activejob//lib/active_job/exceptions.rb#87
  ...
  #  end
  #
  # source://activejob//lib/active_job/exceptions.rb#50
...
module ActiveJob::Execution
  ...
  #
  # source://activejob//lib/active_job/execution.rb#33
  def perform_now; end
...
# source://activejob//lib/active_job/logging.rb#8
module ActiveJob::Logging
  ...
  # @return [Boolean]
  #
  # source://activejob//lib/active_job/logging.rb#51
  def logger_tagged_by_active_job?; end

  # source://activejob//lib/active_job/logging.rb#42
  def tag_logger(*tags); end
end

# source://activejob//lib/active_job/logging.rb#55
class ActiveJob::Logging::LogSubscriber < ::ActiveSupport::LogSubscriber
  # source://activejob//lib/active_job/logging.rb#114
  def discard(event); end

  # source://activejob//lib/active_job/logging.rb#56
  def enqueue(event); end

  # source://activejob//lib/active_job/logging.rb#63
  def enqueue_at(event); end

  # source://activejob//lib/active_job/logging.rb#91
  def enqueue_retry(event); end

  # source://activejob//lib/active_job/logging.rb#77
  def perform(event); end

  # source://activejob//lib/active_job/logging.rb#70
  def perform_start(event); end

  # source://activejob//lib/active_job/logging.rb#105
  def retry_stopped(event); end

  private

  # source://activejob//lib/active_job/logging.rb#128
  def args_info(job); end

  # source://activejob//lib/active_job/logging.rb#137
  def format(arg); end

  # source://activejob//lib/active_job/logging.rb#154
  def logger; end

  # source://activejob//lib/active_job/logging.rb#124
  def queue_name(event); end

  # source://activejob//lib/active_job/logging.rb#150
...
#
# source://activejob//lib/active_job/queue_adapter.rb#18
module ActiveJob::QueueAdapter::ClassMethods
  ...
  # source://activejob//lib/active_job/queue_adapter.rb#50
  def assign_adapter(adapter_name, queue_adapter); end

  # @return [Boolean]
  #
  # source://activejob//lib/active_job/queue_adapter.rb#57
...
#
# source://activejob//lib/active_job/queue_adapters.rb#109
module ActiveJob::QueueAdapters
  ...
  class << self
    ...
    #
    # source://activejob//lib/active_job/queue_adapters.rb#132
    def lookup(name); end
  end
end

# source://activejob//lib/active_job/queue_adapters.rb#124
...
class ActiveJob::QueueAdapters::SidekiqAdapter::JobWrapper
  ...
  # source://sidekiq/5.2.7/lib/sidekiq/worker.rb#201
  def sidekiq_options_hash; end

  # source://sidekiq/5.2.7/lib/sidekiq/worker.rb#213
  ...
  class << self
    # source://sidekiq/5.2.7/lib/sidekiq/worker.rb#168
    def sidekiq_options_hash; end

    # source://sidekiq/5.2.7/lib/sidekiq/worker.rb#176
    ...
    # source://sidekiq/5.2.7/lib/sidekiq/worker.rb#163
...
class ActiveJob::QueueAdapters::TestAdapter
  ...
  # source://activejob//lib/active_job/queue_adapters/test_adapter.rb#35
  def enqueue_at(job, timestamp); end
  ...
  # source://activejob//lib/active_job/queue_adapters/test_adapter.rb#74
  ...
  # @return [Boolean]
  #
  # source://activejob//lib/active_job/queue_adapters/test_adapter.rb#66
...
module ActiveJob::QueueName::ClassMethods
  ...
  #   end
  #
  # source://activejob//lib/active_job/queue_name.rb#41
  def queue_as(part_name = T.unsafe(nil), &block); end

  # source://activejob//lib/active_job/queue_name.rb#49
...
module ActiveJob::Serializers
  ...
  class << self
    ...
    # @raise [ArgumentError]
    #
    # source://activejob//lib/active_job/serializers.rb#35
    ...
    #
    # source://activejob//lib/active_job/serializers.rb#26
    def serialize(argument); end

    # Returns list of known serializers.
    #
    # source://activejob//lib/active_job/serializers.rb#46
    def serializers; end
  end
end
...
class ActiveJob::Serializers::DateSerializer < ::ActiveJob::Serializers::ObjectSerializer
  ...
  # source://activejob//lib/active_job/serializers/date_serializer.rb#16
  def klass; end
end
...
class ActiveJob::Serializers::DateTimeSerializer < ::ActiveJob::Serializers::ObjectSerializer
  ...
  # source://activejob//lib/active_job/serializers/date_time_serializer.rb#16
  def klass; end
end
...
class ActiveJob::Serializers::ObjectSerializer
  ...
  # @raise [NotImplementedError]
  #
  # source://activejob//lib/active_job/serializers/object_serializer.rb#49
  def klass; end
...
class ActiveJob::Serializers::SymbolSerializer < ::ActiveJob::Serializers::ObjectSerializer
  ...
  # source://activejob//lib/active_job/serializers/symbol_serializer.rb#16
  def klass; end
end
...
class ActiveJob::Serializers::TimeSerializer < ::ActiveJob::Serializers::ObjectSerializer
  ...
  # source://activejob//lib/active_job/serializers/time_serializer.rb#16
  def klass; end
end
...
class ActiveJob::Serializers::TimeWithZoneSerializer < ::ActiveJob::Serializers::ObjectSerializer
  # source://activejob//lib/active_job/serializers/time_with_zone_serializer.rb#10
  def deserialize(hash); end
  ...
  # source://activejob//lib/active_job/serializers/time_with_zone_serializer.rb#16
  def klass; end
end
...
#
# source://activejob//lib/active_job/test_helper.rb#7
module ActiveJob::TestHelper
  # source://activejob//lib/active_job/test_helper.rb#48
  ...
  #   end
  #
  # source://activejob//lib/active_job/test_helper.rb#382
  ...
  #   end
  #
  # source://activejob//lib/active_job/test_helper.rb#542
  ...
  #   end
  #
  # source://activejob//lib/active_job/test_helper.rb#575
  def queue_adapter; end
  ...
  # source://activejob//lib/active_job/test_helper.rb#580
  def clear_enqueued_jobs; end

  # source://activejob//lib/active_job/test_helper.rb#584
  def clear_performed_jobs; end

  # source://activejob//lib/active_job/test_helper.rb#651
  def deserialize_args_for_assertion(job); end

  # source://activejob//lib/active_job/test_helper.rb#616
  ...
  # source://activejob//lib/active_job/test_helper.rb#624
  def flush_enqueued_jobs(only: T.unsafe(nil), except: T.unsafe(nil), queue: T.unsafe(nil)); end

  # source://activejob//lib/active_job/test_helper.rb#658
  def instantiate_job(payload); end

  # source://activejob//lib/active_job/test_helper.rb#588
  ...
  # source://activejob//lib/active_job/test_helper.rb#631
  ...
  # source://activejob//lib/active_job/test_helper.rb#638
...
# source://activejob//lib/active_job/test_helper.rb#12
...
module ActiveJob::TestHelper::TestQueueAdapter::ClassMethods
  # source://activejob//lib/active_job/test_helper.rb#24
  def disable_test_adapter; end

  # source://activejob//lib/active_job/test_helper.rb#28
  def enable_test_adapter(test_adapter); end

  # source://activejob//lib/active_job/test_helper.rb#20
  def queue_adapter; end
end
