...
# source://sprockets-rails//lib/sprockets/railtie.rb#14
module Rails
  class << self
    # source://railties/6.0.0/lib/rails.rb#39
    def app_class; end

    # source://railties/6.0.0/lib/rails.rb#39
    def app_class=(_arg0); end

    # source://railties/6.0.0/lib/rails.rb#40
    def application; end

    # source://railties/6.0.0/lib/rails.rb#38
    def application=(_arg0); end

    # source://railties/6.0.0/lib/rails.rb#115
    def autoloaders; end

    # source://railties/6.0.0/lib/rails.rb#51
    ...
    # source://railties/6.0.0/lib/rails.rb#47
    def configuration; end

    # source://railties/6.0.0/lib/rails.rb#73
    def env; end

    # source://railties/6.0.0/lib/rails.rb#80
    def env=(environment); end

    # source://railties/6.0.0/lib/rails/gem_version.rb#5
    def gem_version; end

    # source://railties/6.0.0/lib/rails.rb#95
    def groups(*groups); end

    # source://railties/6.0.0/lib/rails.rb#44
    ...
    # source://railties/6.0.0/lib/rails.rb#111
    def public_path; end

    # source://railties/6.0.0/lib/rails.rb#64
    def root; end

    # source://railties/6.0.0/lib/rails/version.rb#7
    def version; end
  end
end

# source://sprockets-rails//lib/sprockets/railtie.rb#15
class Rails::Application < ::Rails::Engine
  # source://railties/6.0.0/lib/rails/application.rb#128
  ...
  #
  # source://sprockets-rails//lib/sprockets/railtie.rb#27
  def assets; end
  ...
  # source://railties/6.0.0/lib/rails/engine.rb#507
  def build_middleware_stack; end

  # source://railties/6.0.0/lib/rails/application.rb#374
  def config; end

  # source://railties/6.0.0/lib/rails/application.rb#378
  def config=(_arg0); end

  # source://railties/6.0.0/lib/rails/application.rb#222
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/6.0.0/lib/rails/application.rb#300
  def console(&blk); end

  # source://railties/6.0.0/lib/rails/application.rb#436
  def credentials; end

  # source://railties/6.0.0/lib/rails/application.rb#123
  def default_url_options(*args, &block); end

  # source://railties/6.0.0/lib/rails/application.rb#123
  def default_url_options=(arg); end

  # source://railties/6.0.0/lib/rails/application.rb#467
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/6.0.0/lib/rails/application.rb#248
  def env_config; end

  # source://railties/6.0.0/lib/rails/application.rb#121
  def executor; end

  # source://railties/6.0.0/lib/rails/application.rb#306
  def generators(&blk); end

  # source://railties/6.0.0/lib/rails/application.rb#480
  def helpers_paths; end

  # source://railties/6.0.0/lib/rails/application.rb#361
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/6.0.0/lib/rails/application.rb#149
  def initialized?; end

  # source://railties/6.0.0/lib/rails/application.rb#288
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/6.0.0/lib/rails/application.rb#368
  def initializers; end

  # source://railties/6.0.0/lib/rails/application.rb#311
  def isolate_namespace(mod); end

  # source://railties/6.0.0/lib/rails/application.rb#173
  def key_generator; end

  # source://railties/6.0.0/lib/rails/application.rb#199
  def message_verifier(verifier_name); end

  # source://railties/6.0.0/lib/rails/application.rb#500
  ...
  #
  # source://sprockets-rails//lib/sprockets/railtie.rb#48
  def precompiled_assets(clear_cache = T.unsafe(nil)); end

  # source://railties/6.0.0/lib/rails/application.rb#281
  def rake_tasks(&block); end

  # source://railties/6.0.0/lib/rails/application.rb#168
  ...
  # source://railties/6.0.0/lib/rails/application.rb#337
  def require_environment!; end

  # source://railties/6.0.0/lib/rails/application.rb#342
  def routes_reloader; end

  # source://railties/6.0.0/lib/rails/application.rb#153
  def run_load_hooks!; end

  # source://railties/6.0.0/lib/rails/application.rb#294
  def runner(&blk); end

  # source://railties/6.0.0/lib/rails/application.rb#119
  def sandbox; end
  ...
  # source://railties/6.0.0/lib/rails/application.rb#419
  def secret_key_base; end

  # source://railties/6.0.0/lib/rails/application.rb#394
  def secrets; end

  # source://railties/6.0.0/lib/rails/application.rb#408
  def secrets=(_arg0); end

  # source://railties/6.0.0/lib/rails/application.rb#476
  def to_app; end

  # source://railties/6.0.0/lib/rails/application.rb#349
  def watchable_args; end

  protected

  # source://railties/6.0.0/lib/rails/application.rb#569
  def default_middleware_stack; end

  # source://railties/6.0.0/lib/rails/application.rb#535
  def ordered_railties; end

  # source://railties/6.0.0/lib/rails/application.rb#557
  def railties_initializers(current); end

  # source://railties/6.0.0/lib/rails/application.rb#529
  def run_console_blocks(app); end

  # source://railties/6.0.0/lib/rails/application.rb#519
  def run_generators_blocks(app); end

  # source://railties/6.0.0/lib/rails/application.rb#524
  def run_runner_blocks(app); end

  # source://railties/6.0.0/lib/rails/application.rb#508
  def run_tasks_blocks(app); end

  # source://railties/6.0.0/lib/rails/application.rb#574
  def validate_secret_key_base(secret_key_base); end

  private

  # source://railties/6.0.0/lib/rails/application.rb#609
  def build_middleware; end

  # source://railties/6.0.0/lib/rails/application.rb#602
  def build_request(env); end

  # source://railties/6.0.0/lib/rails/application.rb#586
  def generate_development_secret; end

  class << self
    # source://railties/6.0.0/lib/rails/application.rb#330
    def add_lib_to_load_path!(root); end

    # source://railties/6.0.0/lib/rails/application.rb#103
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/6.0.0/lib/rails/application.rb#107
    def find_root(from); end

    # source://railties/6.0.0/lib/rails/application.rb#92
    def inherited(base); end

    # source://railties/6.0.0/lib/rails/application.rb#99
    def instance; end
  end
end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  # source://railties/6.0.0/lib/rails/application/configuration.rb#26
  def initialize(*_arg0); end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#12
  ...
  # source://railties/6.0.0/lib/rails/application/configuration.rb#292
  def annotations; end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#24
  def api_only; end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#169
  ...
  # source://railties/6.0.0/lib/rails/application/configuration.rb#304
  ...
  # source://railties/6.0.0/lib/rails/application/configuration.rb#252
  def colorize_logging; end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#256
  ...
  # source://railties/6.0.0/lib/rails/application/configuration.rb#296
  ...
  # source://railties/6.0.0/lib/rails/application/configuration.rb#220
  def database_configuration; end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#176
  def debug_exception_response_format; end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#180
  def debug_exception_response_format=(_arg0); end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#316
  ...
  # source://railties/6.0.0/lib/rails/application/configuration.rb#161
  ...
  # source://railties/6.0.0/lib/rails/application/configuration.rb#205
  def load_database_yaml; end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#74
  ...
  # source://railties/6.0.0/lib/rails/application/configuration.rb#182
  def paths; end
  ...
  # source://railties/6.0.0/lib/rails/application/configuration.rb#261
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#288
  ...
  # source://railties/6.0.0/lib/rails/application/configuration.rb#365
  def credentials_available_for_current_env?; end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#349
  def default_credentials_content_path; end

  # source://railties/6.0.0/lib/rails/application/configuration.rb#357
  def default_credentials_key_path; end
end

# source://railties/6.0.0/lib/rails/application.rb#125
Rails::Application::INITIAL_VARIABLES = T.let(T.unsafe(nil), Array)

# source://sprockets-rails//lib/sprockets/railtie.rb#55
class Rails::Engine < ::Rails::Railtie
  # source://railties/6.0.0/lib/rails/engine.rb#427
  def initialize; end

  # source://railties/6.0.0/lib/rails/engine.rb#507
  def app; end

  # source://railties/6.0.0/lib/rails/engine.rb#524
  def call(env); end

  # source://railties/6.0.0/lib/rails/engine.rb#543
  def config; end

  # source://railties/6.0.0/lib/rails/engine.rb#472
  def eager_load!; end

  # source://railties/6.0.0/lib/rails/engine.rb#519
  def endpoint; end

  # source://railties/6.0.0/lib/rails/engine.rb#425
  def engine_name(*args, &block); end

  # source://railties/6.0.0/lib/rails/engine.rb#530
  def env_config; end

  # source://railties/6.0.0/lib/rails/engine.rb#490
  def helpers; end

  # source://railties/6.0.0/lib/rails/engine.rb#502
  def helpers_paths; end

  # source://railties/6.0.0/lib/rails/engine.rb#425
  def isolated?(*args, &block); end

  # source://railties/6.0.0/lib/rails/engine.rb#441
  def load_console(app = T.unsafe(nil)); end

  # source://railties/6.0.0/lib/rails/engine.rb#465
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/6.0.0/lib/rails/engine.rb#450
  def load_runner(app = T.unsafe(nil)); end

  # source://railties/6.0.0/lib/rails/engine.rb#551
  def load_seed; end

  # source://railties/6.0.0/lib/rails/engine.rb#457
  def load_tasks(app = T.unsafe(nil)); end

  # source://railties/6.0.0/lib/rails/engine.rb#424
  def middleware(*args, &block); end

  # source://railties/6.0.0/lib/rails/engine.rb#424
  def paths(*args, &block); end

  # source://railties/6.0.0/lib/rails/engine.rb#485
  def railties; end

  # source://railties/6.0.0/lib/rails/engine.rb#424
  def root(*args, &block); end

  # source://railties/6.0.0/lib/rails/engine.rb#536
  def routes(&block); end

  # source://railties/6.0.0/lib/rails/engine.rb#652
  def routes?; end

  protected

  # source://railties/6.0.0/lib/rails/engine.rb#658
  def run_tasks_blocks(*_arg0); end

  private

  # source://railties/6.0.0/lib/rails/engine.rb#703
  def _all_autoload_once_paths; end

  # source://railties/6.0.0/lib/rails/engine.rb#707
  def _all_autoload_paths; end

  # source://railties/6.0.0/lib/rails/engine.rb#711
  def _all_load_paths(add_autoload_paths_to_load_path); end

  # source://railties/6.0.0/lib/rails/engine.rb#727
  def build_middleware; end

  # source://railties/6.0.0/lib/rails/engine.rb#719
  def build_request(env); end

  # source://railties/6.0.0/lib/rails/engine.rb#699
  def default_middleware_stack; end

  # source://railties/6.0.0/lib/rails/engine.rb#683
  def has_migrations?; end

  # source://railties/6.0.0/lib/rails/engine.rb#665
  def load_config_initializer(initializer); end

  # source://railties/6.0.0/lib/rails/engine.rb#671
  def with_inline_jobs; end

  class << self
    # source://railties/6.0.0/lib/rails/engine.rb#351
    def called_from; end

    # source://railties/6.0.0/lib/rails/engine.rb#351
    def called_from=(_arg0); end

    # source://railties/6.0.0/lib/rails/engine.rb#356
    def eager_load!(*args, &block); end

    # source://railties/6.0.0/lib/rails/engine.rb#376
    def endpoint(endpoint = T.unsafe(nil)); end

    # source://railties/6.0.0/lib/rails/railtie.rb#159
    def engine_name(name = T.unsafe(nil)); end

    # source://railties/6.0.0/lib/rails/engine.rb#414
    def find(path); end

    # source://railties/6.0.0/lib/rails/engine.rb#372
    def find_root(from); end

    # source://railties/6.0.0/lib/rails/engine.rb#687
    def find_root_with_flag(flag, root_path, default = T.unsafe(nil)); end

    # source://railties/6.0.0/lib/rails/engine.rb#358
    def inherited(base); end

    # source://railties/6.0.0/lib/rails/engine.rb#382
    def isolate_namespace(mod); end
...
# source://sprockets-rails//lib/sprockets/rails/context.rb#4
module Sprockets
...
# source://sprockets-rails//lib/sprockets/rails/context.rb#5
...
module Sprockets::Rails::Helper
  ...
  #
  # source://sprockets-rails//lib/sprockets/rails/helper.rb#76
  def compute_asset_path(path, options = T.unsafe(nil)); end
  ...
  class << self
    # @private
    #
    # source://sprockets-rails//lib/sprockets/rails/helper.rb#59
    def extended(obj); end

    # @private
    #
    # source://sprockets-rails//lib/sprockets/rails/helper.rb#42
    def included(klass); end
  end
...
# source://sprockets-rails//lib/sprockets/rails/helper.rb#11
class Sprockets::Rails::Helper::AssetNotPrecompiled < ::StandardError
  include ::Sprockets::Rails::Utils

  # @return [AssetNotPrecompiled] a new instance of AssetNotPrecompiled
  #
  # source://sprockets-rails//lib/sprockets/rails/helper.rb#13
  def initialize(source); end
end

# source://sprockets-rails//lib/sprockets/rails/helper.rb#34
...
class Sprockets::Rails::HelperAssetResolvers::Environment
  ...
  # source://sprockets-rails//lib/sprockets/rails/helper.rb#354
  def find_asset(path, options = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://sprockets-rails//lib/sprockets/rails/helper.rb#358
  def precompiled?(path); end

  # @raise [Helper::AssetNotPrecompiled]
  #
  # source://sprockets-rails//lib/sprockets/rails/helper.rb#362
...
# source://sprockets-rails//lib/sprockets/railtie.rb#67
class Sprockets::Railtie < ::Rails::Railtie
  include ::Sprockets::Rails::Utils

  # source://sprockets-rails//lib/sprockets/railtie.rb#167
  def build_environment(app, initialized = T.unsafe(nil)); end

  class << self
    # source://sprockets-rails//lib/sprockets/railtie.rb#198
...
class Sprockets::Railtie::ManifestNeededError < ::StandardError
  ...
  #
  # source://sprockets-rails//lib/sprockets/railtie.rb#71
  def initialize; end
end

# source://sprockets-rails//lib/sprockets/railtie.rb#89
class Sprockets::Railtie::OrderedOptions < ::ActiveSupport::OrderedOptions
  # source://sprockets-rails//lib/sprockets/railtie.rb#90
