...
class WebSocket::Driver
  ...
  #
  # source://websocket-driver//lib/websocket/driver.rb#74
  ...
  class << self
    ...
    # source://websocket-driver//lib/websocket/driver.rb#215
    def validate_options(options, valid_keys); end

    # @return [Boolean]
    #
    # source://websocket-driver//lib/websocket/driver.rb#223
...
# source://websocket-driver//lib/websocket/driver.rb#59
...
class WebSocket::Driver::Draft76 < ::WebSocket::Driver::Draft75
  ...
  # source://websocket-driver//lib/websocket/driver/draft76.rb#30
  def close(reason = T.unsafe(nil), code = T.unsafe(nil)); end

  # source://websocket-driver//lib/websocket/driver/draft76.rb#24
  def start; end

  # source://websocket-driver//lib/websocket/driver/draft76.rb#20
  def version; end
  ...
  # @raise [ProtocolError]
  #
  # source://websocket-driver//lib/websocket/driver/draft76.rb#40
  def handshake_response; end

  # source://websocket-driver//lib/websocket/driver/draft76.rb#65
  def handshake_signature; end

  # source://websocket-driver//lib/websocket/driver/draft76.rb#87
  def number_from_key(key); end

  # source://websocket-driver//lib/websocket/driver/draft76.rb#80
  def parse_leading_byte(octet); end

  # source://websocket-driver//lib/websocket/driver/draft76.rb#72
  def send_handshake_body; end

  # source://websocket-driver//lib/websocket/driver/draft76.rb#92
...
class WebSocket::Driver::Hybi < ::WebSocket::Driver
  ...
  # source://websocket-driver//lib/websocket/driver/hybi.rb#330
  def check_frame_length; end

  # source://websocket-driver//lib/websocket/driver/hybi.rb#341
  def emit_frame(buffer); end

  # source://websocket-driver//lib/websocket/driver/hybi.rb#390
  def emit_message; end

  # source://websocket-driver//lib/websocket/driver/hybi.rb#264
  def fail(type, message); end

  # source://websocket-driver//lib/websocket/driver/hybi.rb#226
  def handshake_response; end

  # source://websocket-driver//lib/websocket/driver/hybi.rb#319
  def parse_extended_length(buffer); end

  # source://websocket-driver//lib/websocket/driver/hybi.rb#302
  def parse_length(octet); end

  # source://websocket-driver//lib/websocket/driver/hybi.rb#269
  def parse_opcode(octet); end

  # source://websocket-driver//lib/websocket/driver/hybi.rb#195
  def send_frame(frame); end

  # source://websocket-driver//lib/websocket/driver/hybi.rb#252
...
# source://websocket-driver//lib/websocket/driver.rb#58
