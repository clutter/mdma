...
class RSpec::Rails::Matchers::ActiveJob::Base < RSpec::Matchers::BuiltIn::BaseMatcher
...
class RSpec::ExampleGroups::PackageAnalyzer < RSpec::Core::ExampleGroup
  ...
  def self.pre_loaded_fixtures?; end
  def self.proxy_method_warning_if_called_in_before_context_scope(method_name); end
