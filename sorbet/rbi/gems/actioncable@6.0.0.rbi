...
module ActionCable::Channel::Streams
  ...
  # source://actioncable//lib/action_cable/channel/streams.rb#114
  ...
  #
  # source://actioncable//lib/action_cable/channel/streams.rb#150
  def default_stream_handler(broadcasting, coder:); end

  # source://actioncable//lib/action_cable/channel/streams.rb#171
  ...
  # TODO: Tests demonstrating this.
  #
  # source://actioncable//lib/action_cable/channel/streams.rb#134
...
# Pretty simple, eh?
#
# source://actioncable//lib/action_cable/connection/base.rb#45
class ActionCable::Connection::Base
  ...
  # source://actioncable//lib/action_cable/connection/base.rb#123
  def beat; end
  ...
  #
  # source://actioncable//lib/action_cable/connection/base.rb#50
  def env; end

  # source://actioncable//lib/action_cable/connection/base.rb#51
  ...
  # source://actioncable//lib/action_cable/connection/base.rb#140
  def on_close(reason, code); end

  # source://actioncable//lib/action_cable/connection/base.rb#135
  def on_error(message); end

  # source://actioncable//lib/action_cable/connection/base.rb#131
  def on_message(message); end

  # source://actioncable//lib/action_cable/connection/base.rb#127
  def on_open; end

  # Called by the server when a new WebSocket connection is established. This configures the callbacks intended for overwriting by the user.
  # This method should not be called directly -- instead rely upon on the #connect (and #disconnect) callbacks.
  #
  # source://actioncable//lib/action_cable/connection/base.rb#69
  def process; end
  ...
  #
  # source://actioncable//lib/action_cable/connection/base.rb#81
  def receive(websocket_message); end

  # Invoke a method on the connection asynchronously through the pool of thread workers.
  #
  # source://actioncable//lib/action_cable/connection/base.rb#108
  ...
  #
  # source://actioncable//lib/action_cable/connection/base.rb#114
  def statistics; end
  ...
  # source://actioncable//lib/action_cable/connection/base.rb#93
  def transmit(cable_message); end
  ...
  #
  # source://actioncable//lib/action_cable/connection/base.rb#157
  def cookies; end

  # source://actioncable//lib/action_cable/connection/base.rb#165
  def decode(websocket_message); end

  # source://actioncable//lib/action_cable/connection/base.rb#161
  def encode(cable_message); end

  # source://actioncable//lib/action_cable/connection/base.rb#241
  def finished_request_message; end

  # source://actioncable//lib/action_cable/connection/base.rb#181
  def handle_close; end

  # source://actioncable//lib/action_cable/connection/base.rb#169
  def handle_open; end

  # source://actioncable//lib/action_cable/connection/base.rb#249
  ...
  #
  # source://actioncable//lib/action_cable/connection/base.rb#227
  def new_tagged_logger; end

  # The request that initiated the WebSocket connection is available here. This gives access to the environment, cookies, etc.
  #
  # source://actioncable//lib/action_cable/connection/base.rb#149
  def request; end

  # source://actioncable//lib/action_cable/connection/base.rb#218
  def respond_to_invalid_request; end

  # source://actioncable//lib/action_cable/connection/base.rb#213
  def respond_to_successful_request; end

  # source://actioncable//lib/action_cable/connection/base.rb#192
  def send_welcome_message; end

  # source://actioncable//lib/action_cable/connection/base.rb#232
  def started_request_message; end

  # source://actioncable//lib/action_cable/connection/base.rb#255
  def successful_request_message; end

  # Returns the value of attribute websocket.
  #
  # source://actioncable//lib/action_cable/connection/base.rb#145
  def websocket; end
...
class ActionCable::Connection::Subscriptions
  ...
  # source://actioncable//lib/action_cable/connection/subscriptions.rb#27
  def add(data); end

  # source://actioncable//lib/action_cable/connection/subscriptions.rb#15
  def execute_command(data); end

  # source://actioncable//lib/action_cable/connection/subscriptions.rb#58
  def identifiers; end

  # source://actioncable//lib/action_cable/connection/subscriptions.rb#68
  def logger(*args, &block); end

  # source://actioncable//lib/action_cable/connection/subscriptions.rb#54
  def perform_action(data); end

  # source://actioncable//lib/action_cable/connection/subscriptions.rb#44
  def remove(data); end

  # source://actioncable//lib/action_cable/connection/subscriptions.rb#49
  def remove_subscription(subscription); end

  # source://actioncable//lib/action_cable/connection/subscriptions.rb#62
  ...
  # Returns the value of attribute connection.
  #
  # source://actioncable//lib/action_cable/connection/subscriptions.rb#67
  def connection; end
...
class ActionCable::Server::Worker
  ...
  #
  # source://actioncable//lib/action_cable/server/worker.rb#29
  def halt; end
  ...
  # @return [Boolean]
  #
  # source://actioncable//lib/action_cable/server/worker.rb#33
  def stopping?; end

  # source://actioncable//lib/action_cable/server/worker.rb#37
