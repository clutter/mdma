...
module RSpec::Mocks
  class << self
    ...
    # @private
    #
    # source://rspec-mocks//lib/rspec/mocks.rb#103
    def space; end
    ...
    #
    # source://rspec-mocks//lib/rspec/mocks.rb#90
...
# @private
#
# source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#662
class RSpec::Mocks::AndReturnImplementation
  # @return [AndReturnImplementation] a new instance of AndReturnImplementation
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#663
  def initialize(values_to_return); end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#667
...
class RSpec::Mocks::AndWrapOriginalImplementation
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#702
  def initialize(method, block); end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#729
  def call(*args, &block); end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#709
  def initial_action=(_value); end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#725
...
# source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#707
...
# @private
#
# source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#635
...
class RSpec::Mocks::AnyInstance::Chain
  ...
  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/chain.rb#60
  def constrained_to_any_of?(*constraints); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/chain.rb#74
  def expectation_fulfilled!; end

  # @private
  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/chain.rb#69
  def matches_args?(*args); end

  # source://rspec-mocks//lib/rspec/mocks/any_instance/chain.rb#78
  def never; end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/chain.rb#52
  def playback!(instance); end

  # source://rspec-mocks//lib/rspec/mocks/any_instance/chain.rb#83
  def with(*args, &block); end

  private

  # source://rspec-mocks//lib/rspec/mocks/any_instance/chain.rb#98
  def last_message; end

  # source://rspec-mocks//lib/rspec/mocks/any_instance/chain.rb#94
  def messages; end

  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/chain.rb#90
  def negated?; end

  # source://rspec-mocks//lib/rspec/mocks/any_instance/chain.rb#102
...
class RSpec::Mocks::AnyInstance::Recorder
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#48
  def expect_chain(*method_names_and_optional_return_values, &block); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#112
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#70
  def should_not_receive(method_name, &block); end
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#61
  def should_receive(method_name, &block); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#99
  ...
  # @see Methods#stub
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#30
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#40
  ...
  # @see Methods#unstub
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#78
  def unstub(method_name); end
  ...
  # @api private
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#91
  def verify; end

  protected

  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#143
  def stop_observing!(method_name); end

  private

  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#274
  def allow_no_prepended_module_definition_of(method_name); end

  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#154
  def ancestor_is_an_observer?(method_name); end

  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#228
  def backup_method!(method_name); end

  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#261
  def mark_invoked!(method_name); end

  # @yield [args.first, args]
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#171
  def normalize_chain(*args); end

  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#242
  def observe!(method_name); end

  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#238
  ...
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#222
  def remove_dummy_method!(method_name); end

  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#182
  def restore_method!(method_name); end

  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#190
  def restore_original_method!(method_name); end

  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#163
  def super_class_observers_for(method_name); end

  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/any_instance/recorder.rb#167
...
class RSpec::Mocks::ArgumentMatchers::ArrayIncludingMatcher
  ...
  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#246
  def description; end

  private

  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#252
...
class RSpec::Mocks::ArgumentMatchers::DuckTypeMatcher
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#261
  def initialize(*methods_to_respond_to); end

  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#265
  def ===(value); end

  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#269
  def description; end
end
...
class RSpec::Mocks::ArgumentMatchers::InstanceOf
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#276
  def initialize(klass); end

  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#280
  def ===(actual); end

  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#284
  def description; end
end

# @private
#
# source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#290
class RSpec::Mocks::ArgumentMatchers::KindOf
  # @return [KindOf] a new instance of KindOf
  #
  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#291
  def initialize(klass); end

  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#295
  def ===(actual); end

  # source://rspec-mocks//lib/rspec/mocks/argument_matchers.rb#299
  def description; end
end
...
# @private
#
# source://rspec-mocks//lib/rspec/mocks.rb#109
...
# @private
#
# source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#679
class RSpec::Mocks::Implementation
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#682
  def call(*args, &block); end

  # Returns the value of attribute initial_action.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#680
  ...
  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#688
  def present?; end
...
#
# source://rspec-mocks//lib/rspec/mocks.rb#119
...
#
# source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#42
class RSpec::Mocks::MessageExpectation
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#97
  ...
  # @return [nil] No further chaining is supported after this.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#139
  ...
  # @return [nil] No further chaining is supported after this.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#69
  ...
  # @return [nil] No further chaining is supported after this.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#155
  ...
  # @return [nil] No further chaining is supported after this.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#115
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#167
  def and_yield(*args, &block); end
  ...
  # @return [MessageExpectation] self, to support further chaining.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#221
  ...
  # @return [MessageExpectation] self, to support further chaining.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#189
  def exactly(n, &block); end

  # @return [String] a nice representation of the message expectation
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#347
  def inspect; end
  ...
  # @return [MessageExpectation] self, to support further chaining.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#245
  def never; end
  ...
  # @return [MessageExpectation] self, to support further chaining.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#256
  def once(&block); end
  ...
  # @return [MessageExpectation] self, to support further chaining.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#330
  ...
  # @return [MessageExpectation] self, to support further chaining.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#278
  ...
  # @return [MessageExpectation] self, to support further chaining.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#235
  def times(&block); end
  ...
  # @return [MessageExpectation] self, to support further chaining.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#267
  def twice(&block); end
  ...
  # @return [MessageExpectation] self, to support further chaining.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#311
  def with(*args, &block); end
end
...
# @private
#
# source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#360
module RSpec::Mocks::MessageExpectation::ImplementationDetails
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#371
  ...
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#404
  ...
  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#433
  def called_max_times?; end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#510
  def description_for(verb); end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#453
  ...
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#400
  def expected_args; end
  ...
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#486
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#361
  ...
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#425
  ...
  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#462
  def matches_at_least_count?; end

  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#466
  def matches_at_most_count?; end

  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#470
  def matches_exact_count?; end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#440
  def matches_name_but_not_args(message, *args); end

  # Returns the value of attribute message.
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#362
  def message; end

  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#429
  def negative?; end
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#363
  def orig_object; end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#517
  def raise_out_of_order_error; end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#500
  ...
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#482
  def unadvise(args); end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#444
  ...
  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#573
  def has_been_invoked?; end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#596
  ...
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#548
  def invoke_incrementing_actual_calls_by(increment, allowed_to_fail, parent_stub, *args, &block); end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#577
  ...
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#617
...
class RSpec::Mocks::MethodDouble
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#187
  def add_default_stub(*args, &implementation); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#137
  def add_expectation(error_generator, expectation_ordering, expected_from, opts, &implementation); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#173
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#123
  def clear; end
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#132
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#76
  def proxy_method_invoked(_obj, *args, &block); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#204
  def raise_method_not_stubbed_error; end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#193
  def remove_stub; end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#199
  def remove_stub_if_present; end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#117
  def reset; end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#81
  def restore_original_method; end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#104
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#178
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#93
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#112
  def verify; end
  ...
  # source://rspec-mocks//lib/rspec/mocks/method_double.rb#264
...
#
# source://rspec-mocks//lib/rspec/mocks/method_double.rb#224
...
# @private
#
# source://rspec-mocks//lib/rspec/mocks/proxy.rb#424
...
# @private
#
# source://rspec-mocks//lib/rspec/mocks/proxy.rb#348
module RSpec::Mocks::PartialClassDoubleProxyMethods
  ...
  # does.
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#374
  def original_method_handle_for(message); end

  protected

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#402
  def method_double_from_ancestor_for(message); end

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#397
  def original_unbound_method_handle_from_ancestor_for(message); end

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#412
...
class RSpec::Mocks::PartialDoubleProxy < ::RSpec::Mocks::Proxy
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#300
  def add_simple_expectation(method_name, response, location); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#306
  def add_simple_stub(method_name, response); end

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#323
  ...
  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#332
...
class RSpec::Mocks::Proxy
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#66
  def add_simple_expectation(method_name, response, location); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#123
  def add_simple_stub(method_name, response); end
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#39
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#102
  def check_for_unexpected_arguments(expectation); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#13
  ...
  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#32
  def null_object?; end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#29
  def object; end
  ...
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#227
  def prepended_modules_of_singleton_class; end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#206
  def raise_missing_default_stub_error(expectation, args_for_multiple_calls); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#201
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#128
  def remove_stub(method_name); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#133
  def remove_stub_if_present(method_name); end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#81
  ...
  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#138
  def verify; end

  # @private
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#211
  def visibility_for(_method_name); end

  private

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#249
  def find_almost_matching_expectation(method_name, *args); end

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#271
  def find_almost_matching_stub(method_name, *args); end

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#255
  def find_best_matching_expectation_for(method_name); end

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#243
  ...
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#239
  def method_double_for(message); end

  class << self
    # source://rspec-mocks//lib/rspec/mocks/proxy.rb#217
    def prepended_modules_of(klass); end
  end
end

# source://rspec-mocks//lib/rspec/mocks/proxy.rb#49
...
class RSpec::Mocks::ProxyForNil < ::RSpec::Mocks::PartialDoubleProxy
  ...
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#430
  def initialize(order_group); end

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#438
  def add_message_expectation(method_name, opts = T.unsafe(nil), &block); end

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#443
  def add_stub(method_name, opts = T.unsafe(nil), &implementation); end

  # Returns the value of attribute disallow_expectations.
  #
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#435
  ...
  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#480
  def raise_error(method_name); end

  # source://rspec-mocks//lib/rspec/mocks/proxy.rb#450
...
# @private
#
# source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#9
class RSpec::Mocks::SimpleMessageExpectation
  # @return [SimpleMessageExpectation] a new instance of SimpleMessageExpectation
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#10
  def initialize(message, response, error_generator, backtrace_line = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#24
  def called_max_times?; end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#15
  def invoke(*_); end

  # @return [Boolean]
  #
  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#20
  def matches?(message, *_); end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#35
  def unadvise(_); end

  # source://rspec-mocks//lib/rspec/mocks/message_expectation.rb#28
  def verify_messages_received; end
end
