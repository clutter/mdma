...
module SimpleCov
  class << self
    # source://simplecov/0.17.0/lib/simplecov.rb#65
    def add_not_loaded_files(result); end

    # source://simplecov/0.17.0/lib/simplecov.rb#169
    def clear_result; end

    # source://simplecov/0.17.0/lib/simplecov.rb#27
    def exit_exception; end

    # source://simplecov/0.17.0/lib/simplecov.rb#184
    def exit_status_from_exception; end

    # source://simplecov/0.17.0/lib/simplecov.rb#114
    def filtered(files); end

    # source://simplecov/0.17.0/lib/simplecov.rb#259
    def final_result_process?; end

    # source://simplecov/0.17.0/lib/simplecov.rb#125
    def grouped(files); end

    # source://simplecov/0.17.0/lib/simplecov.rb#145
    def load_adapter(name); end

    # source://simplecov/0.17.0/lib/simplecov.rb#141
    def load_profile(name); end

    # source://simplecov/0.17.0/lib/simplecov.rb#26
    def pid; end

    # source://simplecov/0.17.0/lib/simplecov.rb#26
    def pid=(_arg0); end

    # source://simplecov/0.17.0/lib/simplecov.rb#220
    def process_result(result, exit_status); end

    # source://simplecov/0.17.0/lib/simplecov.rb#82
    def result; end

    # source://simplecov/0.17.0/lib/simplecov.rb#107
    def result?; end

    # source://simplecov/0.17.0/lib/simplecov.rb#234
    def result_exit_status(result, covered_percent); end

    # source://simplecov/0.17.0/lib/simplecov.rb#198
    def run_exit_tasks!; end

    # source://simplecov/0.17.0/lib/simplecov.rb#25
    def running; end

    # source://simplecov/0.17.0/lib/simplecov.rb#25
    def running=(_arg0); end

    # source://simplecov/0.17.0/lib/simplecov.rb#177
    def set_exit_exception; end

    # source://simplecov/0.17.0/lib/simplecov.rb#46
    def start(profile = T.unsafe(nil), &block); end

    # source://simplecov/0.17.0/lib/simplecov.rb#154
    def usable?; end

    # source://simplecov/0.17.0/lib/simplecov.rb#266
    def wait_for_other_processes; end

    # source://simplecov/0.17.0/lib/simplecov.rb#274
...
# source://simplecov/0.17.0/lib/simplecov/version.rb#4
