...
module ActionText
  ...
  class << self
    # source://railties/6.0.0/lib/rails/engine.rb#403
    def railtie_helpers_paths; end

    # source://railties/6.0.0/lib/rails/engine.rb#392
    def railtie_namespace; end

    # source://railties/6.0.0/lib/rails/engine.rb#407
    def railtie_routes_url_helpers(include_path_helpers = T.unsafe(nil)); end

    # source://railties/6.0.0/lib/rails/engine.rb#395
    def table_name_prefix; end

    # source://railties/6.0.0/lib/rails/engine.rb#399
...
# source://actiontext//lib/action_text.rb#22
...
class ActionText::Attachables::ContentAttachment
  ...
  # source://activemodel/6.0.0/lib/active_model/naming.rb#238
  ...
  # source://activemodel/6.0.0/lib/active_model/validations.rb#48
...
# source://actiontext//lib/action_text/attachment.rb#4
class ActionText::Attachment
  ...
  #
  # source://actiontext//lib/action_text/attachment.rb#53
  def initialize(node, attachable); end

  # Returns the value of attribute attachable.
  #
  # source://actiontext//lib/action_text/attachment.rb#48
  def attachable; end

  # source://actiontext//lib/action_text/attachment.rb#58
  def caption; end

  # source://actiontext//lib/action_text/attachment.rb#62
  def full_attributes; end

  # source://actiontext//lib/action_text/attachment.rb#86
  def inspect; end

  # source://activesupport/6.0.0/lib/active_support/core_ext/module/delegation.rb#296
  ...
  # source://actiontext//lib/action_text/attachment.rb#78
  def to_html; end

  # source://actiontext//lib/action_text/attachment.rb#50
  def to_param(*args, &block); end

  # source://actiontext//lib/action_text/attachment.rb#70
  def to_plain_text; end

  # source://actiontext//lib/action_text/attachment.rb#82
  def to_s; end
  ...
  # source://actiontext//lib/action_text/attachment.rb#95
  def attachable_attributes; end

  # source://actiontext//lib/action_text/attachment.rb#91
  def node_attributes; end

  # source://activesupport/6.0.0/lib/active_support/core_ext/module/delegation.rb#288
  def respond_to_missing?(name, include_private = T.unsafe(nil)); end

  # source://actiontext//lib/action_text/attachment.rb#99
  def sgid_attributes; end

  class << self
    # source://actiontext//lib/action_text/attachment.rb#12
    ...
    # source://actiontext//lib/action_text/attachment.rb#30
    def from_attributes(attributes, attachable = T.unsafe(nil)); end

    # source://actiontext//lib/action_text/attachment.rb#16
...
# source://actiontext//lib/action_text/attachment.rb#8
ActionText::Attachment::SELECTOR = T.let(T.unsafe(nil), String)

# source://actiontext//lib/action_text/attachment.rb#7
...
# source://actiontext//lib/action_text/attachments/trix_conversion.rb#5
module ActionText::Attachments::TrixConversion
  extend ::ActiveSupport::Concern

  mixes_in_class_methods ::ActionText::Attachments::TrixConversion::ClassMethods

  # source://actiontext//lib/action_text/attachments/trix_conversion.rb#20
  def to_trix_attachment(content = T.unsafe(nil)); end

  private

  # source://actiontext//lib/action_text/attachments/trix_conversion.rb#27
...
module ActionText::Attachments::TrixConversion::ClassMethods
  ...
  # source://actiontext//lib/action_text/attachments/trix_conversion.rb#15
...
module ActionText::Attribute::ClassMethods
  # source://actiontext//lib/action_text/attribute.rb#26
  def has_rich_text(name); end
end

# source://actiontext//lib/action_text/content.rb#6
class ActionText::Content
  ...
  # source://actiontext//lib/action_text/content.rb#59
  def append_attachables(attachables); end

  # source://actiontext//lib/action_text/content.rb#98
  def as_json(*_arg0); end

  # source://actiontext//lib/action_text/content.rb#53
  def attachables; end

  # source://actiontext//lib/action_text/content.rb#43
  def attachment_galleries; end

  # source://actiontext//lib/action_text/content.rb#37
  def attachments; end

  # source://actiontext//lib/action_text/content.rb#13
  ...
  #
  # source://actiontext//lib/action_text/content.rb#11
  def fragment; end
  ...
  # source://actiontext//lib/action_text/content.rb#64
  def render_attachments(**options, &block); end

  # source://activesupport/6.0.0/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#50
  def renderer; end

  # source://activesupport/6.0.0/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#91
  ...
  class << self
    # source://actiontext//lib/action_text/content.rb#16
    def fragment_by_canonicalizing_content(content); end

    # source://activesupport/6.0.0/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#43
    def renderer; end

    # source://activesupport/6.0.0/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#84
    def renderer=(obj); end
  end
end
...
module ActionText::PlainTextConversion
  ...
  # source://actiontext//lib/action_text/plain_text_conversion.rb#38
  def plain_text_for_br_node(node, index); end

  # source://actiontext//lib/action_text/plain_text_conversion.rb#46
  ...
  # source://actiontext//lib/action_text/plain_text_conversion.rb#59
  ...
  # source://actiontext//lib/action_text/plain_text_conversion.rb#26
  def plain_text_method_for_node(node); end

  # source://actiontext//lib/action_text/plain_text_conversion.rb#65
...
class ActionText::RichText < ::ActiveRecord::Base
  ...
  # source://activerecord/6.0.0/lib/active_record/autosave_association.rb#153
...
module ActionText::RichText::GeneratedAssociationMethods
  # source://activerecord/6.0.0/lib/active_record/associations/builder/association.rb#99
  def record; end

  # source://activerecord/6.0.0/lib/active_record/associations/builder/association.rb#107
  def record=(value); end

  # source://activerecord/6.0.0/lib/active_record/associations/builder/singular_association.rb#19
...
module ActionText::Serialization
  ...
  # source://actiontext//lib/action_text/serialization.rb#30
  def _dump(*_arg0); end
end
...
module ActionView::Helpers
  ...
  class << self
    # source://actionview/6.0.0/lib/action_view/helpers.rb#34
    def eager_load!; end
  end
end

class ActionView::Helpers::FormBuilder
  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1663
  def initialize(object_name, object, template, options); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2471
  def button(value = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2313
  def check_box(method, options = T.unsafe(nil), checked_value = T.unsafe(nil), unchecked_value = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_options_helper.rb#879
  def collection_check_boxes(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_options_helper.rb#891
  def collection_radio_buttons(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_options_helper.rb#843
  def collection_select(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1906
  def color_field(method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1906
  def date_field(method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/date_helper.rb#1171
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/date_helper.rb#1195
  def datetime_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1906
  def email_field(method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2477
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2195
  def fields(scope = T.unsafe(nil), model: T.unsafe(nil), **options, &block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2157
  def fields_for(record_name, record_object = T.unsafe(nil), fields_options = T.unsafe(nil), &block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2395
  def file_field(method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_options_helper.rb#855
  def grouped_collection_select(method, collection, group_method, group_label_method, option_key_method, option_value_method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2357
  def hidden_field(method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1640
  def index; end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2252
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1643
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1638
  def object; end
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2335
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/form_options_helper.rb#831
  def select(method, choices = T.unsafe(nil), options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2427
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/date_helper.rb#1183
  def time_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_options_helper.rb#867
  def time_zone_select(method, priority_zones = T.unsafe(nil), options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1659
  def to_model; end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1655
  def to_partial_path; end
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2558
  def convert_to_legacy_options(options); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2540
  def fields_for_nested_model(name, object, fields_options, block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2513
  def fields_for_with_nested_attributes(association_name, association, options, block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2509
  def nested_attributes_association?(association_name); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2553
  def nested_child_index(name); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2482
  def objectify_options(options); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#2486
  def submit_default_value; end

  class << self
    # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1651
...
module ActionView::Helpers::FormHelper
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1300
  def check_box(object_name, method, options = T.unsafe(nil), checked_value = T.unsafe(nil), unchecked_value = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1330
  def color_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1394
  def date_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1452
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1506
  def email_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1057
  def fields(scope = T.unsafe(nil), model: T.unsafe(nil), **options, &block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1007
  def fields_for(record_name, record_object = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1212
  def file_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#430
  def form_for(record, options = T.unsafe(nil), &block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#742
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1180
  def hidden_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1117
  def label(object_name, method, content_or_options = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1471
  def month_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1514
  def number_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1162
  def password_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1362
  def phone_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1322
  def radio_button(object_name, method, tag_value, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1522
  def range_field(object_name, method, options = T.unsafe(nil)); end

  def rich_text_area(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1353
  def search_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1362
  def telephone_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1240
  def text_area(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1141
  def text_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1423
  def time_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1497
  def url_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1488
  def week_field(object_name, method, options = T.unsafe(nil)); end

  private

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#459
  def apply_form_for_options!(record, object, options); end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1570
  def default_form_builder_class; end

  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1527
  ...
  # source://actionview/6.0.0/lib/action_view/helpers/form_helper.rb#1556
