...
# source://aws-sigv4//lib/aws-sigv4/credentials.rb#1
module Aws
  class << self
...
# source://aws-sigv4//lib/aws-sigv4/credentials.rb#2
...
# @api private
#
# source://aws-sigv4//lib/aws-sigv4/credentials.rb#6
class Aws::Sigv4::Credentials
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/credentials.rb#11
  def initialize(options = T.unsafe(nil)); end

  # @api private
  # @return [String]
  #
  # source://aws-sigv4//lib/aws-sigv4/credentials.rb#23
  def access_key_id; end

  # @api private
  # @return [String]
  #
  # source://aws-sigv4//lib/aws-sigv4/credentials.rb#26
  def secret_access_key; end

  # @api private
  # @return [String, nil]
  #
  # source://aws-sigv4//lib/aws-sigv4/credentials.rb#29
  def session_token; end

  # @api private
  # @return [Boolean]
  #
  # source://aws-sigv4//lib/aws-sigv4/credentials.rb#32
  def set?; end
end

# source://aws-sigv4//lib/aws-sigv4/errors.rb#3
...
class Aws::Sigv4::Errors::MissingCredentialsError < ::ArgumentError
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/errors.rb#6
  def initialize(msg = T.unsafe(nil)); end
end

# source://aws-sigv4//lib/aws-sigv4/errors.rb#16
class Aws::Sigv4::Errors::MissingRegionError < ::ArgumentError
  # @return [MissingRegionError] a new instance of MissingRegionError
  #
  # source://aws-sigv4//lib/aws-sigv4/errors.rb#17
  def initialize(*args); end
end

# source://aws-sigv4//lib/aws-sigv4/signature.rb#3
class Aws::Sigv4::Signature
  # @api private
  # @return [Signature] a new instance of Signature
  #
  # source://aws-sigv4//lib/aws-sigv4/signature.rb#6
  def initialize(options); end

  # @return [String] For debugging purposes.
  #
  # source://aws-sigv4//lib/aws-sigv4/signature.rb#25
  ...
  # @return [String] For debugging purposes.
  #
  # source://aws-sigv4//lib/aws-sigv4/signature.rb#31
  ...
  #   * 'authorization'
  #
  # source://aws-sigv4//lib/aws-sigv4/signature.rb#22
  def headers; end
  ...
  # @return [String] For debugging purposes.
  #
  # source://aws-sigv4//lib/aws-sigv4/signature.rb#28
...
# and `#session_token`.
#
# source://aws-sigv4//lib/aws-sigv4/signer.rb#73
class Aws::Sigv4::Signer
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#119
  def initialize(options = T.unsafe(nil)); end
  ...
  #   * `#set?` => Boolean
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#146
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#368
  ...
  # @return [String]
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#132
  def service; end
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#282
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#203
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#485
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#441
  ...
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#551
  def host(uri); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#504
  def normalized_querystring(querystring); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#494
  def path(url); end
  ...
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#525
  ...
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#423
  def string_to_sign(datetime, canonical_request); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#651
  def uri_escape(string); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#655
...
# @api private
#
# source://aws-sigv4//lib/aws-sigv4/credentials.rb#41
class Aws::Sigv4::StaticCredentialsProvider
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/credentials.rb#47
  def initialize(options = T.unsafe(nil)); end

  # @api private
  # @return [Credentials]
  #
  # source://aws-sigv4//lib/aws-sigv4/credentials.rb#54
  def credentials; end
end
