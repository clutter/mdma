...
class ChildProcess::Unix::ForkExecProcess < ::ChildProcess::Unix::Process
  ...
  # source://childprocess//lib/childprocess/unix/fork_exec_process.rb#64
  def set_env; end
end
...
class ChildProcess::Unix::Process < ::ChildProcess::AbstractProcess
  ...
  # source://childprocess//lib/childprocess/unix/process.rb#79
  def _pid; end

  # source://childprocess//lib/childprocess/unix/process.rb#64
  def send_kill; end

  # source://childprocess//lib/childprocess/unix/process.rb#68
  def send_signal(sig); end

  # source://childprocess//lib/childprocess/unix/process.rb#60
  def send_term; end

  # source://childprocess//lib/childprocess/unix/process.rb#75
