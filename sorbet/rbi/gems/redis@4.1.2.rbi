...
# source://redis//lib/redis/errors.rb#1
class Redis
  ...
  #
  # source://redis//lib/redis.rb#41
  def initialize(options = T.unsafe(nil)); end

  # source://redis//lib/redis.rb#1166
  def _bpop(cmd, args, &blk); end

  # source://redis//lib/redis.rb#121
  def _client; end

  # source://redis//lib/redis.rb#2548
  def _eval(cmd, args); end

  # source://redis//lib/redis.rb#2611
  ...
  #
  # source://redis//lib/redis.rb#1007
  ...
  #
  # source://redis//lib/redis.rb#3281
  def asking; end
  ...
  #
  # source://redis//lib/redis.rb#1019
  ...
  #
  # source://redis//lib/redis.rb#1031
  ...
  #
  # source://redis//lib/redis.rb#1045
  ...
  #
  # source://redis//lib/redis.rb#1211
  def blpop(*args); end
  ...
  # @see #blpop
  #
  # source://redis//lib/redis.rb#1227
  def brpop(*args); end
  ...
  #
  # source://redis//lib/redis.rb#1242
  ...
  #
  # source://redis//lib/redis.rb#1694
  ...
  # @return [nil] when no element could be popped and the timeout expired
  #
  # source://redis//lib/redis.rb#1715
  ...
  #
  # source://redis//lib/redis.rb#220
  def client(subcommand = T.unsafe(nil), *args); end

  # Disconnect the client as quickly and silently as possible.
  #
  # source://redis//lib/redis.rb#73
  def close; end
  ...
  #
  # source://redis//lib/redis.rb#3258
  ...
  # @return [Boolean]
  #
  # source://redis//lib/redis.rb#68
  def connected?; end

  # source://redis//lib/redis.rb#3297
  def connection; end
  ...
  # @see #exec
  #
  # source://redis//lib/redis.rb#2494
  def discard; end
  ...
  #
  # source://redis//lib/redis.rb#483
  def dump(key); end

  # source://redis//lib/redis.rb#3293
  def dup; end
  ...
  # @see #evalsha
  #
  # source://redis//lib/redis.rb#2582
  def eval(*args); end
  ...
  # @see #eval
  #
  # source://redis//lib/redis.rb#2607
  ...
  # @see #discard
  #
  # source://redis//lib/redis.rb#2480
  def exec; end
  ...
  #
  # source://redis//lib/redis.rb#2827
  ...
  #
  # source://redis//lib/redis.rb#2896
  ...
  #
  # source://redis//lib/redis.rb#2838
  ...
  #
  # source://redis//lib/redis.rb#2884
  ...
  #
  # source://redis//lib/redis.rb#2854
  ...
  # @return [Array<String>] may be changed with `options`
  #
  # source://redis//lib/redis.rb#2871
  ...
  #   did not exist
  #
  # source://redis//lib/redis.rb#1064
  ...
  #
  # source://redis//lib/redis.rb#2213
  ...
  #
  # source://redis//lib/redis.rb#2224
  ...
  # @return [String]
  #
  # source://redis//lib/redis.rb#2164
  ...
  #
  # source://redis//lib/redis.rb#2236
  ...
  #
  # source://redis//lib/redis.rb#2248
  ...
  # @return [Array<String>]
  #
  # source://redis//lib/redis.rb#2258
  def hkeys(key); end
  ...
  #
  # source://redis//lib/redis.rb#2097
  def hlen(key); end
  ...
  # @see #mapped_hmget
  #
  # source://redis//lib/redis.rb#2181
  ...
  # @see #mapped_hmset
  #
  # source://redis//lib/redis.rb#2138
  ...
  #
  # source://redis//lib/redis.rb#2684
  ...
  #
  # source://redis//lib/redis.rb#2701
  ...
  #
  # source://redis//lib/redis.rb#2109
  ...
  # @return [Boolean] whether or not the field was **added** to the hash
  #
  # source://redis//lib/redis.rb#2121
  ...
  # @return [Array<String>]
  #
  # source://redis//lib/redis.rb#2268
  def hvals(key); end

  # source://redis//lib/redis.rb#3285
  def id; end
  ...
  # @return [Hash<String, String>]
  #
  # source://redis//lib/redis.rb#284
  def info(cmd = T.unsafe(nil)); end

  # source://redis//lib/redis.rb#3289
  def inspect; end
  ...
  # @return [String]
  #
  # source://redis//lib/redis.rb#1263
  ...
  #
  # source://redis//lib/redis.rb#1277
  ...
  # @return [Fixnum]
  #
  # source://redis//lib/redis.rb#1085
  def llen(key); end
  ...
  # @return [String]
  #
  # source://redis//lib/redis.rb#1139
  def lpop(key); end
  ...
  #
  # source://redis//lib/redis.rb#1096
  ...
  # @return [Fixnum] the length of the list after the push operation
  #
  # source://redis//lib/redis.rb#1107
  ...
  # @return [Array<String>]
  #
  # source://redis//lib/redis.rb#1289
  ...
  #
  # source://redis//lib/redis.rb#1304
  ...
  # @return [String] `OK`
  #
  # source://redis//lib/redis.rb#1316
  ...
  # @return [String] `OK`
  #
  # source://redis//lib/redis.rb#1328
  ...
  # @see #hmget
  #
  # source://redis//lib/redis.rb#2198
  ...
  # @see #hmset
  #
  # source://redis//lib/redis.rb#2155
  ...
  # @see #msetnx
  #
  # source://redis//lib/redis.rb#904
  def mapped_msetnx(hash); end

  # source://redis//lib/redis.rb#3309
  ...
  #
  # source://redis//lib/redis.rb#2453
  def multi; end

  # source://redis//lib/redis.rb#603
  def object(*args); end
  ...
  #
  # source://redis//lib/redis.rb#2791
  ...
  # @return [Fixnum]
  #
  # source://redis//lib/redis.rb#2804
  ...
  # @return [Boolean]
  #
  # source://redis//lib/redis.rb#2816
  ...
  # @return [String] `PONG`
  #
  # source://redis//lib/redis.rb#151
  def ping(message = T.unsafe(nil)); end

  # source://redis//lib/redis.rb#2410
  def pipelined; end
  ...
  #
  # source://redis//lib/redis.rb#473
  def pttl(key); end

  # Post a message to a channel.
  #
  # source://redis//lib/redis.rb#2285
  def publish(channel, message); end

  # Inspect the state of the Pub/Sub subsystem.
  # Possible subcommands: channels, numsub, numpat.
  #
  # source://redis//lib/redis.rb#2343
  def pubsub(subcommand, *args); end

  # Stop listening for messages posted to channels matching the given patterns.
  #
  # source://redis//lib/redis.rb#2334
  ...
  # @return [String]
  #
  # source://redis//lib/redis.rb#1149
  def rpop(key); end
  ...
  #
  # source://redis//lib/redis.rb#1160
  ...
  # @return [Fixnum] the length of the list after the push operation
  #
  # source://redis//lib/redis.rb#1118
  ...
  # @return [Fixnum] the length of the list after the push operation
  #
  # source://redis//lib/redis.rb#1129
  ...
  #   successfully added
  #
  # source://redis//lib/redis.rb#1352
  ...
  #
  # source://redis//lib/redis.rb#2644
  ...
  # @return [Enumerator] an enumerator for all found keys
  #
  # source://redis//lib/redis.rb#2663
  ...
  # @return [Fixnum]
  #
  # source://redis//lib/redis.rb#1338
  def scard(key); end
  ...
  # @see #evalsha
  #
  # source://redis//lib/redis.rb#2524
  ...
  #
  # source://redis//lib/redis.rb#1455
  def sdiff(*keys); end
  ...
  #
  # source://redis//lib/redis.rb#1466
  ...
  #
  # source://redis//lib/redis.rb#3228
  ...
  #
  # source://redis//lib/redis.rb#960
  def setrange(key, offset, value); end

  # Synchronously save the dataset to disk and then shut down the server.
  #
  # source://redis//lib/redis.rb#335
  def shutdown; end
  ...
  #
  # source://redis//lib/redis.rb#1476
  def sinter(*keys); end
  ...
  # @return [Fixnum] number of elements in the resulting set
  #
  # source://redis//lib/redis.rb#1487
  ...
  # @return [Boolean]
  #
  # source://redis//lib/redis.rb#1435
  def sismember(key, member); end

  # Make the server a slave of another instance, or promote it as master.
  #
  # source://redis//lib/redis.rb#349
  ...
  # @return [Array<String>]
  #
  # source://redis//lib/redis.rb#1445
  ...
  # @return [Boolean]
  #
  # source://redis//lib/redis.rb#1424
  ...
  # @return [String]
  #
  # source://redis//lib/redis.rb#1393
  ...
  # @return [String]
  #
  # source://redis//lib/redis.rb#1408
  ...
  #
  # source://redis//lib/redis.rb#1374
  ...
  #
  # source://redis//lib/redis.rb#2761
  ...
  #
  # source://redis//lib/redis.rb#2776
  ...
  #
  # source://redis//lib/redis.rb#1075
  def strlen(key); end
  ...
  #
  # source://redis//lib/redis.rb#1497
  def sunion(*keys); end
  ...
  # @return [Fixnum] number of elements in the resulting set
  #
  # source://redis//lib/redis.rb#1508
  def sunionstore(destination, *keys); end

  # Internal command used for replication.
  #
  # source://redis//lib/redis.rb#369
  def sync; end

  # source://redis//lib/redis.rb#51
  def synchronize; end
  ...
  #
  # source://redis//lib/redis.rb#546
  def unlink(*keys); end

  # Stop listening for messages posted to the given channels.
  #
  # source://redis//lib/redis.rb#2312
  ...
  # @see #multi
  #
  # source://redis//lib/redis.rb#2404
  def unwatch; end
  ...
  # @see #multi
  #
  # source://redis//lib/redis.rb#2379
  def watch(*keys); end

  # Run code with the client reconnecting
  #
  # source://redis//lib/redis.rb#56
  ...
  #
  # source://redis//lib/redis.rb#3143
  ...
  #
  # source://redis//lib/redis.rb#2947
  ...
  #
  # source://redis//lib/redis.rb#3180
  ...
  #
  # source://redis//lib/redis.rb#2983
  ...
  #
  # source://redis//lib/redis.rb#3091
  ...
  #
  # source://redis//lib/redis.rb#2918
  ...
  #
  # source://redis//lib/redis.rb#3042
  def xlen(key); end
  ...
  #
  # source://redis//lib/redis.rb#3209
  ...
  #
  # source://redis//lib/redis.rb#3005
  ...
  #
  # source://redis//lib/redis.rb#3063
  ...
  # @return [Hash{String => Hash{String => Hash}}] the entries
  #
  # source://redis//lib/redis.rb#3121
  ...
  # @return [Array<Array<String, Hash>>] the ids and entries pairs
  #
  # source://redis//lib/redis.rb#3028
  ...
  # @return [Integer] the number of entries actually deleted
  #
  # source://redis//lib/redis.rb#2967
  ...
  #
  # source://redis//lib/redis.rb#1559
  ...
  # @return [Fixnum]
  #
  # source://redis//lib/redis.rb#1522
  def zcard(key); end
  ...
  #
  # source://redis//lib/redis.rb#2032
  ...
  #
  # source://redis//lib/redis.rb#1600
  ...
  #
  # source://redis//lib/redis.rb#2052
  ...
  #
  # source://redis//lib/redis.rb#1855
  ...
  #
  # source://redis//lib/redis.rb#1651
  ...
  # @return [Array<Array<String, Float>>] list of popped elements and scores
  #
  # source://redis//lib/redis.rb#1672
  ...
  #
  # source://redis//lib/redis.rb#1754
  ...
  #
  # source://redis//lib/redis.rb#1882
  ...
  #   - when `:with_scores` is specified, an array with `[member, score]` pairs
  #
  # source://redis//lib/redis.rb#1942
  ...
  # @return [Fixnum]
  #
  # source://redis//lib/redis.rb#1800
  ...
  #
  # source://redis//lib/redis.rb#1623
  ...
  #
  # source://redis//lib/redis.rb#1831
  ...
  # @return [Fixnum] number of members that were removed
  #
  # source://redis//lib/redis.rb#2009
  ...
  # @see #zrange
  #
  # source://redis//lib/redis.rb#1780
  ...
  # @see #zrangebylex
  #
  # source://redis//lib/redis.rb#1904
  ...
  # @see #zrangebyscore
  #
  # source://redis//lib/redis.rb#1974
  ...
  # @return [Fixnum]
  #
  # source://redis//lib/redis.rb#1812
  ...
  #   members and scores
  #
  # source://redis//lib/redis.rb#2723
  ...
  #
  # source://redis//lib/redis.rb#2740
  ...
  #
  # source://redis//lib/redis.rb#1730
...
#
# source://redis//lib/redis/errors.rb#22
...
# returning false.
#
# source://redis//lib/redis.rb#3320
Redis::Boolify = T.let(T.unsafe(nil), Proc)

# source://redis//lib/redis.rb#3331
...
class Redis::Client
  ...
  #
  # source://redis//lib/redis/client.rb#82
  def initialize(options = T.unsafe(nil)); end

  # source://redis//lib/redis/client.rb#124
  def call(command); end

  # source://redis//lib/redis/client.rb#135
  def call_loop(command, timeout = T.unsafe(nil)); end

  # source://redis//lib/redis/client.rb#159
  def call_pipeline(pipeline); end

  # source://redis//lib/redis/client.rb#177
  def call_pipelined(pipeline); end

  # source://redis//lib/redis/client.rb#217
  def call_with_timeout(command, timeout, &blk); end

  # source://redis//lib/redis/client.rb#225
  ...
  # source://redis//lib/redis/client.rb#101
  def connect; end

  # source://redis//lib/redis/client.rb#50
  def connect_timeout; end

  # @return [Boolean]
  #
  # source://redis//lib/redis/client.rb#246
  def connected?; end

  # Returns the value of attribute connection.
  #
  # source://redis//lib/redis/client.rb#79
  def connection; end

  # source://redis//lib/redis/client.rb#62
  def db; end

  # source://redis//lib/redis/client.rb#66
  def db=(db); end

  # source://redis//lib/redis/client.rb#250
  def disconnect; end

  # source://redis//lib/redis/client.rb#70
  def driver; end

  # source://redis//lib/redis/client.rb#34
  def host; end

  # source://redis//lib/redis/client.rb#116
  def id; end

  # @return [Boolean]
  #
  # source://redis//lib/redis/client.rb#74
  def inherit_socket?; end

  # source://redis//lib/redis/client.rb#259
  def io; end
  ...
  # source://redis//lib/redis/client.rb#58
  def password; end

  # source://redis//lib/redis/client.rb#42
  def path; end

  # source://redis//lib/redis/client.rb#38
  def port; end

  # source://redis//lib/redis/client.rb#229
  def process(commands); end

  # source://redis//lib/redis/client.rb#270
  def read; end

  # source://redis//lib/redis/client.rb#46
  ...
  # source://redis//lib/redis/client.rb#54
  def timeout; end

  # source://redis//lib/redis/client.rb#303
  def with_reconnect(val = T.unsafe(nil)); end

  # source://redis//lib/redis/client.rb#285
  def with_socket_timeout(timeout); end

  # source://redis//lib/redis/client.rb#312
  def without_reconnect(&blk); end

  # source://redis//lib/redis/client.rb#299
  ...
  # source://redis//lib/redis/client.rb#502
  def _parse_driver(driver); end

  # source://redis//lib/redis/client.rb#403
  def _parse_options(options); end

  # source://redis//lib/redis/client.rb#365
  def ensure_connected; end

  # source://redis//lib/redis/client.rb#343
  def establish_connection; end

  # source://redis//lib/redis/client.rb#318
  def logging(commands); end
end

# source://redis//lib/redis/client.rb#522
class Redis::Client::Connector
  # @return [Connector] a new instance of Connector
  #
  # source://redis//lib/redis/client.rb#523
  def initialize(options); end

  # source://redis//lib/redis/client.rb#531
  def check(client); end

  # source://redis//lib/redis/client.rb#527
  def resolve; end
end

# source://redis//lib/redis/client.rb#534
class Redis::Client::Connector::Sentinel < ::Redis::Client::Connector
  # @return [Sentinel] a new instance of Sentinel
  #
  # source://redis//lib/redis/client.rb#535
  def initialize(options); end

  # source://redis//lib/redis/client.rb#545
  def check(client); end

  # source://redis//lib/redis/client.rb#562
  def resolve; end

  # source://redis//lib/redis/client.rb#601
  def resolve_master; end

  # source://redis//lib/redis/client.rb#609
  def resolve_slave; end

  # @raise [CannotConnectError]
  #
  # source://redis//lib/redis/client.rb#575
...
#
# source://redis//lib/redis/errors.rb#79
...
#
# source://redis//lib/redis/cluster/slot.rb#8
...
#
# source://redis//lib/redis/errors.rb#18
class Redis::CommandError < ::Redis::BaseError; end

# source://redis//lib/redis/connection/registry.rb#2
...
# source://redis//lib/redis/connection/command_helper.rb#3
...
# source://redis//lib/redis/connection/ruby.rb#301
class Redis::Connection::Ruby
  ...
  # source://redis//lib/redis/connection/ruby.rb#415
  def format_bulk_reply(line); end

  # source://redis//lib/redis/connection/ruby.rb#403
  def format_error_reply(line); end

  # source://redis//lib/redis/connection/ruby.rb#411
  def format_integer_reply(line); end

  # source://redis//lib/redis/connection/ruby.rb#423
  def format_multi_bulk_reply(line); end

  # source://redis//lib/redis/connection/ruby.rb#392
  def format_reply(reply_type, line); end

  # source://redis//lib/redis/connection/ruby.rb#407
  def format_status_reply(line); end

  # source://redis//lib/redis/connection/ruby.rb#348
  def get_tcp_keepalive; end

  # source://redis//lib/redis/connection/ruby.rb#383
  def read; end

  # source://redis//lib/redis/connection/ruby.rb#345
  def set_tcp_keepalive(keepalive); end

  # source://redis//lib/redis/connection/ruby.rb#369
  def timeout=(timeout); end

  # source://redis//lib/redis/connection/ruby.rb#379
  def write(command); end

  # source://redis//lib/redis/connection/ruby.rb#375
  def write_timeout=(timeout); end

  class << self
    # source://redis//lib/redis/connection/ruby.rb#310
    def connect(config); end
  end
end

# source://redis//lib/redis/connection/ruby.rb#308
Redis::Connection::Ruby::ASTERISK = T.let(T.unsafe(nil), String)

# source://redis//lib/redis/connection/ruby.rb#306
...
# source://redis//lib/redis/connection/ruby.rb#304
Redis::Connection::Ruby::MINUS = T.let(T.unsafe(nil), String)

# source://redis//lib/redis/connection/ruby.rb#305
Redis::Connection::Ruby::PLUS = T.let(T.unsafe(nil), String)

# source://redis//lib/redis/connection/ruby.rb#257
...
# source://redis//lib/redis/connection/ruby.rb#15
...
# source://redis//lib/redis/connection/ruby.rb#229
...
#
# source://redis//lib/redis/errors.rb#30
class Redis::ConnectionError < ::Redis::BaseConnectionError; end

# source://redis//lib/redis/distributed.rb#4
...
# source://redis//lib/redis.rb#3350
Redis::Floatify = T.let(T.unsafe(nil), Proc)

# source://redis//lib/redis.rb#3363
...
class Redis::Future < ::BasicObject
  ...
  # source://redis//lib/redis/pipeline.rb#151
  def _command; end

  # source://redis//lib/redis/pipeline.rb#146
  def _set(object); end

  # source://redis//lib/redis/pipeline.rb#164
  def class; end

  # source://redis//lib/redis/pipeline.rb#142
  def inspect; end

  # @return [Boolean]
  #
  # source://redis//lib/redis/pipeline.rb#160
  def is_a?(other); end

  # Returns the value of attribute timeout.
  #
  # source://redis//lib/redis/pipeline.rb#133
  def timeout; end
...
# source://redis//lib/redis.rb#3342
Redis::Hashify = T.let(T.unsafe(nil), Proc)

# source://redis//lib/redis.rb#3413
Redis::HashifyClusterNodeInfo = T.let(T.unsafe(nil), Proc)

# source://redis//lib/redis.rb#3442
...
# source://redis//lib/redis.rb#3450
Redis::Noop = T.let(T.unsafe(nil), Proc)

# source://redis//lib/redis/pipeline.rb#2
class Redis::Pipeline
  # @return [Pipeline] a new instance of Pipeline
  #
  # source://redis//lib/redis/pipeline.rb#8
  ...
  # source://redis//lib/redis/pipeline.rb#44
  def call_with_timeout(command, timeout, &block); end

  # Returns the value of attribute client.
  #
  # source://redis//lib/redis/pipeline.rb#4
  def client; end

  # source://redis//lib/redis/pipeline.rb#55
  def commands; end
  ...
  # @return [Boolean]
  #
  # source://redis//lib/redis/pipeline.rb#31
  def empty?; end

  # source://redis//lib/redis/pipeline.rb#72
  ...
  # @return [Boolean]
  #
  # source://redis//lib/redis/pipeline.rb#27
  def shutdown?; end

  # source://redis//lib/redis/pipeline.rb#15
  def timeout; end

  # source://redis//lib/redis/pipeline.rb#59
  def timeouts; end

  # source://redis//lib/redis/pipeline.rb#63
  def with_reconnect(val = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://redis//lib/redis/pipeline.rb#19
  ...
  # @return [Boolean]
  #
  # source://redis//lib/redis/pipeline.rb#23
  def without_reconnect?; end
end

# source://redis//lib/redis/pipeline.rb#84
class Redis::Pipeline::Multi < ::Redis::Pipeline
  # source://redis//lib/redis/pipeline.rb#114
  def commands; end

  # source://redis//lib/redis/pipeline.rb#85
...
#
# source://redis//lib/redis/errors.rb#7
...
# source://redis//lib/redis/subscribe.rb#2
...
#
# source://redis//lib/redis/errors.rb#34
