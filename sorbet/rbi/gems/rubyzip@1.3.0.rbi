...
# source://rubyzip//lib/zip/dos_time.rb#1
module Zip
  extend ::Zip
...
class Zip::CentralDirectory
  ...
  # source://rubyzip//lib/zip/central_directory.rb#199
  def ==(other); end
  ...
  #
  # source://rubyzip//lib/zip/central_directory.rb#181
  def each(&proc); end
  ...
  # @raise [Error]
  #
  # source://rubyzip//lib/zip/central_directory.rb#166
  ...
  #
  # source://rubyzip//lib/zip/central_directory.rb#187
  def size; end

  # source://rubyzip//lib/zip/central_directory.rb#157
  ...
  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/central_directory.rb#153
  ...
  class << self
    # source://rubyzip//lib/zip/central_directory.rb#191
    def read_from_stream(io); end
  end
end
...
class Zip::DOSTime < ::Time
  ...
  class << self
    # source://rubyzip//lib/zip/dos_time.rb#32
...
class Zip::Entry
  ...
  #
  # source://rubyzip//lib/zip/entry.rb#54
  ...
  # source://rubyzip//lib/zip/entry.rb#140
  def calculate_local_header_size; end

  # source://rubyzip//lib/zip/entry.rb#152
  def cdir_header_size; end

  # @raise [::Zip::Error]
  #
  # source://rubyzip//lib/zip/entry.rb#365
  def check_c_dir_entry_comment_size; end

  # @raise [Error]
  #
  # source://rubyzip//lib/zip/entry.rb#360
  def check_c_dir_entry_signature; end

  # @raise [Error]
  #
  # source://rubyzip//lib/zip/entry.rb#355
  ...
  # source://rubyzip//lib/zip/entry.rb#585
  def clean_up; end
  ...
  # source://rubyzip//lib/zip/entry.rb#136
  ...
  # source://rubyzip//lib/zip/entry.rb#104
  def directory?; end
  ...
  # source://rubyzip//lib/zip/entry.rb#132
  def extra_size; end
  ...
  # source://rubyzip//lib/zip/entry.rb#395
  def file_stat(path); end

  # @raise [InternalError]
  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/entry.rb#97
  ...
  # source://rubyzip//lib/zip/entry.rb#532
  ...
  #
  # source://rubyzip//lib/zip/entry.rb#500
  def get_input_stream(&block); end

  # source://rubyzip//lib/zip/entry.rb#577
  ...
  # source://rubyzip//lib/zip/entry.rb#124
  ...
  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/entry.rb#109
  ...
  # source://rubyzip//lib/zip/entry.rb#326
  def set_ftype_from_c_dir_entry; end

  # source://rubyzip//lib/zip/entry.rb#411
  ...
  # source://rubyzip//lib/zip/entry.rb#89
  def time=(value); end

  # source://rubyzip//lib/zip/entry.rb#182
  def to_s; end
  ...
  # source://rubyzip//lib/zip/entry.rb#302
  def unpack_c_dir_entry(buf); end

  # source://rubyzip//lib/zip/entry.rb#223
  ...
  # @raise [Error]
  #
  # source://rubyzip//lib/zip/entry.rb#146
  def verify_local_header_size!; end

  # source://rubyzip//lib/zip/entry.rb#457
  def write_c_dir_entry(io); end

  # source://rubyzip//lib/zip/entry.rb#290
  ...
  #
  # source://rubyzip//lib/zip/entry.rb#650
  ...
  # source://rubyzip//lib/zip/entry.rb#591
  def set_time(binary_dos_date, binary_dos_time); end

  class << self
    # source://rubyzip//lib/zip/entry.rb#199
    def read_c_dir_entry(io); end

    # source://rubyzip//lib/zip/entry.rb#212
    def read_local_entry(io); end
    ...
    # source://rubyzip//lib/zip/entry.rb#187
...
class Zip::EntrySet
  ...
  # source://rubyzip//lib/zip/entry_set.rb#60
  ...
  # source://rubyzip//lib/zip/entry_set.rb#56
  ...
  # source://rubyzip//lib/zip/entry_set.rb#70
  def sorted_entries; end

  private

  # source://rubyzip//lib/zip/entry_set.rb#76
...
class Zip::ExtraField < ::Hash
  ...
  # source://rubyzip//lib/zip/extra_field.rb#53
  def create(name); end
  ...
  #
  # source://rubyzip//lib/zip/extra_field.rb#62
...
class Zip::ExtraField::IUnix < ::Zip::ExtraField::Generic
  ...
  # source://rubyzip//lib/zip/extra_field/unix.rb#25
  def ==(other); end
...
class Zip::ExtraField::NTFS < ::Zip::ExtraField::Generic
  ...
  # source://rubyzip//lib/zip/extra_field/ntfs.rb#36
  def ==(other); end
  ...
  #
  # source://rubyzip//lib/zip/extra_field/ntfs.rb#48
  def pack_for_c_dir; end

  # Info-ZIP note states this extra field is stored at local header
  #
  # source://rubyzip//lib/zip/extra_field/ntfs.rb#43
  def pack_for_local; end

  private

  # source://rubyzip//lib/zip/extra_field/ntfs.rb#82
  def from_ntfs_time(ntfs_time); end

  # source://rubyzip//lib/zip/extra_field/ntfs.rb#66
...
class Zip::ExtraField::OldUnix < ::Zip::ExtraField::Generic
  ...
  # source://rubyzip//lib/zip/extra_field/old_unix.rb#29
  def ==(other); end
  ...
  # source://rubyzip//lib/zip/extra_field/old_unix.rb#36
  def pack_for_local; end
...
class Zip::ExtraField::UniversalTime < ::Zip::ExtraField::Generic
  ...
  # Returns the value of attribute atime.
  #
  # source://rubyzip//lib/zip/extra_field/universal_time.rb#15
  def atime; end
  ...
  # source://rubyzip//lib/zip/extra_field/universal_time.rb#17
  def merge(binstr); end
  ...
  # source://rubyzip//lib/zip/extra_field/universal_time.rb#41
  def pack_for_c_dir; end

  # source://rubyzip//lib/zip/extra_field/universal_time.rb#33
  def pack_for_local; end
end
...
class Zip::ExtraField::Zip64 < ::Zip::ExtraField::Generic
  ...
  # source://rubyzip//lib/zip/extra_field/zip64.rb#58
  def pack_for_c_dir; end

  # source://rubyzip//lib/zip/extra_field/zip64.rb#52
  def pack_for_local; end
  ...
  #
  # source://rubyzip//lib/zip/extra_field/zip64.rb#35
  ...
  # source://rubyzip//lib/zip/extra_field/zip64.rb#47
...
class Zip::File < ::Zip::CentralDirectory
  ...
  # the zip archive.
  #
  # source://rubyzip//lib/zip/file.rb#328
  def commit; end
  ...
  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/file.rb#359
  ...
  #
  # source://rubyzip//lib/zip/file.rb#368
  ...
  # @raise [Errno::ENOENT]
  #
  # source://rubyzip//lib/zip/file.rb#379
  ...
  # File.open method.
  #
  # source://rubyzip//lib/zip/file.rb#253
  ...
  #
  # source://rubyzip//lib/zip/file.rb#373
  ...
  # @raise [Errno::EEXIST]
  #
  # source://rubyzip//lib/zip/file.rb#389
  ...
  #
  # source://rubyzip//lib/zip/file.rb#276
  def read(entry); end

  # Removes the specified entry.
  #
  # source://rubyzip//lib/zip/file.rb#298
  ...
  # source://rubyzip//lib/zip/file.rb#425
  ...
  class << self
    ...
    #
    # source://rubyzip//lib/zip/file.rb#110
    ...
    # source://rubyzip//lib/zip/file.rb#188
...
module Zip::IOExtras::AbstractInputStream
  ...
  # source://rubyzip//lib/zip/ioextras/abstract_input_stream.rb#103
  def each(a_sep_string = T.unsafe(nil)); end

  # source://rubyzip//lib/zip/ioextras/abstract_input_stream.rb#103
  def each_line(a_sep_string = T.unsafe(nil)); end

  # source://rubyzip//lib/zip/ioextras/abstract_input_stream.rb#91
  def flush; end

  # source://rubyzip//lib/zip/ioextras/abstract_input_stream.rb#57
  ...
  # @raise [EOFError]
  #
  # source://rubyzip//lib/zip/ioextras/abstract_input_stream.rb#97
  def readline(a_sep_string = T.unsafe(nil)); end

  # source://rubyzip//lib/zip/ioextras/abstract_input_stream.rb#51
  def readlines(a_sep_string = T.unsafe(nil)); end

  # source://rubyzip//lib/zip/ioextras/abstract_input_stream.rb#87
  def ungetc(byte); end
end
...
class Zip::Inflater < ::Zip::Decompressor
  ...
  # source://rubyzip//lib/zip/inflater.rb#11
  ...
  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/inflater.rb#52
  def internal_input_finished?; end

  # source://rubyzip//lib/zip/inflater.rb#41
  def internal_produce_input(buf = T.unsafe(nil)); end

  # mimic behaviour of ruby File object.
  #
  # source://rubyzip//lib/zip/inflater.rb#56
...
class Zip::InputStream
  ...
  #
  # source://rubyzip//lib/zip/input_stream.rb#50
  def initialize(context, offset = T.unsafe(nil), decrypter = T.unsafe(nil)); end

  # source://rubyzip//lib/zip/input_stream.rb#58
  def close; end

  # source://rubyzip//lib/zip/input_stream.rb#85
  def eof; end
  ...
  #
  # source://rubyzip//lib/zip/input_stream.rb#81
  def sysread(number_of_bytes = T.unsafe(nil), buf = T.unsafe(nil)); end
  ...
  # source://rubyzip//lib/zip/input_stream.rb#113
  def get_io(io_or_file, offset = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/input_stream.rb#165
  def input_finished?; end

  # source://rubyzip//lib/zip/input_stream.rb#125
  def open_entry; end

  # source://rubyzip//lib/zip/input_stream.rb#161
  def produce_input; end
  ...
  class << self
    ...
    # returns.
    #
    # source://rubyzip//lib/zip/input_stream.rb#95
    def open(filename_or_io, offset = T.unsafe(nil), decrypter = T.unsafe(nil)); end

    # source://rubyzip//lib/zip/input_stream.rb#105
...
module Zip::NullDecompressor
  ...
  # source://rubyzip//lib/zip/null_decompressor.rb#17
  def eof; end
...
class Zip::OutputStream
  ...
  #
  # source://rubyzip//lib/zip/output_stream.rb#67
  def close; end

  # Closes the stream and writes the central directory to the zip file
  #
  # source://rubyzip//lib/zip/output_stream.rb#77
  ...
  # @raise [Error]
  #
  # source://rubyzip//lib/zip/output_stream.rb#104
  ...
  # @raise [Error]
  #
  # source://rubyzip//lib/zip/output_stream.rb#88
  ...
  class << self
    ...
    # @yield [zos]
    #
    # source://rubyzip//lib/zip/output_stream.rb#59
...
class Zip::PassThruDecompressor < ::Zip::Decompressor
  ...
  # @return [Boolean]
  #
  # source://rubyzip//lib/zip/pass_thru_decompressor.rb#29
  def eof; end
...
class Zip::StreamableStream
  ...
  # source://rubyzip//lib/zip/streamable_stream.rb#48
  def clean_up; end

  # source://rubyzip//lib/zip/streamable_stream.rb#26
  def get_input_stream; end

  # source://rubyzip//lib/zip/streamable_stream.rb#14
  def get_output_stream; end

  # source://rubyzip//lib/zip/streamable_stream.rb#43
...
#
# source://rubyzip//lib/zip/errors.rb#12
