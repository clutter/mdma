...
class SorbetRails::Config
  ...
  # source://sorbet-rails//lib/sorbet-rails/config.rb#69
  sig { returns(T::Array[::Symbol]) }
...
class SorbetRails::JobRbiFormatter
  ...
  # source://sorbet-rails//lib/sorbet-rails/job_rbi_formatter.rb#80
  sig { returns(::String) }
...
class SorbetRails::ModelPlugins::ActiveRecordAssoc < ::SorbetRails::ModelPlugins::Base
  ...
  # source://sorbet-rails//lib/sorbet-rails/model_plugins/active_record_assoc.rb#159
  ...
  # source://sorbet-rails//lib/sorbet-rails/model_plugins/active_record_assoc.rb#178
  sig { params(reflection: T.untyped).returns(T.nilable(T::Boolean)) }
  def polymorphic_assoc?(reflection); end

  # source://sorbet-rails//lib/sorbet-rails/model_plugins/active_record_assoc.rb#125
  ...
  # source://sorbet-rails//lib/sorbet-rails/model_plugins/active_record_assoc.rb#172
  sig { params(reflection: T.untyped).returns(T.nilable(T::Boolean)) }
  def relation_should_be_untyped?(reflection); end

  private

  # source://sorbet-rails//lib/sorbet-rails/model_plugins/active_record_assoc.rb#73
  sig { params(reflection: T.untyped).returns(T::Boolean) }
  def belongs_to_and_required?(reflection); end

  # source://sorbet-rails//lib/sorbet-rails/model_plugins/active_record_assoc.rb#114
  sig { params(reflection: T.untyped).returns(T::Boolean) }
...
class SorbetRails::ModelPlugins::ActiveRecordAttribute < ::SorbetRails::ModelPlugins::Base
  ...
  # source://sorbet-rails//lib/sorbet-rails/model_plugins/active_record_attribute.rb#59
  sig do
    params(
  ...
  # source://sorbet-rails//lib/sorbet-rails/model_plugins/active_record_attribute.rb#127
...
class SorbetRails::ModelPlugins::ActiveRecordQuerying < ::SorbetRails::ModelPlugins::Base
  ...
  # source://sorbet-rails//lib/sorbet-rails/model_plugins/active_record_querying.rb#66
...
# source://sorbet-rails//lib/sorbet-rails/model_plugins/plugins.rb#89
...
class SorbetRails::ModelRbiFormatter
  ...
  # source://sorbet-rails//lib/sorbet-rails/model_rbi_formatter.rb#70
  sig { params(root: ::Parlour::RbiGenerator::Namespace).void }
  def generate_base_rbi(root); end

  # source://sorbet-rails//lib/sorbet-rails/model_rbi_formatter.rb#36
  sig { returns(::String) }
  def generate_rbi; end
  ...
  # source://sorbet-rails//lib/sorbet-rails/model_rbi_formatter.rb#122
  sig do
    params(
...
module SorbetRails::ModelUtils
  ...
  # source://sorbet-rails//lib/sorbet-rails/model_utils.rb#95
  sig do
    params(
      root: ::Parlour::RbiGenerator::Namespace,
      method_name: ::String,
