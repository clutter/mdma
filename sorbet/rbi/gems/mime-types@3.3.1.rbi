...
#                                  # => false
#
# source://mime-types//lib/mime/type.rb#31
class MIME::Type
  include ::Comparable
  ...
  # @return [Boolean]
  #
  # source://mime-types//lib/mime/type.rb#389
  def binary?; end
  ...
  # @return [Boolean]
  #
  # source://mime-types//lib/mime/type.rb#406
  def complete?; end
  ...
  #
  # source://mime-types//lib/mime/type.rb#198
  def content_type; end

  # Returns the default encoding for the MIME::Type based on the media type.
  #
  # source://mime-types//lib/mime/type.rb#303
  ...
  #
  # source://mime-types//lib/mime/type.rb#440
  ...
  #
  # source://mime-types//lib/mime/type.rb#238
  def extensions; end
  ...
  #
  # source://mime-types//lib/mime/type.rb#334
  ...
  #
  # source://mime-types//lib/mime/type.rb#359
  def i18n_key; end
  ...
  # source://mime-types//lib/mime/type.rb#483
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://mime-types//lib/mime/type.rb#115
  def like?(other); end
  ...
  #   audio/QCELP       => audio
  #
  # source://mime-types//lib/mime/type.rb#212
  def media_type; end

  # Returns +true+ if the media type is obsolete.
  #
  # source://mime-types//lib/mime/type.rb#323
  def obsolete; end
  ...
  # source://mime-types//lib/mime/type.rb#264
  ...
  #
  # source://mime-types//lib/mime/type.rb#158
  ...
  #   audio/QCELP       => qcelp
  #
  # source://mime-types//lib/mime/type.rb#230
  ...
  #
  # source://mime-types//lib/mime/type.rb#401
  def signature; end
  ...
  #   audio/QCELP       => audio/qcelp
  #
  # source://mime-types//lib/mime/type.rb#206
  def simplified; end
  ...
  # source://mime-types//lib/mime/type.rb#315
  def use_instead; end
  ...
  #
  # source://mime-types//lib/mime/type.rb#320
  def use_instead=(_arg0); end

  # The decoded cross-reference URL list for this MIME::Type.
  #
  # source://mime-types//lib/mime/type.rb#375
  def xref_urls; end

  # Returns the value of attribute xrefs.
  #
  # source://mime-types//lib/mime/type.rb#367
  def xrefs; end

  # source://mime-types//lib/mime/type.rb#370
  def xrefs=(xrefs); end
  ...
  #
  # source://mime-types//lib/mime/type.rb#553
  def intern_string(string); end

  # source://mime-types//lib/mime/type.rb#564
  def xref_map(values, helper); end

  # source://mime-types//lib/mime/type.rb#572
  def xref_url_for_draft(value); end

  # source://mime-types//lib/mime/type.rb#580
  def xref_url_for_person(value); end

  # source://mime-types//lib/mime/type.rb#568
  ...
  class << self
    ...
    #
    # source://mime-types//lib/mime/type.rb#503
...
#
# source://mime-types//lib/mime/type.rb#60
...
class MIME::Types
  ...
  #
  # source://mime-types//lib/mime/types.rb#74
  def initialize; end
  ...
  #   6. Sort on name.
  #
  # source://mime-types//lib/mime/types.rb#124
  ...
  #
  # source://mime-types//lib/mime/types.rb#165
  def add(*types); end
  ...
  #
  # source://mime-types//lib/mime/types.rb#186
  def add_type(type, quiet = T.unsafe(nil)); end

  # Returns the number of known type variants.
  #
  # source://mime-types//lib/mime/types.rb#80
  def count; end

  # Iterates through the type variants.
  #
  # source://mime-types//lib/mime/types.rb#89
  def each; end

  # source://mime-types//lib/mime/types.rb#84
  def inspect; end
  ...
  #
  # source://mime-types//lib/mime/types.rb#151
  def of(filename); end
  ...
  # source://mime-types//lib/mime/types.rb#199
  def add_type_variant!(mime_type); end

  # source://mime-types//lib/mime/types.rb#209
  def index_extensions!(mime_type); end

  # source://mime-types//lib/mime/types.rb#219
  def match(pattern); end

  # source://mime-types//lib/mime/types.rb#213
  def prune_matches(matches, complete, registered); end

  # source://mime-types//lib/mime/types.rb#203
  ...
  class << self
    ...
    #
    # source://mime-types//lib/mime/types/logger.rb#14
    def logger; end
...
module MIME::Types::Columnar
  ...
  # source://mime-types//lib/mime/types/_columnar.rb#121
  def arr(line); end

  # source://mime-types//lib/mime/types/_columnar.rb#109
  ...
  # source://mime-types//lib/mime/types/_columnar.rb#133
  def flag(line); end
  ...
  # source://mime-types//lib/mime/types/_columnar.rb#97
  def load_friendly; end

  # source://mime-types//lib/mime/types/_columnar.rb#76
  def load_preferred_extension; end

  # source://mime-types//lib/mime/types/_columnar.rb#103
  def load_use_instead; end

  # source://mime-types//lib/mime/types/_columnar.rb#91
  def load_xrefs; end

  # source://mime-types//lib/mime/types/_columnar.rb#129
  def opt(line); end
...
#
# source://mime-types//lib/mime/types/loader.rb#23
class MIME::Types::Loader
  ...
  #
  # source://mime-types//lib/mime/types/loader.rb#32
  ...
  #
  # source://mime-types//lib/mime/types/loader.rb#28
  def container; end
  ...
  #
  # source://mime-types//lib/mime/types/loader.rb#60
  def load_json; end
  ...
  #
  # source://mime-types//lib/mime/types/loader.rb#47
  def load_yaml; end

  # The path that will be read for the MIME::Types files.
  #
  # source://mime-types//lib/mime/types/loader.rb#25
  def path; end

  private

  # source://mime-types//lib/mime/types/loader.rb#143
  def columnar_path; end

  # source://mime-types//lib/mime/types/loader.rb#139
  def json_path; end

  # source://mime-types//lib/mime/types/loader.rb#135
  def yaml_path; end

  class << self
    # Loads the default MIME::Type registry.
    #
    # source://mime-types//lib/mime/types/loader.rb#93
    def load(options = T.unsafe(nil)); end
    ...
    # shipped with the mime-types library.
    #
    # source://mime-types//lib/mime/types/loader.rb#121
    ...
    # NOTE: The purpose of this format is purely for maintenance reasons.
    #
    # source://mime-types//lib/mime/types/loader.rb#106
    def load_from_yaml(filename); end

    private

    # source://mime-types//lib/mime/types/loader.rb#128
...
#
# source://mime-types//lib/mime/types.rb#69
