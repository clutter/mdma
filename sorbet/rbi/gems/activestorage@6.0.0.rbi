...
module ActiveStorage::Attached::Model
  ...
  # source://activestorage//lib/active_storage/attached/model.rb#139
  def attachment_changes; end

  # source://activestorage//lib/active_storage/attached/model.rb#143
...
module ActiveStorage::Attached::Model::ClassMethods
  # source://activestorage//lib/active_storage/attached/model.rb#89
...
module ActiveStorage::Attachment::GeneratedAssociationMethods
  ...
  # source://activerecord/6.0.0/lib/active_record/associations/builder/singular_association.rb#28
  def build_blob(*args, &block); end

  # source://activerecord/6.0.0/lib/active_record/associations/builder/singular_association.rb#32
  def create_blob(*args, &block); end

  # source://activerecord/6.0.0/lib/active_record/associations/builder/singular_association.rb#36
  def create_blob!(*args, &block); end
...
class ActiveStorage::Current < ::ActiveSupport::CurrentAttributes
  class << self
    # source://activesupport/6.0.0/lib/active_support/current_attributes.rb#112
    def host; end

    # source://activesupport/6.0.0/lib/active_support/current_attributes.rb#116
...
class ActiveStorage::Previewer::VideoPreviewer < ::ActiveStorage::Previewer
  # source://activestorage//lib/active_storage/previewer/video_previewer.rb#9
  def preview; end
  ...
  # source://activestorage//lib/active_storage/previewer/video_previewer.rb#22
  def ffmpeg_path; end

  class << self
    # source://activestorage//lib/active_storage/previewer/video_previewer.rb#5
    def accept?(blob); end
  end
end
...
#   )
#
# source://activestorage//lib/active_storage/service.rb#40
class ActiveStorage::Service
  ...
  # @raise [NotImplementedError]
  #
  # source://activestorage//lib/active_storage/service.rb#90
  def delete(key); end
  ...
  # @raise [NotImplementedError]
  #
  # source://activestorage//lib/active_storage/service.rb#95
  ...
  # @raise [NotImplementedError]
  #
  # source://activestorage//lib/active_storage/service.rb#81
  ...
  # @return [Boolean]
  #
  # source://activestorage//lib/active_storage/service.rb#100
  def exist?(key); end

  # Returns a Hash of headers for +url_for_direct_upload+ requests.
  #
  # source://activestorage//lib/active_storage/service.rb#120
  ...
  #
  # source://activestorage//lib/active_storage/service.rb#72
  ...
  # @raise [NotImplementedError]
  #
  # source://activestorage//lib/active_storage/service.rb#65
  ...
  # @raise [NotImplementedError]
  #
  # source://activestorage//lib/active_storage/service.rb#107
  ...
  # @raise [NotImplementedError]
  #
  # source://activestorage//lib/active_storage/service.rb#115
  ...
  # source://activestorage//lib/active_storage/service.rb#125
  def instrument(operation, payload = T.unsafe(nil), &block); end
  ...
  class << self
    ...
    #
    # source://activestorage//lib/active_storage/service.rb#58
    ...
    #
    # source://activestorage//lib/active_storage/service.rb#48
