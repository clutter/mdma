...
# source://aws-eventstream//lib/aws-eventstream/decoder.rb#5
module Aws
  class << self
...
# source://aws-eventstream//lib/aws-eventstream/decoder.rb#6
module Aws::EventStream; end

# @api private
#
# source://aws-eventstream//lib/aws-eventstream/bytes_buffer.rb#5
class Aws::EventStream::BytesBuffer
  ...
  #
  # @api private
  # @return [BytesBuffer] a new instance of BytesBuffer
  #
  # source://aws-eventstream//lib/aws-eventstream/bytes_buffer.rb#9
  def initialize(data); end

  # @api private
  #
  # source://aws-eventstream//lib/aws-eventstream/bytes_buffer.rb#37
  def <<(bytes); end

  # @api private
  #
  # source://aws-eventstream//lib/aws-eventstream/bytes_buffer.rb#51
  def bytesize; end

  # @api private
  #
  # source://aws-eventstream//lib/aws-eventstream/bytes_buffer.rb#59
  def clear!; end

  # @api private
  # @return [Boolean]
  #
  # source://aws-eventstream//lib/aws-eventstream/bytes_buffer.rb#47
  def eof?; end

  # @api private
  #
  # source://aws-eventstream//lib/aws-eventstream/bytes_buffer.rb#14
  def read(len = T.unsafe(nil), offset = T.unsafe(nil)); end

  # @api private
  #
  # source://aws-eventstream//lib/aws-eventstream/bytes_buffer.rb#30
  def readbyte; end

  # @api private
  #
  # source://aws-eventstream//lib/aws-eventstream/bytes_buffer.rb#43
  def rewind; end

  # @api private
  #
  # source://aws-eventstream//lib/aws-eventstream/bytes_buffer.rb#55
  def tell; end
...
#
# source://aws-eventstream//lib/aws-eventstream/decoder.rb#61
class Aws::EventStream::Decoder
  include ::Enumerable

  # @return [Decoder] a new instance of Decoder
  #
  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#79
  ...
  #
  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#95
  ...
  #
  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#113
  def decode_chunk(chunk = T.unsafe(nil)); end

  # Returns the value of attribute message_buffer.
  #
  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#85
  def message_buffer; end

  private

  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#166
  def context(io, total_len, headers_len, prelude_buffer); end

  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#121
  def decode_io(io); end

  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#125
  def decode_message(io); end

  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#185
  def extract_headers(buffer); end

  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#214
  def extract_payload(buffer); end

  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#220
  def payload_stringio(buffer); end

  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#224
  def payload_tempfile(buffer); end

  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#149
  def prelude(io); end

  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#240
  def unpack_uint16(buffer); end

  # overhead decode helpers
  #
  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#236
  def unpack_uint32(buffer); end

  # source://aws-eventstream//lib/aws-eventstream/decoder.rb#244
...
#
# source://aws-eventstream//lib/aws-eventstream/decoder.rb#73
Aws::EventStream::Decoder::OVERHEAD_LENGTH = T.let(T.unsafe(nil), Integer)

# bytes of prelude part, including 4 bytes of
# total message length, headers length and crc checksum of prelude
#
# source://aws-eventstream//lib/aws-eventstream/decoder.rb#69
...
#   # => true
#
# source://aws-eventstream//lib/aws-eventstream/encoder.rb#36
class Aws::EventStream::Encoder
  ...
  #
  # source://aws-eventstream//lib/aws-eventstream/encoder.rb#107
  ...
  # source://aws-eventstream//lib/aws-eventstream/encoder.rb#145
  def pack_uint16(val); end

  # source://aws-eventstream//lib/aws-eventstream/encoder.rb#149
  def pack_uint32(val); end

  # overhead encode helpers
  #
  # source://aws-eventstream//lib/aws-eventstream/encoder.rb#141
  def pack_uint8(val); end

  # source://aws-eventstream//lib/aws-eventstream/encoder.rb#131
...
# source://aws-eventstream//lib/aws-eventstream/errors.rb#3
module Aws::EventStream::Errors; end

# source://aws-eventstream//lib/aws-eventstream/errors.rb#39
...
# source://aws-eventstream//lib/aws-eventstream/errors.rb#33
...
#
# source://aws-eventstream//lib/aws-eventstream/errors.rb#15
...
# source://aws-eventstream//lib/aws-eventstream/errors.rb#27
...
# source://aws-eventstream//lib/aws-eventstream/errors.rb#21
...
#
# source://aws-eventstream//lib/aws-eventstream/errors.rb#6
...
# source://aws-eventstream//lib/aws-eventstream/header_value.rb#4
...
# source://aws-eventstream//lib/aws-eventstream/message.rb#3
...
#
# source://aws-eventstream//lib/aws-eventstream/types.rb#5
