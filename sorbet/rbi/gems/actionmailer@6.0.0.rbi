...
class ActionMailer::Base < ::AbstractController::Base
  ...
  # source://actionmailer//lib/action_mailer/base.rb#458
  ...
  #
  # source://actionmailer//lib/action_mailer/base.rb#732
  def attachments; end
  ...
  # for the same header.
  #
  # source://actionmailer//lib/action_mailer/base.rb#694
  ...
  #   end
  #
  # source://actionmailer//lib/action_mailer/base.rb#841
  ...
  # source://actionmailer//lib/action_mailer/base.rb#918
  ...
  # source://actionmailer//lib/action_mailer/base.rb#993
  ...
  #
  # source://actionmailer//lib/action_mailer/base.rb#908
  ...
  # source://actionmailer//lib/action_mailer/base.rb#1006
  def insert_part(container, response, charset); end

  # source://actionmailer//lib/action_mailer/base.rb#1020
  ...
  # used.
  #
  # source://actionmailer//lib/action_mailer/base.rb#886
  ...
  class << self
    ...
    #
    # source://actionmailer//lib/action_mailer/base.rb#545
    ...
    #
    # source://actionmailer//lib/action_mailer/base.rb#586
    ...
    #   end
    #
    # source://actionmailer//lib/action_mailer/base.rb#567
    ...
    #
    # source://actionmailer//lib/action_mailer/base.rb#474
    ...
    # source://actionmailer//lib/action_mailer/base.rb#608
...
# source://actionmailer//lib/action_mailer/base.rb#740
class ActionMailer::Base::LateAttachmentsProxy < ::SimpleDelegator
  # source://actionmailer//lib/action_mailer/base.rb#742
  def []=(_name, _content); end

  # source://actionmailer//lib/action_mailer/base.rb#741
  def inline; end
  ...
  # @raise [RuntimeError]
  #
  # source://actionmailer//lib/action_mailer/base.rb#745
...
class ActionMailer::Base::NullMail
  ...
  # @return [Boolean]
  #
  # source://actionmailer//lib/action_mailer/base.rb#646
...
class ActionMailer::DeliveryJob < ::ActiveJob::Base
  ...
  # source://actionmailer//lib/action_mailer/delivery_job.rb#36
  def handle_exception_with_mailer_class(exception); end

  # "Deserialize" the mailer class name by hand in case another argument
  # (like a Global ID reference) raised DeserializationError.
  #
  # source://actionmailer//lib/action_mailer/delivery_job.rb#30
...
class ActionMailer::LogSubscriber < ::ActiveSupport::LogSubscriber
  ...
  #
  # source://actionmailer//lib/action_mailer/log_subscriber.rb#39
  def logger; end

  # An email was generated.
  #
  # source://actionmailer//lib/action_mailer/log_subscriber.rb#30
...
class ActionMailer::MailDeliveryJob < ::ActiveJob::Base
  ...
  # source://actionmailer//lib/action_mailer/mail_delivery_job.rb#30
  def handle_exception_with_mailer_class(exception); end

  # "Deserialize" the mailer class name by hand in case another argument
  # (like a Global ID reference) raised DeserializationError.
  #
  # source://actionmailer//lib/action_mailer/mail_delivery_job.rb#24
  def mailer_class; end
...
class ActionMailer::MessageDelivery
  ...
  #
  # source://actionmailer//lib/action_mailer/message_delivery.rb#28
  def __getobj__; end

  # Unused except for delegator internals (dup, marshalling).
  #
  # source://actionmailer//lib/action_mailer/message_delivery.rb#33
  ...
  #   end
  #
  # source://actionmailer//lib/action_mailer/message_delivery.rb#93
  ...
  #   end
  #
  # source://actionmailer//lib/action_mailer/message_delivery.rb#69
  def deliver_later!(options = T.unsafe(nil)); end
  ...
  #
  # source://actionmailer//lib/action_mailer/message_delivery.rb#112
  def deliver_now; end
  ...
  #
  # source://actionmailer//lib/action_mailer/message_delivery.rb#38
  def message; end
  ...
  # @return [Boolean]
  #
  # source://actionmailer//lib/action_mailer/message_delivery.rb#43
  def processed?; end

  private

  # source://actionmailer//lib/action_mailer/message_delivery.rb#144
  def arguments_for(delivery_job, delivery_method); end

  # source://actionmailer//lib/action_mailer/message_delivery.rb#127
  def enqueue_delivery(delivery_method, options = T.unsafe(nil)); end

  # Returns the processed Mailer instance. We keep this instance
  # on hand so we can delegate exception handling to it.
  #
  # source://actionmailer//lib/action_mailer/message_delivery.rb#121
...
class ActionMailer::Parameterized::Mailer
  ...
  # @return [Boolean]
  #
  # source://actionmailer//lib/action_mailer/parameterized.rb#119
  def respond_to_missing?(method, include_all = T.unsafe(nil)); end
end
...
class ActionMailer::Parameterized::MessageDelivery < ::ActionMailer::MessageDelivery
  ...
  # source://actionmailer//lib/action_mailer/parameterized.rb#162
  def arguments_for(delivery_job, delivery_method); end

  # source://actionmailer//lib/action_mailer/parameterized.rb#154
...
# source://actionmailer//lib/action_mailer/preview.rb#70
class ActionMailer::Preview
  extend ::ActiveSupport::DescendantsTracker

  # @return [Preview] a new instance of Preview
  #
  # source://actionmailer//lib/action_mailer/preview.rb#75
  def initialize(params = T.unsafe(nil)); end

  # Returns the value of attribute params.
  #
  # source://actionmailer//lib/action_mailer/preview.rb#73
  def params; end

  class << self
    # Returns all mailer preview classes.
    #
    # source://actionmailer//lib/action_mailer/preview.rb#81
    def all; end
    ...
    #
    # source://actionmailer//lib/action_mailer/preview.rb#89
    ...
    # @return [Boolean]
    #
    # source://actionmailer//lib/action_mailer/preview.rb#102
    def email_exists?(email); end

    # Returns all of the available email previews.
    #
    # source://actionmailer//lib/action_mailer/preview.rb#97
    def emails; end
    ...
    # @return [Boolean]
    #
    # source://actionmailer//lib/action_mailer/preview.rb#107
    ...
    #
    # source://actionmailer//lib/action_mailer/preview.rb#117
    def preview_name; end

    private

    # source://actionmailer//lib/action_mailer/preview.rb#136
    def inform_preview_interceptors(message); end

    # source://actionmailer//lib/action_mailer/preview.rb#122
    def load_previews; end

    # source://actionmailer//lib/action_mailer/preview.rb#128
    def preview_path; end

    # source://actionmailer//lib/action_mailer/preview.rb#132
    def show_previews; end
  end
end
...
# source://actionmailer//lib/action_mailer/test_case.rb#33
module ActionMailer::TestCase::Behavior
  ...
  # source://actionmailer//lib/action_mailer/test_case.rb#108
  def charset; end

  # source://actionmailer//lib/action_mailer/test_case.rb#112
  def encode(subject); end

  # source://actionmailer//lib/action_mailer/test_case.rb#80
  def initialize_test_deliveries; end

  # source://actionmailer//lib/action_mailer/test_case.rb#116
  def read_fixture(action); end

  # source://actionmailer//lib/action_mailer/test_case.rb#97
  def restore_delivery_method; end

  # source://actionmailer//lib/action_mailer/test_case.rb#87
  def restore_test_deliveries; end

  # source://actionmailer//lib/action_mailer/test_case.rb#92
  def set_delivery_method(method); end

  # source://actionmailer//lib/action_mailer/test_case.rb#102
...
module ActionMailer::TestCase::Behavior::ClassMethods
  ...
  #
  # source://actionmailer//lib/action_mailer/test_case.rb#69
  def determine_default_mailer(name); end

  # source://actionmailer//lib/action_mailer/test_case.rb#61
  def mailer_class; end

  # source://actionmailer//lib/action_mailer/test_case.rb#50
...
module ActionMailer::TestCase::ClearTestDeliveries
  ...
  # source://actionmailer//lib/action_mailer/test_case.rb#26
...
module ActionMailer::TestHelper
  ...
  # source://actionmailer//lib/action_mailer/test_helper.rb#156
