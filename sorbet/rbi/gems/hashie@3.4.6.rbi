...
# source://hashie//lib/hashie/version.rb#1
module Hashie
...
class Hashie::CoercionError < ::StandardError; end
...
class Hashie::Dash < ::Hashie::Hash
  ...
  #
  # source://hashie//lib/hashie/dash.rb#94
  def initialize(attributes = T.unsafe(nil), &block); end

  # Retrieve a value from the Dash (will return the
  # property's default value if it hasn't been set).
  #
  # source://hashie//lib/hashie/dash.rb#116
  def [](property); end

  # Set a value on the Dash in a Hash-like way. Only works
  # on pre-existing properties.
  #
  # source://hashie//lib/hashie/dash.rb#130
  ...
  # source://hashie//lib/hashie/dash.rb#136
  def merge(other_hash); end

  # source://hashie//lib/hashie/dash.rb#144
  def merge!(other_hash); end

  # source://hashie//lib/hashie/dash.rb#151
  def replace(other_hash); end

  # source://hashie//lib/hashie/extensions/pretty_inspect.rb#9
  def to_s; end

  # source://hashie//lib/hashie/dash.rb#158
  ...
  # source://hashie//lib/hashie/dash.rb#179
  def assert_property_exists!(property); end

  # source://hashie//lib/hashie/dash.rb#193
  def assert_property_required!(property, value); end

  # source://hashie//lib/hashie/dash.rb#189
  def assert_property_set!(property); end

  # source://hashie//lib/hashie/dash.rb#183
  def assert_required_attributes_set!; end

  # source://hashie//lib/hashie/dash.rb#201
  def fail_no_property_error!(property); end

  # source://hashie//lib/hashie/dash.rb#197
  def fail_property_required_error!(property); end

  # source://hashie//lib/hashie/dash.rb#173
  def initialize_attributes(attributes); end

  # @return [Boolean]
  #
  # source://hashie//lib/hashie/dash.rb#205
  def required?(property); end

  class << self
    # Returns the value of attribute defaults.
    #
    # source://hashie//lib/hashie/dash.rb#65
    def defaults; end

    # @private
    #
    # source://hashie//lib/hashie/dash.rb#72
    ...
    # @return [Boolean]
    #
    # source://hashie//lib/hashie/dash.rb#82
    ...
    # @return [Boolean]
    #
    # source://hashie//lib/hashie/dash.rb#88
    def required?(name); end

    # Returns the value of attribute required_properties.
    #
    # source://hashie//lib/hashie/dash.rb#66
    def required_properties; end
  end
end

# source://hashie//lib/hashie.rb#12
...
# source://hashie//lib/hashie/extensions/coercion.rb#5
module Hashie::Extensions::Coercion
  ...
  class << self
    # @private
    #
    # source://hashie//lib/hashie/extensions/coercion.rb#20
    def included(base); end
  end
end

# source://hashie//lib/hashie/extensions/coercion.rb#15
Hashie::Extensions::Coercion::ABSTRACT_CORE_TYPES = T.let(T.unsafe(nil), Hash)

# source://hashie//lib/hashie/extensions/coercion.rb#6
Hashie::Extensions::Coercion::CORE_TYPES = T.let(T.unsafe(nil), Hash)

# source://hashie//lib/hashie/extensions/coercion.rb#54
module Hashie::Extensions::Coercion::ClassMethods
  ...
  # source://hashie//lib/hashie/extensions/coercion.rb#191
  def build_container_coercion(type, value_type); end

  # source://hashie//lib/hashie/extensions/coercion.rb#198
  def build_core_type_coercion(type); end

  # source://hashie//lib/hashie/extensions/coercion.rb#183
  ...
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#72
  ...
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#110
  def coerce_value(from, into, options = T.unsafe(nil)); end

  # source://hashie//lib/hashie/extensions/coercion.rb#150
  def coercion_cache; end

  # source://hashie//lib/hashie/extensions/coercion.rb#145
  def fetch_coercion(type); end

  # source://hashie//lib/hashie/extensions/coercion.rb#206
  def inherited(klass); end

  # Returns the specific key coercion for the specified key,
  # if one exists.
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#86
  ...
  #
  # source://hashie//lib/hashie/extensions/coercion.rb#55
  def key_coercions=(_arg0); end
end

# source://hashie//lib/hashie/extensions/coercion.rb#28
module Hashie::Extensions::Coercion::InstanceMethods
  # source://hashie//lib/hashie/extensions/coercion.rb#43
  def custom_writer(key, value, _convert = T.unsafe(nil)); end

  # source://hashie//lib/hashie/extensions/coercion.rb#47
  def replace(other_hash); end
...
# source://hashie//lib/hashie.rb#37
...
module Hashie::Extensions::Dash::IndifferentAccess::ClassMethods
  ...
  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/dash/indifferent_access.rb#13
  def property?(name); end

  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/dash/indifferent_access.rb#28
  def transformation_exists?(name); end

  # source://hashie//lib/hashie/extensions/dash/indifferent_access.rb#23
  def transformed_property(property_name, value); end

  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/dash/indifferent_access.rb#18
...
module Hashie::Extensions::Dash::PropertyTranslation::ClassMethods
  ...
  # source://hashie//lib/hashie/extensions/dash/property_translation.rb#119
  ...
  #
  # source://hashie//lib/hashie/extensions/dash/property_translation.rb#72
  def property(property_name, options = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/dash/property_translation.rb#99
  def transformation_exists?(name); end

  # source://hashie//lib/hashie/extensions/dash/property_translation.rb#95
  def transformed_property(property_name, value); end
  ...
  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/dash/property_translation.rb#103
  def translation_exists?(name); end

  # source://hashie//lib/hashie/extensions/dash/property_translation.rb#107
...
# source://hashie//lib/hashie/extensions/dash/property_translation.rb#130
module Hashie::Extensions::Dash::PropertyTranslation::InstanceMethods
  ...
  #
  # source://hashie//lib/hashie/extensions/dash/property_translation.rb#134
  def []=(property, value); end

  # Deletes any keys that have a translation
  #
  # source://hashie//lib/hashie/extensions/dash/property_translation.rb#145
  def initialize_attributes(attributes); end
  ...
  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/dash/property_translation.rb#157
...
#
# source://hashie//lib/hashie/extensions/deep_fetch.rb#13
module Hashie::Extensions::DeepFetch
  # source://hashie//lib/hashie/extensions/deep_fetch.rb#16
...
# source://hashie//lib/hashie/extensions/deep_find.rb#3
module Hashie::Extensions::DeepFind
  ...
  #
  # source://hashie//lib/hashie/extensions/deep_find.rb#18
  ...
  #
  # source://hashie//lib/hashie/extensions/deep_find.rb#38
  ...
  # source://hashie//lib/hashie/extensions/deep_find.rb#51
...
module Hashie::Extensions::DeepLocate
  ...
  #
  # source://hashie//lib/hashie/extensions/deep_locate.rb#60
  def deep_locate(comparator); end

  class << self
    # source://hashie//lib/hashie/extensions/deep_locate.rb#66
    def _construct_key_comparator(search_key, object); end

    # source://hashie//lib/hashie/extensions/deep_locate.rb#75
    def _deep_locate(comparator, object, result = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://hashie//lib/hashie/extensions/deep_locate.rb#89
...
module Hashie::Extensions::IgnoreUndeclared
  ...
  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/ignore_undeclared.rb#42
  def property_exists?(property); end
end
...
module Hashie::Extensions::IndifferentAccess
  ...
  #
  # source://hashie//lib/hashie/extensions/indifferent_access.rb#77
  def convert!; end

  # source://hashie//lib/hashie/extensions/indifferent_access.rb#70
  def convert_key(key); end

  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/indifferent_access.rb#126
  def indifferent_access?; end

  # source://hashie//lib/hashie/extensions/indifferent_access.rb#94
  def indifferent_default(key = T.unsafe(nil)); end

  # source://hashie//lib/hashie/extensions/indifferent_access.rb#114
  def indifferent_delete(key); end

  # source://hashie//lib/hashie/extensions/indifferent_access.rb#110
  def indifferent_fetch(key, *args, &block); end

  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/indifferent_access.rb#118
  def indifferent_key?(key); end

  # source://hashie//lib/hashie/extensions/indifferent_access.rb#130
  ...
  # source://hashie//lib/hashie/extensions/indifferent_access.rb#84
  def indifferent_value(value); end

  # source://hashie//lib/hashie/extensions/indifferent_access.rb#122
  def indifferent_values_at(*indices); end

  # source://hashie//lib/hashie/extensions/indifferent_access.rb#106
  def indifferent_writer(key, value); end

  # source://hashie//lib/hashie/extensions/indifferent_access.rb#136
  def merge(*_arg0); end

  # source://hashie//lib/hashie/extensions/indifferent_access.rb#140
  def merge!(*_arg0); end
  ...
  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/indifferent_access.rb#146
  def hash_lacking_indifference?(other); end

  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/indifferent_access.rb#152
  def hash_with_indifference?(other); end

  class << self
    # @private
    #
    # source://hashie//lib/hashie/extensions/indifferent_access.rb#26
    def included(base); end

    # Injects indifferent access into a duplicate of the hash
    # provided. See #inject!
    #
    # source://hashie//lib/hashie/extensions/indifferent_access.rb#66
    def inject(hash); end
    ...
    #
    # source://hashie//lib/hashie/extensions/indifferent_access.rb#59
    def inject!(hash); end
  end
end
...
# source://hashie//lib/hashie.rb#43
...
module Hashie::Extensions::Mash::SafeAssignment
  # source://hashie//lib/hashie/extensions/mash/safe_assignment.rb#10
  def []=(*args); end
...
# underscores.
#
# source://hashie//lib/hashie/extensions/method_access.rb#226
module Hashie::Extensions::MethodAccessWithOverride
  ...
  class << self
    # @private
    #
    # source://hashie//lib/hashie/extensions/method_access.rb#227
    def included(base); end
  end
end
...
#
# source://hashie//lib/hashie/extensions/method_access.rb#183
module Hashie::Extensions::MethodOverridingWriter
  # source://hashie//lib/hashie/extensions/method_access.rb#184
  def convert_key(key); end

  # source://hashie//lib/hashie/extensions/method_access.rb#188
  def method_missing(name, *args); end
  ...
  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/method_access.rb#205
  def already_overridden?(name); end

  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/method_access.rb#209
  def method?(name); end

  # source://hashie//lib/hashie/extensions/method_access.rb#213
  ...
  # @return [Boolean]
  #
  # source://hashie//lib/hashie/extensions/method_access.rb#198
...
# source://hashie//lib/hashie.rb#33
module Hashie::Extensions::Parsers; end

# source://hashie//lib/hashie/extensions/parsers/yaml_erb_parser.rb#6
class Hashie::Extensions::Parsers::YamlErbParser
  # @return [YamlErbParser] a new instance of YamlErbParser
  #
  # source://hashie//lib/hashie/extensions/parsers/yaml_erb_parser.rb#7
  def initialize(file_path); end

  # source://hashie//lib/hashie/extensions/parsers/yaml_erb_parser.rb#12
  def perform; end

  class << self
    # source://hashie//lib/hashie/extensions/parsers/yaml_erb_parser.rb#18
    def perform(file_path); end
  end
end
...
# source://hashie//lib/hashie/extensions/ruby_version_check.rb#3
module Hashie::Extensions::RubyVersionCheck
  ...
  class << self
    # @private
    #
    # source://hashie//lib/hashie/extensions/ruby_version_check.rb#4
    def included(base); end
  end
end

# source://hashie//lib/hashie/extensions/ruby_version_check.rb#8
module Hashie::Extensions::RubyVersionCheck::ClassMethods
  # source://hashie//lib/hashie/extensions/ruby_version_check.rb#9
...
#
# source://hashie//lib/hashie/extensions/strict_key_access.rb#20
module Hashie::Extensions::StrictKeyAccess
  ...
  #
  # source://hashie//lib/hashie/extensions/strict_key_access.rb#44
  def [](key); end
...
# source://hashie//lib/hashie/extensions/strict_key_access.rb#21
...
class Hashie::Hash < ::Hash
  ...
  #
  # source://hashie//lib/hashie/hash.rb#41
  ...
  # source://hashie//lib/hashie/hash.rb#47
...
#   mash.author # => <Mash>
#
# source://hashie//lib/hashie/mash.rb#58
class Hashie::Mash < ::Hashie::Hash
  ...
  #
  # source://hashie//lib/hashie/mash.rb#89
  ...
  # @yield [value]
  #
  # source://hashie//lib/hashie/mash.rb#101
  def [](key); end
  ...
  # current mash.
  #
  # source://hashie//lib/hashie/mash.rb#164
  def deep_merge(other_hash, &blk); end

  # Recursively merges this mash with the passed
  # in hash, merging each hash in the hierarchy.
  #
  # source://hashie//lib/hashie/mash.rb#171
  def deep_merge!(other_hash, &blk); end
  ...
  # source://hashie//lib/hashie/mash.rb#256
  def dig(*keys); end

  # Duplicates the current mash as a new mash.
  #
  # source://hashie//lib/hashie/mash.rb#151
  def dup; end
  ...
  # @return [Boolean]
  #
  # source://hashie//lib/hashie/mash.rb#246
  def extractable_options?; end

  # source://hashie//lib/hashie/mash.rb#137
  def fetch(key, *args); end

  # @return [Boolean]
  #
  # source://hashie//lib/hashie/mash.rb#155
  def has_key?(key); end
  ...
  # source://hashie//lib/hashie/mash.rb#228
  def method_missing(method_name, *args, &blk); end

  # @return [Boolean]
  #
  # source://hashie//lib/hashie/mash.rb#223
  ...
  # source://hashie//lib/hashie/mash.rb#207
  def replace(other_hash); end

  # another ActiveSupport method, see issue #270
  #
  # source://hashie//lib/hashie/mash.rb#251
  def reverse_merge(other_hash); end

  # Performs a shallow_update on a duplicate of the current mash
  #
  # source://hashie//lib/hashie/mash.rb#194
  ...
  # source://hashie//lib/hashie/mash.rb#74
  ...
  # if there isn't a value already assigned to the key requested.
  #
  # source://hashie//lib/hashie/mash.rb#128
  ...
  # source://hashie//lib/hashie/mash.rb#281
  def convert_value(val, duping = T.unsafe(nil)); end

  # source://hashie//lib/hashie/mash.rb#263
  def method_name_and_suffix(method_name); end

  # source://hashie//lib/hashie/mash.rb#272
  ...
  # @return [Boolean]
  #
  # source://hashie//lib/hashie/mash.rb#213
...
# source://hashie//lib/hashie/mash.rb#62
