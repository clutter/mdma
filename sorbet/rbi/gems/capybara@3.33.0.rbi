...
module Capybara
  ...
  class << self
    ...
    # source://capybara//lib/capybara.rb#412
    ...
    # source://capybara//lib/capybara.rb#422
    def session_pool; end

    # source://capybara//lib/capybara.rb#428
    def specified_session; end

    # source://capybara//lib/capybara.rb#436
...
class Capybara::Driver::Base
  ...
  #
  # source://capybara//lib/capybara/driver/base.rb#130
  ...
  # @raise [Capybara::NotSupportedByDriverError]
  #
  # source://capybara//lib/capybara/driver/base.rb#80
  ...
  # @return [String] the message shown in the modal
  #
  # source://capybara//lib/capybara/driver/base.rb#143
  ...
  # source://capybara//lib/capybara/driver/base.rb#70
  def frame_title; end
  ...
  # source://capybara//lib/capybara/driver/base.rb#147
  ...
  # source://capybara//lib/capybara/driver/base.rb#161
  def session_options; end
  ...
  # @raise [Capybara::NotSupportedByDriverError]
  #
  # source://capybara//lib/capybara/driver/base.rb#84
  def window_size(handle); end

  private

  # source://capybara//lib/capybara/driver/base.rb#167
  def session; end
end
...
module Capybara::Helpers
  ...
  # @api private
  #
  # source://capybara//lib/capybara/helpers.rb#74
...
# @api private
#
# source://capybara//lib/capybara/helpers.rb#83
class Capybara::Helpers::Timer
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/helpers.rb#97
  def stalled?; end
...
module Capybara::Node::Actions
  ...
  #
  # source://capybara//lib/capybara/node/actions.rb#278
  ...
  #
  # source://capybara//lib/capybara/node/actions.rb#149
  ...
  #
  # source://capybara//lib/capybara/node/actions.rb#121
  ...
  #
  # source://capybara//lib/capybara/node/actions.rb#200
  ...
  #
  # source://capybara//lib/capybara/node/actions.rb#177
...
class Capybara::Node::Element < ::Capybara::Node::Base
  ...
  #
  # source://capybara//lib/capybara/node/element.rb#522
  def evaluate_async_script(script, *args); end
  ...
  # @return [Object] The result of the evaluated JavaScript (may be driver specific)
  #
  # source://capybara//lib/capybara/node/element.rb#505
  def evaluate_script(script, *args); end
  ...
  #
  # source://capybara//lib/capybara/node/element.rb#488
  def execute_script(script, *args); end
  ...
  # @return [Capybara::Node::Element] The element
  #
  # source://capybara//lib/capybara/node/element.rb#535
  def flash; end
  ...
  #
  # source://capybara//lib/capybara/node/element.rb#570
  def inspect; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/node/element.rb#553
  def reload; end
  ...
  # @return [Capybara::Node::Element] The element
  #
  # source://capybara//lib/capybara/node/element.rb#466
  ...
  # @raise [ArgumentError]
  #
  # source://capybara//lib/capybara/node/element.rb#597
  def perform_click_action(keys, wait: T.unsafe(nil), **options); end
end

# source://capybara//lib/capybara/node/element.rb#583
...
module Capybara::Node::Finders
  ...
  #
  # source://capybara//lib/capybara/node/finders.rb#247
  ...
  #
  # source://capybara//lib/capybara/node/finders.rb#73
  ...
  # @return [Capybara::Node::Element] The found element
  #
  # source://capybara//lib/capybara/node/finders.rb#50
  ...
  # @return [Capybara::Node::Element] The found element
  #
  # source://capybara//lib/capybara/node/finders.rb#174
  ...
  # @return [Capybara::Node::Element] The found element
  #
  # source://capybara//lib/capybara/node/finders.rb#188
  ...
  # @return [Capybara::Node::Element] The found element
  #
  # source://capybara//lib/capybara/node/finders.rb#127
  ...
  # @return [Capybara::Node::Element] The found element
  #
  # source://capybara//lib/capybara/node/finders.rb#147
  ...
  #
  # source://capybara//lib/capybara/node/finders.rb#283
  ...
  # @return [Capybara::Node::Element] The found element
  #
  # source://capybara//lib/capybara/node/finders.rb#96
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/finders.rb#308
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/finders.rb#312
  def prefer_exact?(query); end

  # source://capybara//lib/capybara/node/finders.rb#290
  def synced_resolve(query); end
end

# source://capybara//lib/capybara/node/matchers.rb#5
module Capybara::Node::Matchers
  # source://capybara//lib/capybara/node/matchers.rb#814
  def ==(other); end
  ...
  #
  # source://capybara//lib/capybara/node/matchers.rb#157
  ...
  #
  # source://capybara//lib/capybara/node/matchers.rb#739
  def assert_ancestor(*args, &optional_filter_block); end
  ...
  #
  # source://capybara//lib/capybara/node/matchers.rb#199
  ...
  #
  # source://capybara//lib/capybara/node/matchers.rb#559
  def assert_matches_selector(*args, &optional_filter_block); end
  ...
  #
  # source://capybara//lib/capybara/node/matchers.rb#125
  def assert_matches_style(styles, **options); end

  # source://capybara//lib/capybara/node/matchers.rb#747
  def assert_no_ancestor(*args, &optional_filter_block); end
  ...
  #
  # source://capybara//lib/capybara/node/matchers.rb#231
  def assert_no_selector(*args, &optional_filter_block); end

  # source://capybara//lib/capybara/node/matchers.rb#790
  def assert_no_sibling(*args, &optional_filter_block); end
  ...
  # @return [true]
  #
  # source://capybara//lib/capybara/node/matchers.rb#689
  ...
  #
  # source://capybara//lib/capybara/node/matchers.rb#178
  ...
  # @raise [Capybara::ExpectationNotMet] If the selector does not exist
  #
  # source://capybara//lib/capybara/node/matchers.rb#108
  def assert_selector(*args, &optional_filter_block); end
  ...
  # @raise [Capybara::ExpectationNotMet] If the selector does not exist
  #
  # source://capybara//lib/capybara/node/matchers.rb#782
  def assert_sibling(*args, &optional_filter_block); end

  # @deprecated Use {#assert_matches_style} instead.
  #
  # source://capybara//lib/capybara/node/matchers.rb#137
  ...
  # @return [true]
  #
  # source://capybara//lib/capybara/node/matchers.rb#673
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#759
  ...
  #
  # source://capybara//lib/capybara/node/matchers.rb#356
  ...
  # @return [Boolean] Whether it exists
  #
  # source://capybara//lib/capybara/node/matchers.rb#711
  ...
  #
  # source://capybara//lib/capybara/node/matchers.rb#307
  ...
  # @return [Boolean] Whether it exists
  #
  # source://capybara//lib/capybara/node/matchers.rb#332
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#767
  ...
  #
  # source://capybara//lib/capybara/node/matchers.rb#368
  ...
  # @return [Boolean] Whether it doesn't exist
  #
  # source://capybara//lib/capybara/node/matchers.rb#434
  ...
  # @return [Boolean] Whether it doesn't exist
  #
  # source://capybara//lib/capybara/node/matchers.rb#723
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#319
  ...
  # @return [Boolean] Whether it doesn't exist
  #
  # source://capybara//lib/capybara/node/matchers.rb#344
  ...
  # @return [Boolean] Whether it doesn't exist
  #
  # source://capybara//lib/capybara/node/matchers.rb#505
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#810
  ...
  # @return [Boolean] Whether it doesn't exist
  #
  # source://capybara//lib/capybara/node/matchers.rb#539
  ...
  # @return [Boolean] Whether it doesn't exist
  #
  # source://capybara//lib/capybara/node/matchers.rb#460
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#280
  ...
  # @return [Boolean] Whether it exists
  #
  # source://capybara//lib/capybara/node/matchers.rb#493
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#802
  def has_sibling?(*args, **options, &optional_filter_block); end

  # @deprecated Use {#matches_style?} instead.
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#70
  ...
  # @return [Boolean] Whether it exists
  #
  # source://capybara//lib/capybara/node/matchers.rb#527
  ...
  # @return [Boolean] Whether it exists
  #
  # source://capybara//lib/capybara/node/matchers.rb#447
  ...
  # @return [Boolean] If the expression exists
  #
  # source://capybara//lib/capybara/node/matchers.rb#268
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#608
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#597
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#642
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#620
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/matchers.rb#631
  def not_matches_xpath?(xpath, **options, &optional_filter_block); end

  private

  # source://capybara//lib/capybara/node/matchers.rb#865
  ...
  # source://capybara//lib/capybara/node/matchers.rb#824
  def _verify_multiple(*args, wait: T.unsafe(nil), **options); end

  # source://capybara//lib/capybara/node/matchers.rb#832
  def _verify_selector_result(query_args, optional_filter_block, query_type = T.unsafe(nil)); end

  # source://capybara//lib/capybara/node/matchers.rb#856
  def _verify_text(type = T.unsafe(nil), expected_text, **query_options); end

  # source://capybara//lib/capybara/node/matchers.rb#820
  def extract_selector(args); end

  # source://capybara//lib/capybara/node/matchers.rb#873
...
class Capybara::Node::Simple
  ...
  # @api private
  #
  # source://capybara//lib/capybara/node/simple.rb#171
  def find_css(css, **_options); end

  # @api private
  #
  # source://capybara//lib/capybara/node/simple.rb#176
  def find_xpath(xpath, **_options); end

  # @api private
  #
  # source://capybara//lib/capybara/node/simple.rb#186
  def initial_cache; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/node/simple.rb#181
  def session_options; end
  ...
  # @return [String] The title of the document
  #
  # source://capybara//lib/capybara/node/simple.rb#162
  def title; end
  ...
  # source://capybara//lib/capybara/node/simple.rb#192
  def option_value(option); end
end

# source://capybara//lib/capybara/node/simple.rb#198
...
class Capybara::Queries::AncestorQuery < ::Capybara::Queries::SelectorQuery
  # @api private
  #
  # source://capybara//lib/capybara/queries/ancestor_query.rb#19
...
class Capybara::Queries::CurrentPathQuery < ::Capybara::Queries::BaseQuery
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/current_path_query.rb#31
  def failure_message; end
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/current_path_query.rb#19
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/current_path_query.rb#41
  def failure_message_helper(negated = T.unsafe(nil)); end

  # @api private
  #
  # source://capybara//lib/capybara/queries/current_path_query.rb#46
  def valid_keys; end
end
...
class Capybara::Queries::SelectorQuery < ::Capybara::Queries::BaseQuery
  ...
  # @raise [ArgumentError]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#337
  def assert_valid_keys; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#570
  def builder(expr); end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#333
  def custom_keys; end
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#410
  def describe_within?; end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#414
  def document?(node); end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#406
  def exact_text; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#306
  def filter_set(name); end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#355
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#522
  def matches_exact_text_filter?(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#296
  def matches_filter_block?(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#479
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#271
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#502
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#432
  def matches_system_filters?(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#551
  def matches_text_exactly?(node, value); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#513
  def matches_text_filter?(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#560
  def matches_text_regexp?(node, regexp); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#528
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#310
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#324
  def ordered_results(results); end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#574
  def position_cache(key); end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#578
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#259
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#367
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#400
...
# @api private
#
# source://capybara//lib/capybara/queries/selector_query.rb#582
class Capybara::Queries::SelectorQuery::Rectangle
  # @api private
  # @return [Rectangle] a new instance of Rectangle
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#585
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#583
  def bottom; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#631
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#642
...
class Capybara::Queries::SiblingQuery < ::Capybara::Queries::SelectorQuery
  # @api private
  #
  # source://capybara//lib/capybara/queries/sibling_query.rb#18
  def description(applied = T.unsafe(nil)); end
...
# source://capybara//lib/capybara.rb#450
...
class Capybara::RackTest::Browser
  ...
  # source://capybara//lib/capybara/rack_test/browser.rb#13
  def app; end
  ...
  # source://capybara//lib/capybara/rack_test/browser.rb#38
  def follow(method, path, **attributes); end

  # source://capybara//lib/capybara/rack_test/browser.rb#112
  def html; end

  # source://capybara//lib/capybara/rack_test/browser.rb#17
  def options; end

  # source://capybara//lib/capybara/rack_test/browser.rb#64
  def process(method, path, attributes = T.unsafe(nil), env = T.unsafe(nil)); end

  # source://capybara//lib/capybara/rack_test/browser.rb#44
  def process_and_follow_redirects(method, path, attributes = T.unsafe(nil), env = T.unsafe(nil)); end

  # source://capybara//lib/capybara/rack_test/browser.rb#26
  def refresh; end

  # source://capybara//lib/capybara/rack_test/browser.rb#96
  def reset_cache!; end

  # source://capybara//lib/capybara/rack_test/browser.rb#91
  def reset_host!; end

  # source://capybara//lib/capybara/rack_test/browser.rb#31
  def submit(method, path, attributes); end

  # source://capybara//lib/capybara/rack_test/browser.rb#118
  def title; end

  # source://capybara//lib/capybara/rack_test/browser.rb#21
  def visit(path, **attributes); end

  protected

  # source://capybara//lib/capybara/rack_test/browser.rb#124
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/browser.rb#137
...
class Capybara::RackTest::Driver < ::Capybara::Driver::Base
  ...
  # source://capybara//lib/capybara/rack_test/driver.rb#24
  def browser; end

  # source://capybara//lib/capybara/rack_test/driver.rb#60
  def current_url; end

  # source://capybara//lib/capybara/rack_test/driver.rb#103
  def delete(*args, &block); end

  # source://capybara//lib/capybara/rack_test/driver.rb#88
  def dom; end

  # source://capybara//lib/capybara/rack_test/driver.rb#76
  def find_css(selector); end

  # source://capybara//lib/capybara/rack_test/driver.rb#72
  def find_xpath(selector); end

  # source://capybara//lib/capybara/rack_test/driver.rb#56
  def follow(method, path, **attributes); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/driver.rb#28
  ...
  # source://capybara//lib/capybara/rack_test/driver.rb#84
  def html; end

  # source://capybara//lib/capybara/rack_test/driver.rb#106
  def invalid_element_errors; end
  ...
  # source://capybara//lib/capybara/rack_test/driver.rb#32
  def redirect_limit; end

  # source://capybara//lib/capybara/rack_test/driver.rb#48
  def refresh; end

  # source://capybara//lib/capybara/rack_test/driver.rb#40
  def request; end

  # source://capybara//lib/capybara/rack_test/driver.rb#96
  def reset!; end

  # source://capybara//lib/capybara/rack_test/driver.rb#36
  def response; end

  # source://capybara//lib/capybara/rack_test/driver.rb#64
  def response_headers; end

  # source://capybara//lib/capybara/rack_test/driver.rb#68
  def status_code; end

  # source://capybara//lib/capybara/rack_test/driver.rb#52
  def submit(method, path, attributes); end

  # source://capybara//lib/capybara/rack_test/driver.rb#92
  def title; end

  # source://capybara//lib/capybara/rack_test/driver.rb#44
  def visit(path, **attributes); end
end
...
class Capybara::RackTest::Node < ::Capybara::Driver::Node
  # source://capybara//lib/capybara/rack_test/node.rb#142
  def ==(other); end
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/node.rb#288
  def checkbox?; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/rack_test/node.rb#149
  def displayed_text(check_ancestor: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/node.rb#300
  def input_field?; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/node.rb#292
  def radio?; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/node.rb#308
  def range?; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/node.rb#296
  def text_or_password?; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/node.rb#304
  def textarea?; end
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/node.rb#239
  def attribute_is_not_blank?(attribute); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/node.rb#278
  def checkable?; end
  ...
  # source://capybara//lib/capybara/rack_test/node.rb#243
  def follow_link; end
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/node.rb#270
  def link?; end
  ...
  # source://capybara//lib/capybara/rack_test/node.rb#220
  def set_input(value); end

  # source://capybara//lib/capybara/rack_test/node.rb#198
  ...
  # source://capybara//lib/capybara/rack_test/node.rb#177
  def string_node; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/node.rb#274
  def submits?; end

  # source://capybara//lib/capybara/rack_test/node.rb#259
  def toggle_details(details = T.unsafe(nil)); end

  # source://capybara//lib/capybara/rack_test/node.rb#186
  def type; end
  ...
  # source://capybara//lib/capybara/rack_test/node.rb#119
  def unchecked_find_css(locator, **_hints); end

  # source://capybara//lib/capybara/rack_test/node.rb#115
...
# source://capybara//lib/capybara/rack_test/node.rb#313
...
class Capybara::Result
  ...
  # @api private
  #
  # source://capybara//lib/capybara/result.rb#144
  ...
  # source://capybara//lib/capybara/result.rb#117
  def failure_message; end
  ...
  # source://capybara//lib/capybara/result.rb#137
  ...
  # source://capybara//lib/capybara/result.rb#151
  def add_to_cache(elem); end

  # source://capybara//lib/capybara/result.rb#165
  ...
  #
  # source://capybara//lib/capybara/result.rb#185
  def lazy_select_elements(&block); end

  # source://capybara//lib/capybara/result.rb#156
  def load_up_to(num); end

  # source://capybara//lib/capybara/result.rb#170
  def rest; end
end
...
class Capybara::Selector < ::SimpleDelegator
  ...
  # source://capybara//lib/capybara/selector/selector.rb#147
...
class Capybara::Selector::Definition
  ...
  # source://capybara//lib/capybara/selector/definition.rb#265
...
class Capybara::Selector::FilterSet
  ...
  # source://capybara//lib/capybara/selector/filter_set.rb#113
...
class Capybara::Selector::XPathBuilder
  ...
  # @api private
  #
  # source://capybara//lib/capybara/selector/builders/xpath_builder.rb#28
  def attribute_conditions(attributes); end

  # @api private
  #
  # source://capybara//lib/capybara/selector/builders/xpath_builder.rb#45
  def class_conditions(classes); end

  # @api private
  #
  # source://capybara//lib/capybara/selector/builders/xpath_builder.rb#60
  def regexp_to_xpath_conditions(regexp); end
end

# source://capybara//lib/capybara.rb#451
...
class Capybara::Selenium::ChromeNode < ::Capybara::Selenium::Node
  ...
  # source://capybara//lib/capybara/selenium/nodes/chrome_node.rb#95
  def browser_version(to_float = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/nodes/chrome_node.rb#102
  def chromedriver_fixed_actions_key_state?; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/nodes/chrome_node.rb#106
  def chromedriver_supports_displayed_endpoint?; end

  # source://capybara//lib/capybara/selenium/nodes/chrome_node.rb#110
  def chromedriver_version; end

  # source://capybara//lib/capybara/selenium/nodes/chrome_node.rb#89
  def file_errors; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/nodes/chrome_node.rb#114
  def native_displayed?; end

  # @raise [ArgumentError]
  #
  # source://capybara//lib/capybara/selenium/nodes/chrome_node.rb#78
...
class Capybara::Selenium::Driver < ::Capybara::Driver::Base
  ...
  # @return [Driver] a new instance of Driver
  #
  # source://capybara//lib/capybara/selenium/driver.rb#60
  def initialize(app, **options); end
  ...
  # source://capybara//lib/capybara/selenium/driver.rb#41
  def browser; end

  # @raise [ArgumentError]
  #
  # source://capybara//lib/capybara/selenium/driver.rb#202
  def close_window(handle); end

  # source://capybara//lib/capybara/selenium/driver.rb#96
  def current_url; end

  # source://capybara//lib/capybara/selenium/driver.rb#172
  def current_window_handle; end

  # source://capybara//lib/capybara/selenium/driver.rb#236
  def dismiss_modal(_type, **options); end

  # source://capybara//lib/capybara/selenium/driver.rb#112
  def evaluate_async_script(script, *args); end
  ...
  # source://capybara//lib/capybara/selenium/driver.rb#196
  def fullscreen_window(handle); end

  # source://capybara//lib/capybara/selenium/driver.rb#78
  def go_back; end

  # source://capybara//lib/capybara/selenium/driver.rb#82
  def go_forward; end

  # source://capybara//lib/capybara/selenium/driver.rb#86
  def html; end

  # source://capybara//lib/capybara/selenium/driver.rb#257
  def invalid_element_errors; end

  # source://capybara//lib/capybara/selenium/driver.rb#189
  def maximize_window(handle); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/driver.rb#101
  def needs_server?; end

  # source://capybara//lib/capybara/selenium/driver.rb#281
  def no_such_window_error; end
  ...
  # source://capybara//lib/capybara/selenium/driver.rb#74
  def refresh; end

  # source://capybara//lib/capybara/selenium/driver.rb#122
  def reset!; end

  # source://capybara//lib/capybara/selenium/driver.rb#183
  def resize_window_to(handle, width, height); end

  # source://capybara//lib/capybara/selenium/driver.rb#118
  def save_screenshot(path, **_options); end

  # source://capybara//lib/capybara/selenium/driver.rb#157
  def switch_to_frame(frame); end
  ...
  # source://capybara//lib/capybara/selenium/driver.rb#70
  def visit(path); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/driver.rb#100
  def wait?; end

  # source://capybara//lib/capybara/selenium/driver.rb#210
  def window_handles; end

  # source://capybara//lib/capybara/selenium/driver.rb#176
  def window_size(handle); end

  private

  # source://capybara//lib/capybara/selenium/driver.rb#483
  def accept_unhandled_reset_alert; end

  # source://capybara//lib/capybara/selenium/driver.rb#444
  def bridge; end

  # source://capybara//lib/capybara/selenium/driver.rb#440
  def build_node(native_node, initial_cache = T.unsafe(nil)); end

  # source://capybara//lib/capybara/selenium/driver.rb#295
  def clear_browser_state; end

  # source://capybara//lib/capybara/selenium/driver.rb#304
  def clear_browser_state_errors; end

  # source://capybara//lib/capybara/selenium/driver.rb#340
  def clear_local_storage; end

  # source://capybara//lib/capybara/selenium/driver.rb#326
  def clear_session_storage; end

  # source://capybara//lib/capybara/selenium/driver.rb#319
  def clear_storage; end

  # source://capybara//lib/capybara/selenium/driver.rb#315
  def delete_all_cookies; end

  # source://capybara//lib/capybara/selenium/driver.rb#436
  def find_context; end

  # source://capybara//lib/capybara/selenium/driver.rb#378
  def find_modal(text: T.unsafe(nil), **options); end

  # source://capybara//lib/capybara/selenium/driver.rb#401
  def find_modal_errors; end

  # source://capybara//lib/capybara/selenium/driver.rb#362
  def modal_error; end

  # source://capybara//lib/capybara/selenium/driver.rb#291
  def native_args(args); end

  # source://capybara//lib/capybara/selenium/driver.rb#354
  def navigate_with_accept(url); end

  # source://capybara//lib/capybara/selenium/driver.rb#465
  def reset_browser_state; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/driver.rb#287
  def selenium_4?; end
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/driver.rb#415
  def silenced_unknown_error_message?(msg); end

  # source://capybara//lib/capybara/selenium/driver.rb#419
  def silenced_unknown_error_messages; end

  # source://capybara//lib/capybara/selenium/driver.rb#448
  def specialize_driver; end

  # source://capybara//lib/capybara/selenium/driver.rb#308
  def unhandled_alert_errors; end

  # source://capybara//lib/capybara/selenium/driver.rb#423
  def unwrap_script_result(arg); end

  # source://capybara//lib/capybara/selenium/driver.rb#470
  def wait_for_empty_page(timer); end

  # source://capybara//lib/capybara/selenium/driver.rb#405
  def with_legacy_error(errors, legacy_error); end

  # source://capybara//lib/capybara/selenium/driver.rb#366
  def within_given_window(handle); end

  class << self
    # source://capybara//lib/capybara/selenium/driver.rb#18
    def load_selenium; end

    # source://capybara//lib/capybara/selenium/driver.rb#35
    def register_specialization(browser_name, specialization); end

    # Returns the value of attribute specializations.
    #
    # source://capybara//lib/capybara/selenium/driver.rb#33
...
class Capybara::Selenium::FirefoxNode < ::Capybara::Selenium::Node
  ...
  # source://capybara//lib/capybara/selenium/nodes/firefox_node.rb#51
  def drop(*args); end

  # source://capybara//lib/capybara/selenium/nodes/firefox_node.rb#55
  def hover; end

  # source://capybara//lib/capybara/selenium/nodes/firefox_node.rb#62
  def select_option; end
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/nodes/firefox_node.rb#70
  def visible?; end

  private

  # source://capybara//lib/capybara/selenium/nodes/firefox_node.rb#95
  def _send_keys(keys, actions = T.unsafe(nil), down_keys = T.unsafe(nil)); end

  # source://capybara//lib/capybara/selenium/nodes/firefox_node.rb#128
  def browser_version; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/nodes/firefox_node.rb#84
  def native_displayed?; end

  # source://capybara//lib/capybara/selenium/nodes/firefox_node.rb#88
  def perform_with_options(click_options); end

  # @raise [ArgumentError]
  #
  # source://capybara//lib/capybara/selenium/nodes/firefox_node.rb#120
...
class Capybara::Selenium::Node < ::Capybara::Driver::Node
  ...
  # source://capybara//lib/capybara/selenium/node.rb#408
  ...
  # source://capybara//lib/capybara/selenium/node.rb#261
  ...
  # source://capybara//lib/capybara/selenium/node.rb#425
  def modifiers_down(actions, keys); end

  # source://capybara//lib/capybara/selenium/node.rb#430
  ...
  # @raise [ArgumentError]
  #
  # source://capybara//lib/capybara/selenium/node.rb#296
  ...
  # source://capybara//lib/capybara/selenium/node.rb#384
  def set_content_editable(value); end

  # source://capybara//lib/capybara/selenium/node.rb#310
  def set_date(value); end

  # source://capybara//lib/capybara/selenium/node.rb#326
  def set_datetime_local(value); end

  # source://capybara//lib/capybara/selenium/node.rb#356
  def set_file(value); end
  ...
  # source://capybara//lib/capybara/selenium/node.rb#247
  ...
  # source://capybara//lib/capybara/selenium/node.rb#366
  def with_file_detector; end
end

# ClickOptions encapsulates click option logic
#
# source://capybara//lib/capybara/selenium/node.rb#582
class Capybara::Selenium::Node::ClickOptions
  # @return [ClickOptions] a new instance of ClickOptions
  #
  # source://capybara//lib/capybara/selenium/node.rb#585
  def initialize(keys, options); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/node.rb#598
  def center_offset?; end

  # source://capybara//lib/capybara/selenium/node.rb#594
  def coords; end
  ...
  # source://capybara//lib/capybara/selenium/node.rb#606
  def delay; end
  ...
  #
  # source://capybara//lib/capybara/selenium/node.rb#583
  def keys; end
...
#
# source://capybara//lib/capybara/selenium/node.rb#548
class Capybara::Selenium::Node::SettableValue
  # @return [SettableValue] a new instance of SettableValue
  #
  # source://capybara//lib/capybara/selenium/node.rb#551
  def initialize(value); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/node.rb#559
  def dateable?; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/node.rb#567
  def timeable?; end

  # source://capybara//lib/capybara/selenium/node.rb#563
  def to_date_str; end

  # source://capybara//lib/capybara/selenium/node.rb#575
  def to_datetime_str; end

  # source://capybara//lib/capybara/selenium/node.rb#555
  def to_s; end

  # source://capybara//lib/capybara/selenium/node.rb#571
  def to_time_str; end

  # Returns the value of attribute value.
  #
  # source://capybara//lib/capybara/selenium/node.rb#549
  def value; end
end
...
module Capybara::Selenium::Scroll
  ...
  # source://capybara//lib/capybara/selenium/extensions/scroll.rb#66
...
class Capybara::Server::AnimationDisabler
  ...
  # source://capybara//lib/capybara/server/animation_disabler.rb#22
  def call(env); end
  ...
  #
  # source://capybara//lib/capybara/server/animation_disabler.rb#36
  def disable_markup; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/server/animation_disabler.rb#38
...
class Capybara::Session
  ...
  # @return [String] the message shown in the modal
  #
  # source://capybara//lib/capybara/session.rb#637
  ...
  # @return [String] the message shown in the modal
  #
  # source://capybara//lib/capybara/session.rb#647
  ...
  # source://capybara//lib/capybara/session.rb#751
  def all(*_arg0, &_arg1); end
  ...
  # source://capybara//lib/capybara/session.rb#767
  def assert_no_title(*_arg0, &_arg1); end
  ...
  # source://capybara//lib/capybara/session.rb#820
  def config; end
  ...
  # source://capybara//lib/capybara/session.rb#782
  ...
  #
  # source://capybara//lib/capybara/session.rb#438
  ...
  # @return [String] the message shown in the modal
  #
  # source://capybara//lib/capybara/session.rb#657
  ...
  # @return [Object] The result of the evaluated JavaScript (may be driver specific)
  #
  # source://capybara//lib/capybara/session.rb#611
  def evaluate_async_script(script, *args); end
  ...
  # @return [Object] The result of the evaluated JavaScript (may be driver specific)
  #
  # source://capybara//lib/capybara/session.rb#597
  def evaluate_script(script, *args); end
  ...
  # @param args Optional arguments that will be passed to the script. Driver support for this is optional and types of objects supported may differ between drivers
  #
  # source://capybara//lib/capybara/session.rb#582
  def execute_script(script, *args); end
  ...
  #
  # source://capybara//lib/capybara/session.rb#462
  def open_new_window(kind = T.unsafe(nil)); end
  ...
  #
  # source://capybara//lib/capybara/session.rb#710
  ...
  # @param options [Hash] a customizable set of options
  #
  # source://capybara//lib/capybara/session.rb#740
  ...
  #
  # source://capybara//lib/capybara/session.rb#694
  ...
  # @return [String] the path to which the file was saved
  #
  # source://capybara//lib/capybara/session.rb#725
  ...
  #
  # source://capybara//lib/capybara/session.rb#490
  ...
  #
  # source://capybara//lib/capybara/session.rb#559
  ...
  #
  # source://capybara//lib/capybara/session.rb#449
  def windows; end
  ...
  #
  # source://capybara//lib/capybara/session.rb#341
  ...
  #
  # source://capybara//lib/capybara/session.rb#358
  ...
  # @overload within_frame
  #
  # source://capybara//lib/capybara/session.rb#426
  ...
  #
  # source://capybara//lib/capybara/session.rb#368
  ...
  #
  # source://capybara//lib/capybara/session.rb#523
  def within_window(window_or_proc); end

  private

  # source://capybara//lib/capybara/session.rb#893
  def _find_frame(*args, **kw_args); end

  # @raise [Capybara::ScopeError]
  #
  # source://capybara//lib/capybara/session.rb#909
  ...
  # source://capybara//lib/capybara/session.rb#840
  def accept_modal(type, text_or_options, options, &blk); end

  # source://capybara//lib/capybara/session.rb#889
  ...
  # source://capybara//lib/capybara/session.rb#861
  def prepare_path(path, extension); end

  # source://capybara//lib/capybara/session.rb#872
  def scopes; end
...
class Capybara::Window
  ...
  # @raise [Capybara::WindowError]
  #
  # source://capybara//lib/capybara/window.rb#142
