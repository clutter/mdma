...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference('Device.count') do
      post devices_url, params: { device: { app_version: @device.app_version, name: @device.name } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { app_version: @device.app_version, name: @device.name } }
